                            ...
                            <select name="mod_p_ncorr" id="mod_p_ncorr" required type="text" class="form-control" placeholder="Perfiles">
                                <?php 
                                    ...
                                    while ($row_papa=mysqli_fetch_array($query_papa)) {
                                                ?>
                                    <option value="<?php echo $row_papa['p_ncorr']?>"><?php echo ($row_papa['nombre'])?></option>
                                <?php }?>
                            </select>    
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                            <select name="mod_m_ncorr" id="mod_m_ncorr" required type="text" class="form-control" placeholder="Menús">
                                <?php 
                                    ...
                                    while ($row_papa=mysqli_fetch_array($query_papa)) {
                                                ?>
                                    <option value="<?php echo $row_papa['m_ncorr']?>"><?php echo ($row_papa['nombre'])?></option>
                                <?php }?>
                            </select>    
                            <span class="fa fa-user form-control-feedback right" aria-hidden="true"></span>
                        </div>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                            <select name="mod_mh_ncorr" id="mod_mh_ncorr" required type="text" class="form-control" placeholder="Menús Hijos">
                                <?php 
                                    ...
                                    while ($row_papa=mysqli_fetch_array($query_papa)) {
                                                ?>
                                    <option value="<?php echo $row_papa['mh_ncorr']?>"><?php echo ($row_papa['nombre'])?></option>
                                <?php }?>
                            </select>    
                            <span class="fa fa-user form-control-feedback right" aria-hidden="true"></span>
                        </div>
