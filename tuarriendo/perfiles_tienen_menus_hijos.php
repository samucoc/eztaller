        ...
        <div class="">
            <div class="page-title">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <?php
                        include("modal/new_perfiles_tienen_menus_hijos.php");
                        include("modal/upd_perfiles_tienen_menus_hijos.php");
                    ?>
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Perfiles tienen Menús Hijos</h2>
                            <div class="clearfix"></div>
                        </div>
...
<script type="text/javascript" src="js/perfiles_tienen_menus_hijos.js"></script>
...
$( "#add_user" ).submit(function( event ) {
    ...
    var parametros = $(this).serialize();
     $.ajax({
            type: "POST",
            url: "action/add_perfiles_tienen_menus_hijos.php",
            data: parametros,
...
$( "#upd_user" ).submit(function( event ) {
 ...
 var parametros = $(this).serialize();
     $.ajax({
            type: "POST",
            url: "action/upd_perfiles_tienen_menus_hijos.php",
            data: parametros,
             beforeSend: function(objeto){
