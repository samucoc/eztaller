<?php
    ...
    if (isset($_GET['id'])){
        ...
        $query=mysqli_query($con, "SELECT * from perfiles_tienen_menus where ptm_ncorr='".$id_expence."'");
        $count=mysqli_num_rows($query);
            if ($delete1=mysqli_query($con,"DELETE FROM perfiles_tienen_menus WHERE ptm_ncorr='".$id_expence."'")){
            ?>
...
<?php
    if($action == 'ajax'){
        ...
        $aColumns = array('ptm','perfil', 'menu');//Columnas de busqueda
        $sTable = "perfiles_tienen_menus";
        $sWhere = "";
        ...
        $reload = './perfiles_tienen_menus.php';
            ...
            <table class="table table-striped jambo_table bulk_action">
                ...
                ?>
                    ...
                    <tr class="even pointer">
                        <td><?php echo ($id);?></td>
                        <td><?php echo ($str_perfil);?></td>
                        <td><?php echo ($str_menu);?></td>
