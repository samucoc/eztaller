<?php /* Smarty version 2.6.18, created on 2013-10-07 08:33:18
         compiled from sg_informe_compra_combustibles.tpl */ ?>
						...
						<form id="Form1" name="Form1" method="post" runat="server">
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%"><label class="form-titulo">&nbsp;&nbsp;Informe de compra de combustibles</label></td>
								</tr>
							</table>
							<br>
							<table class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								...
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 15%">Usuario:</td>
									<td class="tabla-alycar-texto" style="width: 85%">
                                        <input id="usuario" name="usuario" onchange="verificaValor(this.value)" />
                                        <input type="hidden" name="OBLI-txtCodCobrador" id="OBLI-txtCodCobrador" />
									</td>	
								</tr>
								<tr align="left">
