<?php /* Smarty version 2.6.18, created on 2014-01-02 18:21:37
         compiled from sg_informe_siniestros.tpl */ ?>
						...
						<form id="Form1" name="Form1" method="post" runat="server">
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%"><label class="form-titulo">&nbsp;&nbsp;Informe Siniestros</label></td>
								</tr>
							</table>
							<br>
							<table class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left">
									...
									<td class="tabla-alycar-texto" style="width: 85%">
                                        <input name="fecha1" id="fecha1" value="" /> 
                                        al 
                                        <input name="fecha2" id="fecha2" value="" /> 
                                    </td>	
								</tr>
                                <tr align="left">
								...
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 15%">Trabajador que conducia:</td>
									<td class="tabla-alycar-texto" style="width: 85%">
                                        <input name="trabajador" id="trabajador" value="" />
                                        <input type="hidden" name="rut_trab" id="rut_trab" value="" />
									</td>	
								</tr>
								<tr align="left">
