<?php /* Smarty version 2.6.18, created on 2015-04-22 14:38:57
         compiled from sg_bodega_aumentos.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'sg_bodega_aumentos.tpl', 113, false),)), $this); ?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<HEAD>
		...
		<title> Aumentos a Bodega Central </title>
					...
					<tr>
						<td>
							<table border="0" class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr> 
									<td colspan="2" class="tabla-alycar-fila-informa-requerida-contrato">Ingreso Facturas Repuestos</td>
								</tr>
								<tr align="left">
...
' onKeyPress="return SoloNumeros(this, event, 0)" maxLength="10" size="10">
								...
								<tr align="left">
									<tr align="left">
										<td class="tabla-alycar-label" style="width: 30%">Nro Documento:<label class="requerido"> * </label></td>
										<td class="tabla-alycar-texto" style="width: 70%">
							...
							<table class="grilla-tab" border="0" cellspacing="0" cellpadding="0" width="100%">
								<tr>
									<td class="grilla-tab-fila-campo" style="width: 45%" align='center'>Producto
										<a href="#" style="cursor: hand;"><img  src="../images/magnify.png" border=0 title="Click para Buscar" onclick="showPopWin('sg_busqueda.php?entidad=4&obj1=OBLItxtCodProducto&obj2=OBLItxtDescProducto', 'Busca Art�culo', 550, 350, null);"></a>
									</td>
									...
									<td class="grilla-tab-fila-campo" style="width: 8%" align='center'>Descuento</td>
									<td class="grilla-tab-fila-campo" align='center'></td>
								</tr>								
								<tr>
									<td class="grilla-tab-fila-campo" style="width: 45%" align='left'>
										<INPUT type="text" id="OBLItxtCodProducto" name="OBLItxtCodProducto" value='' onKeyPress="return SoloNumeros(this, event, 1)" onchange="xajax_CargaDesc(xajax.getFormValues('Form1'), 'sgcopec.tallas', 'ta_ncorr', 'ta_descripcion', 'OBLItxtCodProducto', 'OBLItxtDescProducto', '');" maxLength="10" style="width: 15%">
									...
									<td class="grilla-tab-fila-campo" style="width: 20%" align='left'>
										<INPUT type="text" id="OBLItxtMarcaProducto" name="OBLItxtMarcaProducto" value='' maxLength="100" style="width: 75%" readonly>
									...
									<td class="grilla-tab-fila-campo" style="width: 8%" align='center'>
										<INPUT type="text" style="width: 99%" id="OBLItxtDescuento" name="OBLItxtDescuento" onKeyPress="return SoloNumeros(this, event, 0)" onchange="xajax_CalculaTotalesLinea(xajax.getFormValues('Form1'))" value='0' maxLength="10">
									</td>
