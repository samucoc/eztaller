<?php /* Smarty version 2.6.18, created on 2016-10-20 15:18:22
         compiled from sg_cotizacion_ingresar.tpl */ ?>
						...
						<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%"><label class="form-titulo">Ingresar Cotizacion</label></td>
								</tr>
							</table>
							<br>
						</td>
					...
					<tr>
						...
						<td class="tabla-alycar-texto" >
							<table class="tabla-alycar" cellpadding="2" cellspacing="2" style="WIDTH: 100%; float: left; border: 1pt solid #B9B9B9; 	background:#ffffff">
								<tr>
									<td>
										<input type="text" name="cliente" id="cliente" size="50">
										<input type="hidden" name="rut_trabajador" id="rut_trabajador">
									</td>
									<td class="tabla-alycar-label">
										<a href="#" onclick="xajax_AgregarPersona(xajax.getFormValues('Form1'));">
											<img src="../images/plus.png" title="Agregar Cliente" />
										</a>
									</td>
								</tr>
							</table>
					...
					<tr>
						<td class="tabla-alycar-label" colspan="99">
							<a href="#" onclick="xajax_Grabar(xajax.getFormValues('Form1'));">
								<img src='../images/basicos/guardar.png' title='Grabar Cotizacion' width="32"/>
							</a>
						</td>
					</tr>
				</table>
