<?php /* Smarty version 2.6.18, created on 2013-02-06 15:08:38
         compiled from sg_combustible_ingresar_boleta.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'sg_combustible_ingresar_boleta.tpl', 206, false),)), $this); ?>
...
" > 
									...
									<td class="tabla-alycar-label" style="width: 15%">Trabajador Asignado</td>
								...
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 15%">Numero Boleta:<label class="requerido"> * </label></td>
									<td class="tabla-alycar-texto" >
										<INPUT type="text" id="OBLItxtBoleta" name="OBLItxtBoleta" value='' onKeyPress="return SoloNumeros(this, event, 0)" value="">
									</td>
								</tr>
								<tr align="left">
