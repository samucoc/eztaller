	...
	<option value="1">Con Boleta</option>
								...
								<tr align="left">
                                    ...
                                    <td class="tabla-alycar-texto" style="width: 20%">
										<INPUT type="text" id="OBLI-txtFecha" name="OBLI-txtFecha"  onKeyPress="return SoloNumeros(this, event, 0)" value="{if ($carga_fecha=='')}
								...
								<tr align="left">
									...
									<td class="tabla-alycar-texto" style="">
                                    	<input name="cboPersona" id="cboPersona" value="{$CARGA_NOM_PERS}" onblur="verificaValor(this.value)"/>
								...
								<tr align="left">
									...
									<td class="tabla-alycar-texto" style="width: 15%">
									    <div name="pers_asig" id="pers_asig" style="float: Left;">{$pers_asig}</div>
									    <input type="hidden" name="pa_oculto" id="pa_oculto" value="{$pers_asig}"/>
				...
				<tr align="left">
					...
					<td class="tabla-alycar-texto" >
						<div id="monto-cargado" style="float: Left;">{$monto_dispo}</div>
						<input type="hidden" id="cargado_oculto" name="cargado_oculto"value="{$monto_dispo}" readonly/>					</td>
                                </tr>
				<tr align="left">
					...
					<td class="tabla-alycar-texto" >
						<div id="OBLItxtMontoDisponible">{$cargado}</div>
