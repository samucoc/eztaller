<?php
/**
 * Layout #11 for Portolio single post
 * a screenshot of it: /wp-content/themes/wplab-albedo/images/portfolio_single_layouts/layout_11.jpg
 **/
	the_post();
	$post_id = get_the_ID();
...
<div id="post-<?php the_ID(); ?>" <?php post_class( 'single-portfolio-post-container layout-style_11 content-align-' . $post_text_align ); ?>>
	<div class="container">
		...
		<div class="row">
			...
			<div id="content" class="<?php echo wplab_albedo_front::get_content_classes(); ?>">
				...
				<div class="content-wrapper">
					...
					<?php get_template_part( 'template-parts/portfolio/single/parts/grid' ); ?>
