	...
	array(
		...
		'general' => array(
			...
			'options' => array(
					...
					'picker' => array(
						'style' => array(
							...
							'choices' => array(
								...
								'white corners' => esc_html__( 'White, with rounded corners', 'albedo' ),
								'blue' => esc_html__( 'Blue', 'albedo' ),
								'blue corners' => esc_html__( 'Blue, with rounded corners', 'albedo' ),
							),
						)
					),
					'choices' => array(
				...
				'bg_layers_position' => array(
					'label' => esc_html__( 'Background layers position', 'albedo' ),
					'type' => 'select',
					'value' => 'bottom',
					'choices' => array(
						'top' => esc_html__( 'Top', 'albedo' ),
						'bottom' => esc_html__( 'Bottom', 'albedo' ),
						'hidden' => esc_html__( 'Do not display', 'albedo' ),
					),
				),
				...
				'pagination_arrows' => array(
					...
					'choices' => array(
						'yes' => array(
							...
							'display_prev_name' => array(
								'label' => esc_html__( 'Display an author name from previous review ', 'albedo' ),
								'type' => 'switch',
								'left-choice' => array(
									'value' => 'no',
									'color' => '#ccc',
							...
							'prev_title' => array(
								'type'  => 'text',
								'label' => esc_html__('Previous link title', 'albedo'),
								'value' => esc_html__('Previous Review', 'albedo')
							),
							'display_next_name' => array(
								'label' => esc_html__( 'Display an author name from next review ', 'albedo' ),
								'type' => 'switch',
								'left-choice' => array(
									'value' => 'no',
									'color' => '#ccc',
							...
							'next_title' => array(
								'type'  => 'text',
								'label' => esc_html__('Next link title', 'albedo'),
								'value' => esc_html__('Next Review', 'albedo')
							),
