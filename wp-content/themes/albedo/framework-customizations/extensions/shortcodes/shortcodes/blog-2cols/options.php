	...
	array(
		...
		'appearance_tab' => array(
			...
			'options' => array(
				...
				'display_likes' => array(
					...
					'desc' => esc_html__( 'for standard post formats', 'albedo' ),
					'type' => 'switch',
					'value' => 'yes',
					'left-choice' => array(
						'value' => 'no',
				...
				'display_comments' => array(
					'label' => esc_html__( 'Display post comments', 'albedo' ),
					'desc' => esc_html__( 'for standard post formats', 'albedo' ),
					'type' => 'switch',
					'value' => 'yes',
					'left-choice' => array(
		...
		'style_tab' => array(
			...
			'options' => array(
				...
				'custom_radius' => array(
					'label' => esc_html__( 'Custom radius for thumbnails / media', 'albedo' ),
