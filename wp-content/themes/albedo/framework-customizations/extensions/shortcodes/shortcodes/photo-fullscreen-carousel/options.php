		...
		'query_tab' => array(
			...
			'options' => array(
				'posts_per_page' => array(
					'label' => esc_html__( 'Photos count', 'albedo' ),
					'type' => 'text',
					'value' => '10'
				),
				'order_by' => array(
					'label' => esc_html__( 'Photos ordering method', 'albedo' ),
					'type' => 'select',
					'value' => '',
					'choices' => array(
				...
				'sort_by' => array(
					'label' => esc_html__( 'Photos sorting method', 'albedo' ),
					'type' => 'select',
					'value' => '',
					'choices' => array(
		...
		'shortcode_style' => array(
			...
			'options' => array(
				...
				'display_author' => array(
					'label' => esc_html__( 'Display photo author', 'albedo' ),
					'type' => 'switch',
					'right-choice' => array(
						'value' => 'yes',
						'label' => esc_html__( 'Yes', 'albedo' )
