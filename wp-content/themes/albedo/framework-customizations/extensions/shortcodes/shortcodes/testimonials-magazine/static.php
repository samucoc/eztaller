...
if ( ! function_exists( '_action_wplab_albedo_shortcode_testimonials_magazine_enqueue_dynamic_css') ):

	/**
	 * @internal
	 * @param array $data
	 */
	function _action_wplab_albedo_shortcode_testimonials_magazine_enqueue_dynamic_css( $data ) {

		$shortcode = 'testimonials-carousel';
		...
		wp_enqueue_style( 'wplab-albedo-testimonials-magazine', wplab_albedo_utils::locate_uri( '/css/front/css/shortcodes/testimonials_magazine.css'), false, _WPLAB_ALBEDO_CACHE_TIME_ );
		wp_enqueue_style( 'wplab-albedo-testimonials-magazine-variable', wplab_albedo_utils::locate_uri( '/css/front/less/shortcodes/testimonials_magazine_variable.less'), false, _WPLAB_ALBEDO_CACHE_TIME_ );
	...
	add_action(
		'fw_ext_shortcodes_enqueue_static:testimonials_magazine',
		'_action_wplab_albedo_shortcode_testimonials_magazine_enqueue_dynamic_css'
	);
