...
$atts['tpl'] = 'template-parts/portfolio/grid';
...
if( isset( $atts['display_layers'] ) && ! filter_var( $atts['display_layers'], FILTER_VALIDATE_BOOLEAN ) ) {
...
if( $posts->have_posts() ):
?>
<div id="shortcode-<?php echo esc_attr( $atts['id'] ); ?>" class="portfolio-masonry-grid-shortcode <?php if( filter_var( $atts['display_lightbox_icon'], FILTER_VALIDATE_BOOLEAN ) ): ?>with-lightbox<?php endif; ?>">
	<?php
	...
	<div id="posts-container-id-<?php echo esc_attr( $atts['id'] ); ?>" class="portfolio-masonry-grid masonry-grid <?php echo implode(' ', $classes ); ?>">
