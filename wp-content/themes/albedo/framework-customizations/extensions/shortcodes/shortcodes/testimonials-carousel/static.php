...
if ( ! function_exists( '_action_wplab_albedo_shortcode_testimonials_carousel_enqueue_dynamic_css') ):

	/**
	 * @internal
	 * @param array $data
	 */
	function _action_wplab_albedo_shortcode_testimonials_carousel_enqueue_dynamic_css( $data ) {
		...
		wp_enqueue_style( 'wplab-albedo-testimonials-carousel', wplab_albedo_utils::locate_uri( '/css/front/css/shortcodes/testimonials_carousel.css'), false, _WPLAB_ALBEDO_CACHE_TIME_ );
		wp_enqueue_style( 'wplab-albedo-testimonials-carousel-variable', wplab_albedo_utils::locate_uri( '/css/front/less/shortcodes/testimonials_carousel_variable.less'), false, _WPLAB_ALBEDO_CACHE_TIME_ );
	...
	add_action(
		'fw_ext_shortcodes_enqueue_static:testimonials_carousel',
		'_action_wplab_albedo_shortcode_testimonials_carousel_enqueue_dynamic_css'
	);
