<?php	
	...
	if (empty($_POST['name'])) {
		...
		if(isset($_POST["is_admin"])){$is_admin=1;}
			...
			$sql="INSERT INTO user ( username, name, password, email, perfil, profile_pic, is_active, created_at) 
				  VALUES ('$email','$end_name','$password','$email','$perfil','$profile_pic',$status,'$created_at')";
