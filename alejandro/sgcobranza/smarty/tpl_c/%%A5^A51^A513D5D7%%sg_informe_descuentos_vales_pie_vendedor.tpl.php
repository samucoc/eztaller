<?php /* Smarty version 2.6.18, created on 2014-01-28 12:47:13
         compiled from sg_informe_descuentos_vales_pie_vendedor.tpl */ ?>
						...
						<form id="Form1" name="Form1" method="post" runat="server">
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%"><label class="form-titulo">&nbsp;&nbsp;Consulta de Vales de Pie Vendedor Ventas
</label></td>
								</tr>
							</table>
							<br>
