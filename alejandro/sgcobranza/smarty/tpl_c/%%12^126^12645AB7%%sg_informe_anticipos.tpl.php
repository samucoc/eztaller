<?php /* Smarty version 2.6.18, created on 2014-02-17 09:47:18
         compiled from sg_informe_anticipos.tpl */ ?>
						...
						<form id="Form1" name="Form1" method="post" runat="server">
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%"><label class="form-titulo">&nbsp;&nbsp;Consulta de Anticipo Mensual</label></td>
								</tr>
							</table>
							<br>
							<table class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								...
								<tr align="left">
									...
									<td class="tabla-alycar-texto" style="width: 85%">
										<INPUT type="text" id="OBLItxtFecha1" name="OBLItxtFecha1" value='' onKeyPress="return SoloNumeros(this, event, 0)" maxLength="10" size="10" />  al
                                        <INPUT type="text" id="OBLItxtFecha2" name="OBLItxtFecha2" value='' onKeyPress="return SoloNumeros(this, event, 0)" maxLength="10" size="10" /></td>	
								</tr>
								<tr align="left">
