<?php /* Smarty version 2.6.18, created on 2018-08-15 21:31:03
         compiled from sg_consultas_compromisos_bitacora.tpl */ ?>
		...
		<script type="text/javascript">
			$(document).ready(function() { 
                           ...
                           $.datepicker.setDefaults($.datepicker.regional[\'es\']);                            
                            $(\'#txtFecha1,#txtFecha2,#fch_buscar\').datepicker({
                                  showOn: "button",
						...
						<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%"><label class="form-titulo">Informe de Compromisos para el dia</label></td>
								</tr>
							</table>
							<br>
							...
							<table border="0" class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left">
									...
									<td class="tabla-alycar-texto" >
										<input type="text" name="fch_buscar" id="fch_buscar">
									</td>
								</TR>
