<?php /* Smarty version 2.6.18, created on 2017-05-26 21:13:17
         compiled from sg_cobranza_alumnos_morosos_detalle.tpl */ ?>
					...
					<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%">
                                    	<label class="form-titulo">&nbsp;&nbsp;Detalle Apoderado Moroso</label>
...
"/>
		...
		<div id="divlistado" align="left" style="display: none; margin-left:2px; padding: 2px;">
				<table class="curvar" cellpadding="2" cellspacing="2" style="WIDTH: 100%; float: left; border: 1pt solid #B9B9B9; background:#ffffff">
					<tr>
						<td>
							<input type="hidden" name="fecha_buscar" id="fecha_buscar" value="<?php echo $this->_tpl_vars['fecha_buscar']; ?>
">
