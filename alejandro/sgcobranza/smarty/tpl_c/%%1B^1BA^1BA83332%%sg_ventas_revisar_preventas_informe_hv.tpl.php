<?php /* Smarty version 2.6.18, created on 2014-07-15 12:52:48
         compiled from sg_ventas_revisar_preventas_informe_hv.tpl */ ?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="xajax_CargaPagina(xajax.getFormValues('Form1'));" style="background:#ffffff;"> 
		...
		<form id="Form1" name="Form1" method="post" runat="server">
			<input type="hidden" name="txtNumFolio" id="txtNumFolio" value="<?php echo $this->_tpl_vars['folio']; ?>
"/>
			<input type="hidden" name="txtEmpresa" id="txtEmpresa" value="<?php echo $this->_tpl_vars['empresa']; ?>
"/>
			<div id="divresultado"> 
						...
						<td>
							<table border="0" class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								...
								<tr align="left" >
                                    ...
                                    <td class="tabla-alycar-texto" style="font-size:16px"><?php echo $this->_tpl_vars['folio']; ?>
</td>
                                </tr>
								<tr> 
