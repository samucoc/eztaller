<?php /* Smarty version 2.6.18, created on 2014-04-16 15:45:51
         compiled from sg_locomocion_ingresar_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'sg_locomocion_ingresar_list.tpl', 13, false),)), $this); ?>
...
?>
	<tr>
		...
		<td class="grilla-tab-fila-campo">
        	<?php echo $this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['dias']; ?>

        </td>
		<td class="grilla-tab-fila-campo">
        	<?php echo $this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['total']; ?>
...
<?php endfor; endif; ?>
	<tr>
		<td class="grilla-tab-fila-campo" colspan="2">
        	<a href="http://192.168.1.102/sgvales/sitio/scripts/enviar_correo_locomocion.php?grupo=<?php echo $this->_tpl_vars['grupo']; ?>
" >Enviar Correo</a>
        </td>
		<td class="grilla-tab-fila-campo" colspan="2">
        	Total
