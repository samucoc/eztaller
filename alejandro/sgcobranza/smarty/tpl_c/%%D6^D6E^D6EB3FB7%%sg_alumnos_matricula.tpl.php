<?php /* Smarty version 2.6.18, created on 2018-05-29 20:43:53
         compiled from sg_alumnos_matricula.tpl */ ?>
	...
	<HEAD>
       ...
       <meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
        ...
        <!-- librerias para popup submodal -->
			...
			<LINK href="../../sgadministrativo/estilos/smoothness/jquery-ui-1.10.0.custom.css" type="text/css" rel="stylesheet">	
		...
		<script type="text/javascript" > 
                        function verificaValor(){
                        	var temp = document.getElementById("BSCNombresAlumno").value;
                            if (temp==\'\'){
					...
					<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									<td style="width: 93%"><label class="form-titulo">&nbsp;&nbsp;Cartola Alumnos</label></td>
							...
							<table class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left">
								  ...
								  <td class="tabla-alycar-texto" style="width: 20%">
                                  	<select id="curso" name="curso" onchange="xajax_Grabar(xajax.getFormValues('Form1'));"></select>
                                  </td>
							  	</tr>
		  						<tr align="left">
								  <td class="tabla-alycar-label" style="width: 15%">Alumno:</td>
								  <td class="tabla-alycar-texto" style="width: 20%">
                                	<input type="text" id="BSCNombresAlumno" name="BSCNombresAlumno" onKeyPress="return Tabula(this, event, 0)" onchange="verificaValor()"; maxLength="100" size="50"/>
                                    <input type="hidden" id="OBLINumeroRutAlumno" name="OBLINumeroRutAlumno" value="<?php echo $this->_tpl_vars['rut_alumno']; ?>
"/>
                                    <script type="text/javascript">
									<?php echo '
										$(document).ready(function() {
											$("#BSCNombresAlumno").autocomplete({
												source : \'busquedas/busqueda_OBLINumeroRutAlumno.php\',
												select: function( event, ui ) {
													var rut = ui.item.id;
													document.getElementById(\'OBLINumeroRutAlumno\').value = rut;
													xajax_Grabar(xajax.getFormValues(\'Form1\'));
													}
												});
											});
								...
								<tr align="left">
								  ...
								  <td class="tabla-alycar-texto" style="width: 20%">
                                	<input type="text" id="BSCNombresApoderado" name="BSCNombresApoderado" onKeyPress="return Tabula(this, event, 0)" onchange="verificaValor()"; maxLength="100" size="50"/>
                                    <input type="hidden" id="OBLINumeroRutApoderado" name="OBLINumeroRutApoderado" value=""/>
                                    <script type="text/javascript">
									<?php echo '
										$(document).ready(function() {
