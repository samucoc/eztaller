<?php /* Smarty version 2.6.18, created on 2016-09-12 10:45:41
         compiled from sg_movimientos_detalle.tpl */ ?>
					...
					<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%"><label class="form-titulo">&nbsp;&nbsp;Detalle Boleta </label>
										<input type="hidden" name="nro_boleta" id="nro_boleta" value="<?php echo $this->_tpl_vars['nro_boleta']; ?>
"/>
									</td>
								</tr>
							</table>
