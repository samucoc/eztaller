<?php /* Smarty version 2.6.18, created on 2016-11-28 21:15:05
         compiled from sg_alumnos_cobranza_movimientos_imp_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'sg_alumnos_cobranza_movimientos_imp_list.tpl', 33, false),array('modifier', 'number_format', 'sg_alumnos_cobranza_movimientos_imp_list.tpl', 34, false),)), $this); ?>
<div id="pivot">										
<table class="grilla-tab" border="0" cellspacing="0" cellpadding="0" width="100%">
<tr>
    	<td colspan="2" class="grilla-tab-fila-titulo">Detalle de Pagos A&ntilde;o <?php echo $this->_tpl_vars['anio']; ?>
</td> 
    </tr>
	<tr>
...
<tr>
    ...
    <td class="grilla-tab-fila-campo" align='right' colspan="6"><label id="total" name="total"><?php echo $this->_tpl_vars['tot_valor']; ?>
</label></td>
    </tr>
