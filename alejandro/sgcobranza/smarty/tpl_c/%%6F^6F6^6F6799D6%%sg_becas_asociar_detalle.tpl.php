<?php /* Smarty version 2.6.18, created on 2018-10-29 20:58:48
         compiled from sg_becas_asociar_detalle.tpl */ ?>
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%">
                                        ...
                                        <input type="hidden" name="NumeroRutAlumno" id="NumeroRutAlumno" value="<?php echo $this->_tpl_vars['NumeroRutAlumno']; ?>
"/>
                                        <input type="hidden" name="CodigoCurso" id="CodigoCurso" value="<?php echo $this->_tpl_vars['CodigoCurso']; ?>
"/>
                                    </td>
								</tr>
							</table>
