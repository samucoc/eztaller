<?php /* Smarty version 2.6.18, created on 2017-03-08 22:52:41
         compiled from sg_consultas_cumple_pagos_cursos.tpl */ ?>
					...
					<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%">
                                    	<label class="form-titulo">&nbsp;&nbsp;Cumplimientos Pagos por Cursos</label>
                                    </td>
								</tr>
							</table>
							<br>
