<?php /* Smarty version 2.6.18, created on 2017-07-28 20:42:29
         compiled from sg_cobranza_cheques.tpl */ ?>
					...
					<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%">
                                    	<label class="form-titulo">&nbsp;&nbsp;Registra Pagos de Cheques</label>
                                    </td>
								</tr>
							</table>
							<br>
							<table class="tabla-alycar"  border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left">
									...
									<td class="tabla-alycar-texto" style="width: 35%">
										<SELECT id="cboBanco" name="cboBanco" style="width: 100%" onKeyPress="return SoloNumeros(this, event, 0)">
										</SELECT>
									</td>	
									<td class="tabla-alycar-label" style="width: 15%">Rango:</td>
									<td class="tabla-alycar-texto" style="width: 35%">
								...
								<tr align="left">
									...
									<td class="tabla-alycar-texto" style="width: 35%">
										<input type="text" id="txtNroCheque" name="txtNroCheque" style="width: 100%" onKeyPress="return SoloNumeros(this, event, 0)" />
									</td>	
									<td class="tabla-alycar-label" style="width: 15%"></td>
									<td class="tabla-alycar-texto" style="width: 35%"></td>	
								</tr>
								<tr align="left" valign="middle">
