<?php /* Smarty version 2.6.18, created on 2018-09-11 21:01:42
         compiled from sg_cobranza_alumnos_morosos.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'sg_cobranza_alumnos_morosos.tpl', 214, false),)), $this); ?>
		...
		<?php echo '
		 <script type="text/javascript">
			function cambiar(){
					...
					var x=0;
					for (x=0 ; x < document.getElementsByName(\'seleccion[]\').length ; x++){
						if (todos==true){
		...
		<script type="text/javascript">
			$(document).ready(function() { 
                           ...
                           $.datepicker.setDefaults($.datepicker.regional[\'es\']);                            
                            $(\'#fecha_buscar,#fecha1,#fecha2\').datepicker({
                                  showOn: "button",
					...
					<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%">
                                    	<label class="form-titulo">&nbsp;&nbsp;Alumnos Morosos</label>
                                    </td>
								</tr>
							</table>
							<br>
							<table class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								 <tr align="left">
								  <td class="tabla-alycar-label" style="width: 15%">Fecha de Corte:</td>
								  <td class="tabla-alycar-texto" style="width: 20%">
                                  	<input type="text" id="fecha_buscar" name="fecha_buscar"
                                  			value="<?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d/%m/%Y") : smarty_modifier_date_format($_tmp, "%d/%m/%Y")); ?>
" />
                                  </td>
							  	</tr> 
								<tr align="left">
								  <td class="tabla-alycar-label" style="width: 15%">Cursos:</td>
								  <td class="tabla-alycar-texto" style="width: 20%">
