<?php /* Smarty version 2.6.18, created on 2013-03-21 16:52:48
         compiled from sg_informe_nota_credito.tpl */ ?>
						...
						<form id="Form1" name="Form1" method="post" runat="server">
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%"><label class="form-titulo">&nbsp;&nbsp;Informe de Notas de Credito</label></td>
								</tr>
							</table>
							<br>
							<table class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								...
								<tr align="left">
								  ...
								  <td class="tabla-alycar-texto" style="width: 15%"><input id="nc" name="nc"  /></td>
							  </tr>
								<tr align="left">
								...
								<tr align="left">
								  <td class="tabla-alycar-label" style="width: 15%">Tipo de Nota de Debito:</td>
