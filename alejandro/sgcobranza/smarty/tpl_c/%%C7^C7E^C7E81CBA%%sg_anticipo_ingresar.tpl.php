<?php /* Smarty version 2.6.18, created on 2014-04-15 19:18:54
         compiled from sg_anticipo_ingresar.tpl */ ?>
			...
			<table class="curvar" cellpadding="2" cellspacing="2" style="WIDTH: 99%; float: left; border: 1pt solid #B9B9B9; background:#ffffff">
				<tr>
					<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%"><label class="form-titulo">&nbsp;&nbsp;Ingreso de Anticipo<br />
								  </label></td>
								</tr>
							</table>
							<br>
					...
					<tr align="left">
								...
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 15%">Tipo Anticipo</td>
                                	<td class="tabla-alycar-texto" style="width: 20%">
                                    	<select name="tipo_anticipo" id="tipo_anticipo">
                                        	<option value="1">Quincenal</option>
                                        	<option value="2">Por comision Ventas</option>
