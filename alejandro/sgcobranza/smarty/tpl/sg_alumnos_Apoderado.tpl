					...
					<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%">
                                    	<label class="form-titulo">&nbsp;&nbsp;Apoderado</label>
							...
							<table class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left">
                                    	<td class="tabla-alycar-texto" colspan="2">
		                                	<input type="button" name="ficha_alumno" id="ficha_alumno" onclick="location.href='sg_mant_tablas_alumnos.php?tbl=alumnos&rut_alumno={$rut}'"  class="boton" value="Fichas Alumnos"/>
		                                	<input type="button" name="btnNotas" id="btnNotas" onclick="location.href='sg_alumnos_notas.php?rut={$rut}'"  class="boton" value="Notas"/>
		                                	<input type="button" name="btnHojaVida" id="btnHojaVida" onclick="location.href='sg_alumnos_HojaVida.php?rut={$rut}'"  class="boton" value="Hoja de vida"/>
		                                	<input type="button" name="btnAsistencia" id="btnAsistencia" onclick="location.href='sg_alumnos_Asistencia.php?rut={$rut}'"  class="boton" value="Asistencia"/>
		                                	<input type="button" name="btnAsistencia" id="btnAsistencia" onclick="location.href='sg_alumnos_Apoderado.php?rut={$rut}'"  class="boton" value="Apoderado"/>
                                    	</td>
                                    </tr>
                                <tr align="left">
								...
								<tr align="left">
									<td colspan="2" class="tabla-alycar-fila-botones">
										<input type="button" name="btnGrabar" value="Grabar" class="boton" onclick="xajax_Grabar(xajax.getFormValues('Form1'));">
									&nbsp;&nbsp;&nbsp;&nbsp;</td>
								</tr>
