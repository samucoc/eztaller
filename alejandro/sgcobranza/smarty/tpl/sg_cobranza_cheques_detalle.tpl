							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%">
                                    	...
                                    	<input type="hidden" name="cheque_ncorr" id="cheque_ncorr" value="{$cheque_ncorr}" />
                                    </td>
								</tr>
							</table>
							<br>
							<table class="tabla-alycar"  border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								...
								<tr align="left" valign="middle">
									<td class="tabla-alycar-label" style="width: 15%">Banco:</td>
								  	<td class="tabla-alycar-texto" style="width: 20%">
                                    	<input type="text" name="NombreBanco" id="NombreBanco" value="{$banco}"/>
								...
								<tr align="left" valign="middle">
									<td class="tabla-alycar-label" style="width: 15%">Valor:</td>
								  	<td class="tabla-alycar-texto" style="width: 20%">
                                    	<input type="text" name="ValorCheque" id="ValorCheque" value="{$valor}"/>
								...
								<tr align="left" valign="middle">
									<td class="tabla-alycar-label" style="width: 15%">Fecha:</td>
								  	<td class="tabla-alycar-texto" style="width: 20%">
                                    	<input type="text" name="FechaCheque" id="FechaCheque" value="{$fecha}"/>
                                    </td>
								</tr>
								<tr align="left" valign="middle">
