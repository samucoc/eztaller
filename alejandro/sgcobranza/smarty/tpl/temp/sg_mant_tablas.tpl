									...
									{if ($arrCampos[campos].titulo != '')}
										<tr align="left">
											...
											<td class="tabla-alycar-texto" style="width: 70%">
												...
												{elseif ($arrCampos[campos].objeto == 'MLT')}
													<div id="DIV{$arrCampos[campos].campo}" ></div>
                                                ...
                                                {elseif ($arrCampos[campos].objeto == 'CHK')}
													<INPUT type="checkbox" class="chk" id="CHK{$arrCampos[campos].campo}" name="CHK{$arrCampos[campos].campo}" value='1' onKeyPress="return Tabula(this, event, 0)" maxLength="100" size="50" />
                                                {elseif ($arrCampos[campos].objeto == 'TBL')}
													<INPUT type="text" class="rut" id="{$arrCampos[campos].campo}" name="{$arrCampos[campos].campo}" value='' onKeyPress="return Tabula(this, event, 0)" maxLength="100" size="50" />                                                                                                        
												{else}
