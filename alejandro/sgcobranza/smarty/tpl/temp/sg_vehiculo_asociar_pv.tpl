						...
						<form id="Form1" name="Form1" method="post" runat="server">
							...
							<tr align="left">
                                                                    <td colspan="2" class="tabla-alycar-fila-botones">
                                                                            ...
                                                                            <input style="display: none" type="button" name="btnVolver" id="btnVolver" value="Volver" class="boton floatLeft" onclick="document.location.href='sg_vehiculos_ingresar_carga.php?carga_veh={$carga_veh}&carga_nom_pers={$carga_nom_pers}&carga_pers={$carga_pers}&carga_monto={$carga_monto}&carga_fecha={$carga_fecha}'">
                                                                    </td>
							</tr>
