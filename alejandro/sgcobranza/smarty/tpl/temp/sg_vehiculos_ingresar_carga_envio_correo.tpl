							...
							<table border="0" class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								...
								<tr align="left">
									...
									<td class="tabla-alycar-texto" style="width: 70%">
                                        ...
                                        <input name="trabajador" id="trabajador" value="{$nombre}"/>
                                    </td>
								</tr>
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 30%">Monto a Solicitar:<label class="requerido"> * </label></td>
									<td class="tabla-alycar-texto" style="width: 70%">
										<INPUT type="text" id="monto" name="monto" value='{$carga_monto}' onKeyPress="return Tabula(this, event, 0)" />
									</td>
								</tr>
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 30%">Texto:<label class="requerido"> * </label></td>
									<td class="tabla-alycar-texto" style="width: 70%">
                                                                            <input type="hidden" name="id_carga" id="id_carga" value="{$id}"/> 
