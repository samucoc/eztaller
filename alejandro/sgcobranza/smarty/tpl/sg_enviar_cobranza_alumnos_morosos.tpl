							...
							<table class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left">
								  ...
								  <td class="tabla-alycar-texto" style="width: 20%">
                                  	...
                                  	<input type="hidden" id="rut" name="rut" value="{$rut}"></input>
                                  	<input type="hidden" id="fecha_buscar" name="fecha_buscar" value="{$fecha_buscar}"></input>
                                  	<input type="hidden" id="semestre" name="semestre" value="{$semestre}"></input>
                                  </td>
							  	</tr> 
								<tr align="left">
