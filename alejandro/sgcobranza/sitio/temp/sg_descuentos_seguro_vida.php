...
$xajax->setRequestURI("sg_descuentos_seguro_vida.php");
...
function Grabar($data){
	...
	$sql = "insert into seguro_vida (  `trabajador`, `monto`, `fecha`, `usuario`, `fecha_digitacion`, `estado` ) 
			values ( '$trabajador','$monto','$fecha','$usuario','$fecha_digitacion','$estado' )";
			
	$res = mysql_query($sql,$conexion) or die(mysql_error());
	$objResponse->addAlert("Descuento por seguro de vida ingresado correctamente.");
...
$miSmarty->display('sg_descuentos_seguro_vida.tpl');
