...
$xajax->setRequestURI("sg_descuentos_desc_folios.php");
...
function Grabar($data){
	...
	$sql = "insert into desc_folios (  `trabajador`, `monto`, `fecha`, `usuario`, `fecha_digitacion`, `estado` ) 
			values ( '$trabajador','$monto','$fecha','$usuario','$fecha_digitacion','$estado' )";
			
	$res = mysql_query($sql,$conexion) or die(mysql_error());
	$objResponse->addAlert("Descuento Folio ingresado correctamente.");
...
$miSmarty->display('sg_descuentos_desc_folios.tpl');
