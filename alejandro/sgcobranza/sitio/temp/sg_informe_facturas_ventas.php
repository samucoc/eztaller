...
$xajax->setRequestURI("sg_informe_facturas_ventas.php");
...
function Grabar($data){
	...
	if (mysql_num_rows($res_ab) > 0){
		...
		$objResponse->addAssign("divabonos", "innerHTML", $miSmarty->fetch('sg_informe_facturas_ventas_list.tpl'));
...
$miSmarty->display('sg_informe_facturas_ventas.tpl');
