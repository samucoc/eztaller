...
$xajax->setRequestURI("sg_descuentos_prestamos_caja.php");
...
function Grabar($data){
	...
	$sql = "insert into prestamos_caja (  `trabajador`, `monto`, `fecha`, `usuario`, `fecha_digitacion`, `estado` ) 
			values ( '$trabajador','$monto','$fecha','$usuario','$fecha_digitacion','$estado' )";
			
	$res = mysql_query($sql,$conexion) or die(mysql_error());
	$objResponse->addAlert("Prestamos de Caja ingresado correctamente.");
...
$miSmarty->display('sg_descuentos_prestamos_caja.tpl');
