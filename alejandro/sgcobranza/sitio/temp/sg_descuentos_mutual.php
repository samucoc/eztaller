...
$xajax->setRequestURI("sg_descuentos_mutual.php");
...
function Grabar($data){
	...
	$sql = "insert into mutual (  `trabajador`, `monto`, `fecha`, `usuario`, `fecha_digitacion`, `estado` ) 
			values ( '$trabajador','$monto','$fecha','$usuario','$fecha_digitacion','$estado' )";
			
	$res = mysql_query($sql,$conexion) or die(mysql_error());
	$objResponse->addAlert("Descuento Por Mutual ingresado correctamente.");
...
$miSmarty->display('sg_descuentos_mutual.tpl');
