...
$xajax->setRequestURI("sg_informe_descuentos_vales_pie_vendedor.php");
...
function Grabar($data){
	...
	if (($OBLItxtFecha1 != '') && ($OBLItxtFecha2 != '') ){
		...
		$and .= " and vales_pie_vendedor.fecha between '".$OBLItxtFecha1."' and '".$OBLItxtFecha2."' ";
	}
	...
	$sql_pd="SELECT fecha,
			 ...
			 where fecha_digitacion >= '2014-03-12' $and 
			 order by fecha asc";        
	...
	if (mysql_num_rows($res_pd) > 0){
		...
		$objResponse->addAssign("divabonos", "innerHTML", $miSmarty->fetch('sg_informe_descuentos_vales_pie_vendedor_list.tpl'));
...
$miSmarty->display('sg_informe_descuentos_vales_pie_vendedor.tpl');
