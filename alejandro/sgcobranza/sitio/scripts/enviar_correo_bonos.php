...
$body="<html>
		...
		$body			.= "<body>
								Se han ingresado ".$cantidad_filas." bonos por un total de $ ".$total." para su autorizacion
							</body></html>";
        ...
        if(!$mail->Send()) {
        	...
        	echo "No se ha podido enviar el correo. Intentelo haciendo click aca. <a href='http://192.168.0.50/sgvales/sitio/scripts/enviar_correo_bonos.php?grupo=".$grupo."' >Enviar Correo</a>";
        } else {
...
?>
<script>
	location.href="http://192.168.0.50/sgvales/sitio/sg_bono_ingresar.php";
</script>
