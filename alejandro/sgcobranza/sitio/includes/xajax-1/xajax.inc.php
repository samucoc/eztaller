 ...
 * 
 * @package xajax
 * @version $Id: xajax.inc.php 4 2007-02-14 14:12:43Z manilal $
...
class xajax
{
	 ...
	 */
	function _construct($sRequestURI="",$sWrapperPrefix="xajax_",$sEncoding=XAJAX_DEFAULT_CHAR_ENCODING,$bDebug=false)
	{
	...
	{	
		...
		if (isset($this->aFunctionIncludeFiles) && array_key_exists($sFunctionName,$this->aFunctionIncludeFiles))
		{
			ob_start();
	...
	{
		if ($sJsFile == NULL) $sJsFile = "includes/xajax/xajax_js/xajax.js";
	...
	{
		if (isset($this->aObjects) && array_key_exists($sFunction, $this->aObjects)) return true;
		return false;
	}
