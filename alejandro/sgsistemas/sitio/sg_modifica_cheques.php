...
function Grabar($data){
	...
	if ($ingresa == 'SI'){
		...
		if ($ChId != ''){
			...
			$sql = "insert into cheques (ChCtaCte,ChDocumento,ChFechaEmite,ChFechaVence,ChDetalle,ChValor,ChPagado,ChFechaPago)
					values 
					('".$ChCtaCte."','".$ChDocumento."','".$ChFechaEmite."','".$ChFechaVence."','".$ChDetalle."','".$ChValor."','".$ChPagado."','".$ChFechaPago."')";
		}
