<?php
/* Smarty version 3.1.33, created on 2019-08-01 15:03:39
  from '/home/dominios/gescol.cl/web/80/www.gescol.cl/public_html/nmva/sgadministrativo/smarty/tpl/sg_informes_alumnos_anual_notas.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5d43378b2fb6f7_03959160',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '178bd0022c7ecaa5453be5f97995752ae0630b84' => 
    array (
      0 => '/home/dominios/gescol.cl/web/80/www.gescol.cl/public_html/nmva/sgadministrativo/smarty/tpl/sg_informes_alumnos_anual_notas.tpl',
      1 => 1563312320,
      2 => 'file',
    ),
  ),
...
function content_5d43378b2fb6f7_03959160 (Smarty_Internal_Template $_smarty_tpl) {
					...
					<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%">
                                    	<label class="form-titulo">&nbsp;&nbsp;Certificado Anual de Notas</label>
                                    </td>
								</tr>
							</table>
							<br>
							<table class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left">
								  ...
								  <td class="tabla-alycar-texto" style="width: 20%">
                                  	<input name="OBLI-cboAlumno" type="text" id="OBLI-cboAlumno" size="50"/>
								...
								<tr align="left">
									<td colspan="2" class="tabla-alycar-fila-botones">
										<div style="text-align: left; float:left; width:5%">
											<a href="#" onclick="xajax_CargaListado(xajax.getFormValues('Form1'));">
												<img src='../images/basicos/buscar.png' title='Grabar' width="32"/>
											</a>
										</div>										
										<div style="text-align: left; font-size: 15px ; float:left; width:90%; ">
											Importante: Recuerde validar datos con Acta generada por SIGE Mineduc
										</div>
									</td>
								</tr>
