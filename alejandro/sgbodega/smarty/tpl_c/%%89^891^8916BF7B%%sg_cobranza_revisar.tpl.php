<?php /* Smarty version 2.6.18, created on 2014-02-05 21:16:26
         compiled from sg_cobranza_revisar.tpl */ ?>
						...
						<form id="Form1" name="Form1" method="post" runat="server">
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%"><label class="form-titulo">&nbsp;&nbsp;Revisar Cobranza</label></td>
								</tr>
							</table>
							<br>
							<table class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left">
								  ...
								  <td class="tabla-alycar-texto" style="width: 20%">
                                  	<input type="text" name=¨"OBLI-cboAlumno" id="OBLI-cboAlumno" size="50" width="50"/>
								...
								<tr align="left">
									...
									<td class="tabla-alycar-texto" style="width: 85%">
										<select name="OBLIAnio" id="OBLIAnio">
