<?php /* Smarty version 2.6.18, created on 2017-05-12 15:59:25
         compiled from sg_enviar_informe_alumnos_notas_parciales.tpl */ ?>
					...
					<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%">
                                    	<label class="form-titulo">Enviar Notas Parciales por Correo - <div id="nombre_alumno" name="nombre_alumno"></div></label>
                                    	</label> 
                                    </td>
								</tr>
							</table>
								...
								<tr align="left">
									<td colspan="2" class="tabla-alycar-fila-botones">
										<a href="#" onclick="xajax_Grabar(xajax.getFormValues('Form1'));">
											<img src='../images/basicos/email2.png' title='Enviar Notas Parciales por Correo' width="32"/>
										</a>
										</td>
								</tr>
