<?php /* Smarty version 2.6.18, created on 2017-02-06 20:58:21
         compiled from sg_informes_certificado_matricula_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'sg_informes_certificado_matricula_list.tpl', 59, false),)), $this); ?>
<div id='pivot'>
    <table>
        <tr>
...
,</div>
        ...
        <br />
        <br />
            <div style="padding-left: 12%; font-size: 14px; text-align: left">establecimiento para cursar  <?php echo $this->_tpl_vars['nombre_curso']; ?>
 a&ntilde;o 2016.</div>
        <br />
        <br />
    ...
    <!-- 
 	<table>
    	<tr>
    		<td colspan="4" align="right" style="background-image:url('<?php echo $this->_tpl_vars['Foto']; ?>
');
    	...
    	<tr>
        	<td colspan="4" align="right" >
            	<?php echo $this->_tpl_vars['Representante']; ?>
