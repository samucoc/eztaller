<?php
/* Smarty version 3.1.33, created on 2020-01-28 18:32:06
  from '/home/dominios/gescol.cl/web/80/www.gescol.cl/public_html/arcoiris/sgadministrativo/smarty/tpl/sg_notas_ingresar.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5e30a8563b1499_00719327',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '7ff67ed3c039f63f75c4b72429ceb04a5140f7fa' => 
    array (
      0 => '/home/dominios/gescol.cl/web/80/www.gescol.cl/public_html/arcoiris/sgadministrativo/smarty/tpl/sg_notas_ingresar.tpl',
      1 => 1579573413,
      2 => 'file',
    ),
  ),
...
function content_5e30a8563b1499_00719327 (Smarty_Internal_Template $_smarty_tpl) {
 ...
 type="text/javascript">
			$(document).ready(function() { 
                ...
                $("#curso").change(function(){
                	$.ajax({
                		url: 'busquedas/verificar_curso.php?CodigoCurso='+$("#curso").val()
                	}).done(function(e){
                		e=='1' ? $("#ingresoNotas").hide() : $("#ingresoNotas").show() 
                		e=='1' ? $("#ingresoNotasMsj").show() : $("#ingresoNotasMsj").hide() 
                	})
					...
					<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%"><label class="form-titulo">&nbsp;&nbsp;Ingreso y Consulta de Notas</label></td>
								</tr>
							</table>
							<br>
							<table class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								...
								<tr align="left">
								  ...
								  <td class="tabla-alycar-texto" style="width: 20%">
                                  	<select id="curso" name="curso"  onchange="xajax_CargaAsignaturas(xajax.getFormValues('Form1'))"></select>
                                  </td>
							  	</tr>
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 15%">Asignatura:</td>
									<td class="tabla-alycar-texto" style="width: 85%">
										<select name="asignaturas" id="asignaturas" onchange="carga_pruebas()">
                                        </select>
									</td>	
								</tr>
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 15%">Pruebas:</td>
									<td class="tabla-alycar-texto" style="width: 85%">
										<select name="pruebas" id="pruebas">
                                        </select>
									</td>	
								</tr>
								<tr align="left">
									...
									&nbsp;&nbsp;&nbsp;&nbsp;
                                    	<a href="#" onclick="xajax_Nueva(xajax.getFormValues('Form1'));" id="ingresoNotas">
											<img src='../images/basicos/agregar.png' title='Ingresar Notas' width="32"/>
										</a>
										<div id="ingresoNotasMsj" style="display:none">
											Curso Cerrado
										</div>
                                    </td>
								</tr>
