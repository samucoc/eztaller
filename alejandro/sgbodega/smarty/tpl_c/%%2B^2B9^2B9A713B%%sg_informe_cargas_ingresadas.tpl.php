<?php /* Smarty version 2.6.18, created on 2013-01-31 16:20:44
						...
						<form id="Form1" name="Form1" method="post" runat="server">
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%"><label class="form-titulo">&nbsp;&nbsp;Informe de Cargas Ingresadas</label></td>
								</tr>
							</table>
							<br>
								...
								<tr align="left">
									...
									<td class="tabla-alycar-texto" style="width: 85%">
                                                                            <select id="cboDetalle" name="cboDetalle" >
                                                                                ...
                                                                                <option value='ultimos'>Ultima</option>
                                                                            </select>
									</td>	
								</tr>
								<tr align="left">
