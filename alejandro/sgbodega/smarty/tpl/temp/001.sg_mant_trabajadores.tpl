                                  ...
                                  <td class="tabla-alycar-texto" ><input type="text" id="OBLIapellido_pat" name="OBLIapellido_pat" value="" onkeypress="return Tabula(this, event, 0)" maxlength="100" size="50" /></td>
									    ...
									    <tr align="left">
									      <td class="tabla-alycar-label">Fondos por Rendir
									        <label>&nbsp;*</label></td>
									      <td class="tabla-alycar-texto" ><input type="checkbox" id="CHKfondos_rendir" name="CHKfondos_rendir" onkeypress="return Tabula(this, event, 0)" maxlength="100" size="50" onchange="xajax_CambiarFxR(xajax.getFormValues('Form1'))"/></td>
								        </tr>
									    <tr align="left">
									      <td class="tabla-alycar-label">Vehiculos
									        <label>&nbsp;*</label></td>
									      <td class="tabla-alycar-texto" ><input type="checkbox" id="CHKvehiculos" name="CHKvehiculos"  onkeypress="return Tabula(this, event, 0)" maxlength="100" size="50" onchange="xajax_CambiarVehiculos(xajax.getFormValues('Form1'))"/></td>
								        </tr>
									    <tr align="left">
									      <td class="tabla-alycar-label">Cuentas Personales
									        <label>&nbsp;*</label></td>
									      <td class="tabla-alycar-texto" ><input type="checkbox" id="CHKcuentas_personales" name="CHKcuentas_personales" onkeypress="return Tabula(this, event, 0)" maxlength="100" size="50" onchange="xajax_CambiarCuentasPersonales(xajax.getFormValues('Form1'))"/></td>
								        </tr>
									    <tr align="left">
									      <td class="tabla-alycar-label">Ventas
									        <label>&nbsp;*</label></td>
									      <td class="tabla-alycar-texto" ><input type="checkbox" id="CHKventas" name="CHKventas"  onkeypress="return Tabula(this, event, 0)" maxlength="100" size="50" /></td>
								        </tr>
									    <tr align="left">
									      <td class="tabla-alycar-label">Bodega
									        <label>&nbsp;*</label></td>
									      <td class="tabla-alycar-texto" ><input type="checkbox" id="CHKbodega" name="CHKbodega"  onkeypress="return Tabula(this, event, 0)" maxlength="100" size="50" /></td>
								        </tr>
									    <tr align="left">
