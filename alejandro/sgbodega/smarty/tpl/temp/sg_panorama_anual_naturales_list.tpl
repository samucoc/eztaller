                        ...
                        {section name=registroNotas loop=$arrNotas}
                            {if $arrRegistros[registros].rut_alumno == $arrNotas[registroNotas].rut_alumno}
                                    {if $arrNotas[registroNotas].nota == 'XXX'}
                                        {if $arrNotas[registroNotas].CodigoRamo == 'Biologia'}
                                <td class='grilla-tab-fila-campo-pequenio' align='center' title="{$arrNotas[registroNotas].asignatura}" style="font-weight: bold" colspan="{$maximo}">{$arrNotas[registroNotas].CodigoRamo}</td>
                                        {elseif $arrNotas[registroNotas].CodigoRamo == 'Fisica'}
                                <td class='grilla-tab-fila-campo-pequenio' align='center' title="{$arrNotas[registroNotas].asignatura}" style="font-weight: bold" colspan="{$maximo_1}">{$arrNotas[registroNotas].CodigoRamo}</td>
                                        {elseif $arrNotas[registroNotas].CodigoRamo == 'Quimica'}
                                <td class='grilla-tab-fila-campo-pequenio' align='center' title="{$arrNotas[registroNotas].asignatura}" style="font-weight: bold" colspan="{$maximo_2}">{$arrNotas[registroNotas].CodigoRamo}</td>
                                        {else}
                                ...
                                <td class='grilla-tab-fila-campo-pequenio' align='center' >
                                        ...
                                        {else}
                                            {if ($arrNotas[registroNotas].nota<'4') }
                                                {if $arrNotas[registroNotas].promedio == '1'}
