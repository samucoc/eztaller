...
$xajax->setRequestURI("sg_consulta_alumnos_HojaVida.php");
...
function CargaListado($data){
	...
	$sql_ve = "select FechaHojaVida, DescripcionHojaVida, ObservacionHojaVida, TipoHojaVida.nombre, 

						DescripcionMotivo , CodigoRamo

				from HojasDeVida

					inner join TipoHojaVida

						on HojasDeVida.TipoHojaVida = TipoHojaVida.thv_ncorr

					inner join MotivoAnotaciones
...
$miSmarty->display('sg_consulta_alumnos_HojaVida.tpl');
