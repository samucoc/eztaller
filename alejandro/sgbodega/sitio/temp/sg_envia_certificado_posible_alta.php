...
$xajax->setRequestURI("sg_envia_certificado_posible_alta.php");
...
function Grabar($data){
    ...
    $objResponse->addScript("showPopWin('pdfs/pdf_enviar_certificado_posible_alta.php?email=$email&alumno=$alumno&observacion=$observacion', 'Imprime PDF', 400, 300, null);");
...
$miSmarty->display('sg_envia_certificado_posible_alta.tpl');
