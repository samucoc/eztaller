...
$xajax->setRequestURI("sg_imprimir_inscripcion.php");
...
function Grabar($data){
	...
	if ($flag=='0000-00-00'){
		$objResponse->addAssign("divabonos", "innerHTML", $miSmarty->fetch('sg_imprimir_inscripcion_list.tpl'));	
...
function GenerarPDF($data){
	...
	$objResponse->addScript("showPopWin('pdfs/pdf_generar_inscripcion_alumno.php?alumno=$alumno&observacion=$observacion', 'Imprime PDF', 800, 600, null);");
...
function EnivarPDF($data){
	...
	$objResponse->addScript("showPopWin('sg_envia_inscripcion_alumno.php?alumno=$alumno&observacion=$observacion', 'Enviar PDF', 600, 200, null);");
...
$miSmarty->display('sg_imprimir_inscripcion.tpl');
