		...
		Highcharts.chart('container', {
		    ...
		    title: {
		    	<?php 
						...
						$sql_ve = "select  NombreCurso, CodigoCurso from Cursos	where Cursos.CodigoCurso < '399' and CodigoCurso = '".$_GET['curso']."'	";
						...
						echo "text: 'Resumen Inasistencias'";
		        	?>
		    },
		    xAxis: {
		        categories: [
		    	...
		    	<?php 
					...
					for($mes='3';$mes<=12;$mes++){
						...
						$sql_ve = "select  NombreCurso, CodigoCurso 
									from Cursos	
									where Cursos.CodigoCurso < '399' and 
