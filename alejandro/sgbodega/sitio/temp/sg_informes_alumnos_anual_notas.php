...
function CargaListado($data){
   ...
   $objResponse = new xajaxResponse('UTF8');
	...
	$and_1 = '';
	if ($rut!=''){
		$and_1 .= " and alumnos".$anio.".NumeroRutAlumno = '".$rut."' and alumnos".$anio.".NumeroRutAlumno in (select distinct NumeroRutAlumno from SituacionFinal where AnoAcademico = ".$_SESSION["sige_anio_escolar_vigente"]." ) ";
		}
...
function ImprimePDF($data,$rut_alumno,$semestre){
	...
	$objResponse->addScript("showPopWin('pdfs/pdf_informe_alumnos_anual_notas.php?rut=$rut_alumno&semestre=$semestre', 'Imprime PDF', 800, 600, null);");
...
function ImprimePDFCurso($data){
	...
	$objResponse->addScript("showPopWin('pdfs/pdf_informe_alumnos_anual_notas_todos.php?curso=$curso&semestre=$semestre', 'Imprime PDF', 800, 600, null);");
...
function EnviarPDF($data,$rut_alumno,$semestre){
	...
	$objResponse->addScript("showPopWin('pdfs/pdf_enviar_informe_alumnos_anual_notas.php?rut=$rut_alumno&semestre=$semestre', 'Imprime PDF', 800, 600, null);");
...
function EnviarPDFCurso($data){
	...
	$objResponse->addScript("showPopWin('pdfs/pdf_enviar_informe_alumnos_anual_notas_todos.php?curso=$curso&semestre=$semestre', 'Imprime PDF', 800, 600, null);");
