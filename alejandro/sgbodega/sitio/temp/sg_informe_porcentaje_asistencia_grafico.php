...
$xajax->setRequestURI("sg_informe_porcentaje_asistencia_grafico.php");
...
function CargaListado($data){
	...
	$cant_dias 	=	$row_ve['DiasPeriodo'];
		...
		$objResponse->addAssign("divabonos", "innerHTML", $miSmarty->fetch('sg_informe_porcentaje_asistencia_grafico_list.tpl'));
...
$miSmarty->assign('periodo',  $_GET['periodo']);



$miSmarty->display('sg_informe_porcentaje_asistencia_grafico.tpl');
