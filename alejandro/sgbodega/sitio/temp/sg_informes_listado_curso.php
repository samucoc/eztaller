...
$xajax->setRequestURI("sg_informes_listado_curso.php");
...
function Grabar($data){
	...
	$objResponse->addAssign("divabonos", "innerHTML", $miSmarty->fetch('sg_informes_listado_curso_list.tpl'));
...
$miSmarty->display('sg_informes_listado_curso.tpl');
