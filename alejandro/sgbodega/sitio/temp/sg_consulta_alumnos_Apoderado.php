...
$xajax->setRequestURI("sg_consulta_alumnos_Apoderado.php");
...
function Grabar($data){
	...
	if (mysql_num_rows($res_nombre_alumno)==0){
	...
	$objResponse->addScript("location.href='sg_consulta_alumnos_Apoderado.php?rut=".$alumno."'");
...
$miSmarty->display('sg_consulta_alumnos_Apoderado.tpl');
