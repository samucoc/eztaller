...
$xajax->setRequestURI("sg_informes_alumnos_semestral_notas.php");
...
function CargaListado($data){
	...
	$sql_ve = "select  distinct concat(`PaternoAlumno`,' ',`MaternoAlumno`,' , ',`NombresAlumno`) as nombre_alumno,
						alumnos".$anio.".`NumeroRutAlumno`, NroMatricula, NroLista
				from alumnos".$anio."
...
function ImprimePDF($data,$rut_alumno,$semestre){
	...
	$objResponse->addScript("showPopWin('pdfs/pdf_informe_alumnos_semestras_notas.php?rut=$rut_alumno&semestre=$semestre', 'Imprime PDF', 800, 600, null);");
...
function EnviarPDF($data,$rut_alumno,$semestre){
	...
	$objResponse->addScript("showPopWin('pdfs/pdf_enviar_informe_alumnos_semestras_notas.php?rut=$rut_alumno&semestre=$semestre', 'Imprime PDF', 800, 600, null);");
...
function ImprimePDFCurso($data){
	...
	$objResponse->addScript("showPopWin('pdfs/pdf_informe_alumnos_semestras_notas_todos.php?curso=$curso&semestre=$semestre', 'Imprime PDF', 800, 600, null);");
...
function EnviarPDFCurso($data){
	...
	$objResponse->addScript("showPopWin('pdfs/pdf_enviar_informe_alumnos_semestras_notas_todos.php?curso=$curso&semestre=$semestre', 'Imprime PDF', 800, 600, null);");
...
$miSmarty->display('sg_informes_alumnos_semestral_notas.tpl');
