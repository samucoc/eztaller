...
$xajax->setRequestURI("sg_informes_certificado_posible_alta.php");
...
function Grabar($data){
	...
	while ($line_pd = mysql_fetch_row($res_pd)) {
		...
		$miSmarty->assign('DescripcionLarga',$line_pd[1]);
		...
		$miSmarty->assign('diagnostico_alumno',$diagnostico_alumno);
		$miSmarty->assign('nombre_profesor',$line_pd[3]);
		$miSmarty->assign('registro_mineduc',$line_pd[4]);
		
                   
	}
	$miSmarty->assign('observacion',$observacion);

	$objResponse->addAssign("divabonos", "innerHTML", $miSmarty->fetch('sg_informes_certificado_posible_alta_list.tpl'));
...
function GenerarPDF($data){
	...
	$objResponse->addScript("showPopWin('pdfs/pdf_generar_certificado_posible_alta.php?alumno=$alumno&observacion=$observacion', 'Imprime PDF', 1000, 700, null);");
...
function EnivarPDF($data){
	...
	$objResponse->addScript("showPopWin('sg_envia_certificado_posible_alta.php?alumno=$alumno&observacion=$observacion', 'Enviar PDF', 600, 200, null);");
...
$miSmarty->display('sg_informes_certificado_posible_alta.tpl');
