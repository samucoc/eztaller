...
<tr>
	<td colspan='10' class="grilla-tab-fila-titulo" align='center'><b>Listado de Traspasos entre Bodegas al {$smarty.now|date_format:"%d/%m/%Y"}</b></td>
</tr>
...
{section name=registros loop=$arrRegistros}
	<tr>
		...
		<td class="grilla-tab-fila-campo" align='left'>{$arrRegistros[registros].bod_origen}</td>
