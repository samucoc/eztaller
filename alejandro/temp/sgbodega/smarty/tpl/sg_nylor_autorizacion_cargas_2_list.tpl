...
{section name=registros loop=$arrRegistros}
	<tr>
        ...
        <td class="grilla-tab-fila-campo" align='center'><b style="color:#FFCC00">{$arrRegistros[registros].pie|number_format:0:',':'.'}</b></td>
		...
		{if ($arrRegistros[registros].ncorr == $arrDetalle[detalle].ncorr)}
			<tr> 
			   ...
			   <td class="grilla-tab-fila-campo-pequenio" align='right'>{$arrDetalle[detalle].cantidad|number_format:0:',':'.'}</td>
				<td class="grilla-tab-fila-campo-pequenio" align='center' colspan="2">{$arrDetalle[detalle].nu}</td>
