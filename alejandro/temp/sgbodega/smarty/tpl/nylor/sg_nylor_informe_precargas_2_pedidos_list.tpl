...
<tr>
	<td colspan='11' class="grilla-tab-fila-titulo" align='center'><b>Informe de Precargas al {$smarty.now|date_format:"%d/%m/%Y"}</b></td>
</tr>
<tr>
	<td colspan='3' class="grilla-tab-fila-titulo" align='left'>Vendedor:</td>
	<td colspan='8' class="grilla-tab-fila-campo" align='left'>{$VENDEDOR}</td>
</tr>
	...
	<tr>
		...
		<td colspan='6' class="grilla-tab-fila-titulo" align='center'>Cliente</td>
	</tr>
{section name=registros loop=$arrRegistros}
	...
	<tr> 
		...
		<td class="grilla-tab-fila-campo-pequenio" align='center'>Pedido</td>
		<td class="grilla-tab-fila-campo-pequenio" align='center'>Despachado</td>
		<td class="grilla-tab-fila-campo-pequenio" align='center'>Acciones</td>
		...
		{if ($arrRegistros[registros].ncorr == $arrDetalle[detalle].ncorr)}
			<tr> 
				...
				<td class="grilla-tab-fila-campo-pequenio" align='center'>
					<a href="#" onclick="xajax_Pedido(xajax.getFormValues('Form1'));" title="Pedido" ><img src="../images/pedido.png" title="Pedido" /></a>
					<a href="#" onclick="xajax_Despachado(xajax.getFormValues('Form1'));" title="Despachado" ><img src="../images/despachado.png" title="Despachado" /></a>
					<a href="#" onclick="xajax_Aprobado(xajax.getFormValues('Form1'));" title="Aprobado" ><img src="../images/aprobado.png" title="Aprobado" /></a>
					<a href="#" onclick="xajax_Historial(xajax.getFormValues('Form1'));" title="Historial" ><img src="../images/historial.png" title="Historial" /></a>
				</td>
	...
	<tr>
		<td colspan='11'  class="grilla-tab-fila-campo"></td>
	</tr>
...
<tr>
	...
	<td colspan='8' class="grilla-tab-fila-campo" align='left'><b>{$TOTAL_ARTICULOS|number_format:0:',':'.'}</b></td>
</tr>
<tr>
	<td colspan='3' class="grilla-tab-fila-campo" align='right'><b>Total Tarjetas:</b></td>
	<td colspan='8' class="grilla-tab-fila-campo" align='left'><b>{$TOTAL_TARJETAS|number_format:0:',':'.'}</b></td>
</tr>
<tr>
	<td colspan='3' class="grilla-tab-fila-campo" align='right'><b>Total Ventas:</b></td>
	<td colspan='8' class="grilla-tab-fila-campo" align='left'><b>{$TOTAL_VENTAS|number_format:0:',':'.'}</b></td>
</tr>
-->
