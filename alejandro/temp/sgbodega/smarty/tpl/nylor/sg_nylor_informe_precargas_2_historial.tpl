...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="xajax_CargarPagina(xajax.getFormValues('Form1'));" style="background:#ffffff;"> 
					...
					<tr>
						<td>
							<table border="0" class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr> 
									<td colspan="2" class="tabla-alycar-fila-informa-requerida-contrato">Historial 
