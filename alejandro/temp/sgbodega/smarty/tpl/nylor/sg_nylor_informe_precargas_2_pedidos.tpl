					...
					<tr>
						<td>
							<table border="0" class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr> 
									<td colspan="2" class="tabla-alycar-fila-informa-requerida-contrato">Pedidos 
	<input type="hidden" name="txtFolio" id="txtFolio" value={$folio}/>
	<input type="hidden" name="txtCodigo" id="txtCodigo" value={$codigo}/></td>
								</tr>
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 20%">Pedido</td>
									<td class="tabla-alycar-texto" style="width: 70%">
										<Input type='radio' name='OBLIpedido' id='OBLIpedido' value='pedido' />
									</td>
								</TR>
								<tr align="left">
