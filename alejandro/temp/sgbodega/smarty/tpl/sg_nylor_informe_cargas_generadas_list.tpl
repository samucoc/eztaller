...
<tr>
	<td colspan='14' class="grilla-tab-fila-titulo" align='center'><b>Informe de Cargas Generadas al {$smarty.now|date_format:"%d/%m/%Y"}</b></td>
</tr>
<tr>
...
<tr>
	...
	<tr>
		...
		<td colspan='5' class="grilla-tab-fila-titulo" align='center' style="width: 40%">Cliente</td>
	</tr>
{section name=registros loop=$arrRegistros}
	...
	<tr> 
		...
		<td colspan='2' class="grilla-tab-fila-campo-pequenio" align='center'>Descripción</td>
