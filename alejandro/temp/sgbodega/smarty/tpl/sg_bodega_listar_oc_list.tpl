...
{section name=registros loop=$arrRegistros}
        <tr>
            <td class="grilla-tab-fila-campo" align='left'>
            	<a href="#" onclick="xajax_EnviarPagina(xajax.getFormValues('Form1'), {$arrRegistros[registros].nro_oc})"> 
            	{$arrRegistros[registros].nro_oc}
                </a>
            </td>
            <td class="grilla-tab-fila-campo" align='left'>
            	<a href="#" onclick="xajax_EnviarPagina(xajax.getFormValues('Form1'), {$arrRegistros[registros].nro_oc})"> 
                {$arrRegistros[registros].proveedor}
                </a>
                </td>
            <td class="grilla-tab-fila-campo" align='left'>
            	<a href="#" onclick="xajax_EnviarPagina(xajax.getFormValues('Form1'), {$arrRegistros[registros].nro_oc})"> 
