...
<tr>
	...
	<tr>
		...
		<td colspan='5' class="grilla-tab-fila-titulo" align='center'>Cliente</td>
	</tr>
{section name=registros loop=$arrRegistros}
	...
	<tr>
		<td colspan='10'  class="grilla-tab-fila-campo"></td>
	</tr>
...
<tr>
	...
	<td colspan='7' class="grilla-tab-fila-campo" align='left'><b>{$TOTAL_ARTICULOS|number_format:0:',':'.'}</b></td>
</tr>
<tr>
	<td colspan='3' class="grilla-tab-fila-campo" align='right'><b>Total Tarjetas:</b></td>
	<td colspan='7' class="grilla-tab-fila-campo" align='left'><b>{$TOTAL_TARJETAS|number_format:0:',':'.'}</b></td>
</tr>
<tr>
	<td colspan='3' class="grilla-tab-fila-campo" align='right'><b>Total Ventas:</b></td>
	<td colspan='7' class="grilla-tab-fila-campo" align='left'><b>{$TOTAL_VENTAS|number_format:0:',':'.'}</b></td>
</tr>
-->
