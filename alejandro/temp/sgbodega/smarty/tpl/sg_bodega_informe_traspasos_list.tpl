...
<tr>
	<td colspan='12' class="grilla-tab-fila-titulo" align='center'><b>Informe Traspasos a Bodega Central al {$smarty.now|date_format:"%d/%m/%Y"}</b></td>
</tr>
<tr>
	<td colspan='3' class="grilla-tab-fila-titulo" align='left'>Periodo:</td>
	<td colspan='9' class="grilla-tab-fila-campo" align='left'>Desde: {$DESDE} Hasta: {$HASTA}</td>
</tr>
<tr>
	<td colspan='3' class="grilla-tab-fila-titulo" align='left'>Proveedor:</td>
	<td colspan='9' class="grilla-tab-fila-campo" align='left'>{$PROVEEDOR}</td>
</tr>
<tr>
...
{section name=registros loop=$arrRegistros}
	<tr>
		...
		<td class="grilla-tab-fila-campo" align='right'>{$arrRegistros[registros].total|number_format:0:',':'.'}</td>
...
<tr>
	...
	<td colspan='9' class="grilla-tab-fila-campo" align='left'>{$TOTAL_MOVIM|number_format:0:',':'.'}</td>
</tr>
<tr>
