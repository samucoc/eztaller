<?php /* Smarty version 2.6.18, created on 2013-11-05 10:38:46
         compiled from sg_nylor_ingreso_cargas.tpl */ ?>
					...
					<tr>
						<td>
							<table border="0" class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr> 
									<td colspan="2" class="tabla-alycar-fila-informa-requerida-contrato">Ingreso de Cargas</td>
								</tr>
								
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 20%">Folio:<label class="requerido"> * </label></td>
									<td class="tabla-alycar-texto" style="width: 70%">
										<INPUT type="text" id="OBLI-txtFolio" name="OBLI-txtFolio" onKeyPress="return SoloNumeros(this, event, 0)" maxLength="10" size="10">
									</td>
								</TR>
								<tr align="left">
