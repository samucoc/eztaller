<?php /* Smarty version 2.6.18, created on 2015-04-09 16:04:56
         compiled from sg_bodega_informe_devoluciones_proveedor_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'sg_bodega_informe_devoluciones_proveedor_list.tpl', 5, false),array('modifier', 'number_format', 'sg_bodega_informe_devoluciones_proveedor_list.tpl', 36, false),)), $this); ?>
<div id="pivot">										

<table class="grilla-tab" border="0" cellspacing="0" cellpadding="0" width="100%">
<tr>
	<td colspan='11' class="grilla-tab-fila-titulo" align='center'><b>Informe Devoluciones a Proveedor al <?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d/%m/%Y") : smarty_modifier_date_format($_tmp, "%d/%m/%Y")); ?>
</b></td>
</tr>
<tr>
	<td colspan='3' class="grilla-tab-fila-titulo" align='left'>Periodo:</td>
	<td colspan='8' class="grilla-tab-fila-campo" align='left'>Desde: <?php echo $this->_tpl_vars['DESDE']; ?>
 Hasta: <?php echo $this->_tpl_vars['HASTA']; ?>
</td>
</tr>
<tr>
	<td colspan='3' class="grilla-tab-fila-titulo" align='left'>Proveedor:</td>
	<td colspan='8' class="grilla-tab-fila-campo" align='left'><?php echo $this->_tpl_vars['PROVEEDOR']; ?>
</td>
</tr>
<tr>
...
<tr>
	...
	<td colspan='8' class="grilla-tab-fila-campo" align='left'><?php echo ((is_array($_tmp=$this->_tpl_vars['TOTAL_MOVIM'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 0, ',', '.') : number_format($_tmp, 0, ',', '.')); ?>
</td>
</tr>
<tr>
