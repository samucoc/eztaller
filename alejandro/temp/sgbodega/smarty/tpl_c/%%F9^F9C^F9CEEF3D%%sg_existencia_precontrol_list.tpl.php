<?php /* Smarty version 2.6.18, created on 2014-02-04 13:49:51
         compiled from sg_existencia_precontrol_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'sg_existencia_precontrol_list.tpl', 5, false),array('modifier', 'number_format', 'sg_existencia_precontrol_list.tpl', 60, false),)), $this); ?>
<div id="pivot">										

<table class="grilla-tab" border="0" cellspacing="0" cellpadding="0" width="100%">
<tr>
	<td colspan='20' class="grilla-tab-fila-titulo" align='center'><b>Consulta Stock Vendedor al <?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d/%m/%Y") : smarty_modifier_date_format($_tmp, "%d/%m/%Y")); ?>
</b></td>
</tr>

<tr>
	<td colspan='1' class="grilla-tab-fila-titulo" align='left'>Empresa:</td>
	<td colspan='19' class="grilla-tab-fila-campo" align='left'><?php echo $this->_tpl_vars['EMPRESA']; ?>
</td>
</tr>
<tr>
	<td colspan='1' class="grilla-tab-fila-titulo" align='left'>Vendedor:</td>
	<td colspan='19' class="grilla-tab-fila-campo" align='left'><?php echo $this->_tpl_vars['COBRADOR']; ?>
</td>
</tr>
...
<tr>
	...
	<td colspan='2' class="grilla-tab-fila-titulo" align='center'>Aumentos no Afecta</td>
...
<tr>
	...
	<td class="grilla-tab-fila-titulo" align='center'><a href="#" style="cursor: hand;" onclick="xajax_Ordenar(xajax.getFormValues('Form1'), 'aumentos_nb');">N</a></td>
	<td class="grilla-tab-fila-titulo" align='center'><a href="#" style="cursor: hand;" onclick="xajax_Ordenar(xajax.getFormValues('Form1'), 'aumentos_ub');">U</a></td>
...
');"><?php echo $this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['descripcion']; ?>
		...
		<td class="grilla-tab-fila-campo-rev" align='right'><?php echo ((is_array($_tmp=$this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['aumentos_nb'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 0, ',', '.') : number_format($_tmp, 0, ',', '.')); ?>
</td>
		<td class="grilla-tab-fila-campo-rev" align='right'><?php echo ((is_array($_tmp=$this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['aumentos_ub'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 0, ',', '.') : number_format($_tmp, 0, ',', '.')); ?>
</td>
...
<tr>
	...
	<td class="grilla-tab-fila-campo" align='right'><?php echo ((is_array($_tmp=$this->_tpl_vars['TOTAL_AUMENTOS_NB'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 0, ',', '.') : number_format($_tmp, 0, ',', '.')); ?>
</td>
	<td class="grilla-tab-fila-campo" align='right'><?php echo ((is_array($_tmp=$this->_tpl_vars['TOTAL_AUMENTOS_UB'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 0, ',', '.') : number_format($_tmp, 0, ',', '.')); ?>
</td>
...
<tr>
	<td colspan='20' class="grilla-tab-fila-titulo">
