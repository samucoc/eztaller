<?php /* Smarty version 2.6.18, created on 2013-10-18 12:05:04
       ...
       <meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
		...
		<script type="text/javascript">
			$(function($) { 
				...
				xajax_CargaSelect(xajax.getFormValues(\'Form1\'),\'estado\',\'sgyonley.tipos_movim\',\'\',\'Todos\',\'tmov_ncorr\', \'tmov_desc\', \' where tmov_ncorr not in (5,6,7,10)\');
				xajax_CargaSelect(xajax.getFormValues(\'Form1\'),\'cboFamilia\',\'sgbodega.familias\',\'\',\'Todas\',\'fa_codigo\', \'fa_nombre\', \'\');
				xajax_CargaSelect(xajax.getFormValues(\'Form1\'),\'cboBodega\',\'sgbodega.bodegas\',\'\',\'Todas\',\'bodega_ncorr\', \'nombre\', \'\');
				}
			); 		
		</script>
	...
	<body onload="xajax_CargaPagina(xajax.getFormValues('Form1'));" style="background:#ffffff;"> 
		...
		<form id="Form1" name="Form1" method="post" runat="server">
			...
			<div id="divcontenedor" align="left" style="display: block; margin-left:2px; padding: 2px;">
					...
					<tr>
						<td>
							<table border="0" class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr> 
									<td colspan="2" class="tabla-alycar-fila-informa-requerida-contrato">Informe Movimientos</td>
								</tr>
								<tr align="left">
									...
									<td class="tabla-alycar-texto" style="width: 80%">
										...
										al
										&nbsp;
										<INPUT type="text" id="txtFechaHasta" name="txtFechaHasta" value='' onKeyPress="return SoloNumeros(this, event, 0)" maxLength="10" size="10">
										<a href="#" style="cursor: hand;"><img  id='cmdCalendario2' src="../images/calendario.png" border=0 title="Click para ver calendario"></a>
										
									</td>
								</tr>
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 20%">Tipo de Movimiento:<label class="requerido"> * </label></td>
									<td class="tabla-alycar-texto" style="width: 80%">
				...
				<tr>
                                	<td class="tabla-alycar-label" style="width: 20%">Bodega:</td>
	                                <td class="tabla-alycar-texto" style="width: 38%" align='left'>
					<select name="cboBodega" id="cboBodega"></select>					
					</td>
                                </tr>
								<tr align="left">
		...
		<script type="text/javascript">
			...
			Calendar.setup({inputField : "txtFechaHasta",ifFormat : "%d/%m/%Y",showstime: true,button : "cmdCalendario2",step: 1});
		</script>
		'; ?>
