<?php /* Smarty version 2.6.18, created on 2013-08-21 14:34:29
         compiled from sg_bodega_informe_devoluciones_vendedor.tpl */ ?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<HEAD>
		...
		<title> Informe Devoluciones de Vendedor </title>
					...
					<tr>
						<td>
							<table border="0" class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr> 
									<td colspan="2" class="tabla-alycar-fila-informa-requerida-contrato">Informe Devoluciones de Vendedor</td>
								</tr>
								<tr align="left">
								...
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 25%">Vendedor:</td>
									<td class="tabla-alycar-texto" style="width: 75%">
										<INPUT type="text" id="txtCodCobrador" name="txtCodCobrador" value='' onKeyPress="return SoloNumeros(this, event, 1)" onchange="xajax_CargaDesc(xajax.getFormValues('Form1'),'sgbodega.vendedores', 'VE_CODIGO', 'VE_VENDEDOR', 'txtCodCobrador', 'txtDescCobrador', '');" maxLength="10" size="10">
										<INPUT type="text" id="txtDescCobrador" name="txtDescCobrador" value='' maxLength="100" size="50" readonly>
										<a href="#" style="cursor: hand;"><img  src="../images/magnify.png" border=0 title="Click para Buscar" onclick="showPopWin('sg_busqueda.php?entidad=2&obj1=txtCodCobrador&obj2=txtDescCobrador', 'Busca Vendedor', 550, 350, null);"></a>
									</td>
								</TR>
								<tr align="left">
