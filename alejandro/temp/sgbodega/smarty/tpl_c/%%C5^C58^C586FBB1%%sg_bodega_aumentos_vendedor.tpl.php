<?php /* Smarty version 2.6.18, created on 2015-02-13 08:34:53
         compiled from sg_bodega_aumentos_vendedor.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'sg_bodega_aumentos_vendedor.tpl', 128, false),)), $this); ?>
					...
					<tr>
						<td>
							<table border="0" class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr> 
									<td colspan="2" class="tabla-alycar-fila-informa-requerida-contrato">Aumentos a Vendedor
...
' onKeyPress="return SoloNumeros(this, event, 0)" maxLength="10" size="10">
								...
								<tr align="left">
									...
									<td class="tabla-alycar-texto" style="width: 75%">
										<INPUT type="text" id="OBLI-txtCodCobrador" name="OBLI-txtCodCobrador" value='' onKeyPress="return SoloNumeros(this, event, 1)" onchange="xajax_BuscaVendedor(xajax.getFormValues('Form1'),'OBLI-txtCodCobrador', 'OBLI-txtDescCobrador');" maxLength="10" size="10">
								...
								<tr align="left">
									...
									<td class="tabla-alycar-texto" style="width: 70%">
										<textarea id="txtObservacion" name="txtObservacion" cols="50" rows="3" >AMTO N�</textarea>
									</td> 
								</TR>
							...
							<table class="grilla-tab" border="0" cellspacing="0" cellpadding="0" width="100%">
                                    <tr>
                                        <td class="grilla-tab-fila-campo" style="width: 45%" align='center'>Producto                                        <a href="#" style="cursor: hand;"><img  src="../images/magnify.png" border=0 title="Click para Buscar" onclick="showPopWin('sg_busqueda.php?entidad=4&obj1=OBLItxtCodProducto&obj2=OBLItxtDescProducto', 'Busca Articulo', 550, 350, null);"></a>
									</td>
