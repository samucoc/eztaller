<?php /* Smarty version 2.6.18, created on 2014-11-24 15:29:48
         compiled from sg_nylor_informe_preaprobadas_autorizadas.tpl */ ?>
					...
					<tr>
						<td>
							<table border="0" class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr> 
									<td colspan="2" class="tabla-alycar-fila-informa-requerida-contrato">Informe aceptadas y nulas</td>
								</tr>
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 20%">Vendedor:</td>
									<td class="tabla-alycar-texto" style="width: 70%">
										<INPUT type="text" id="txtCodVendedor" name="txtCodVendedor" value='<?php echo $this->_tpl_vars['COD_VENDEDOR']; ?>
' onKeyPress="return SoloNumeros(this, event, 1)" onchange="xajax_CargaDesc(xajax.getFormValues('Form1'),'sgbodega.vendedores', 'VE_CODIGO', 'VE_VENDEDOR', 'txtCodVendedor', 'txtDescVendedor', '');" maxLength="10" size="10">
										<INPUT type="text" id="txtDescVendedor" name="txtDescVendedor" value='<?php echo $this->_tpl_vars['VENDEDOR']; ?>
' maxLength="100" size="50" readonly>
								...
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 20%">Rango de Fecha:</td>
									<td class="tabla-alycar-texto" style="width: 80%">
										
										<INPUT type="text" id="OBLI-txtFechaInicio" name="OBLI-txtFechaInicio" value='<?php echo $this->_tpl_vars['DESDE']; ?>
' onKeyPress="return SoloNumeros(this, event, 0)" maxLength="10" size="10">
										...
										al
										&nbsp;
										<INPUT type="text" id="OBLI-txtFechaTermino" name="OBLI-txtFechaTermino" value='<?php echo $this->_tpl_vars['HASTA']; ?>
' onKeyPress="return SoloNumeros(this, event, 0)" maxLength="10" size="10">
								...
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 20%">Folio</td>
									<td class="tabla-alycar-texto" style="width: 80%">
