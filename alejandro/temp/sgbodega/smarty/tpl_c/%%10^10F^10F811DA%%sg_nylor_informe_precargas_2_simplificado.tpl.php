<?php /* Smarty version 2.6.18, created on 2014-11-24 15:50:31
         compiled from sg_nylor_informe_precargas_2_simplificado.tpl */ ?>
					...
					<tr>
						<td>
							<table border="0" class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr> 
									<td colspan="2" class="tabla-alycar-fila-informa-requerida-contrato">Informe de Preaprobadas para cargas simplificado</td>
								</tr>
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 20%">Producto:</td>
									<td class="tabla-alycar-texto" style="width: 70%">
										<INPUT type="text" id="txtCodArticulo" name="txtCodArticulo" style="width: 15%" value='' onKeyPress="return SoloNumeros(this, event, 1)" onblur="xajax_CargaDesc(xajax.getFormValues('Form1'), 'sgbodega.tallasnew', 'ta_ncorr', 'concat(ta_busqueda,ta_descripcion)', 'txtCodArticulo', 'txtDescArticulo', '');" maxLength="20">
										<INPUT type="text" id="txtDescArticulo" name="txtDescArticulo" style="width: 75%" value='' maxLength="100" readonly>
									</td>
								</TR>
