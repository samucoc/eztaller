<?php /* Smarty version 2.6.18, created on 2015-04-23 17:52:58
         compiled from sg_bodega_imp_guia_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'number_format', 'sg_bodega_imp_guia_list.tpl', 92, false),)), $this); ?>
<div id="pivot">										
...
?>
	<tr>	
		...
		<td colspan='2' class="grilla-tab-fila-campo" align='left'><?php echo $this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['fecha']; ?>
</td>
	</tr>
	<?php if (( ( $this->_tpl_vars['movim'] == '1' ) || ( $this->_tpl_vars['movim'] == '3' ) )): ?>	
		<tr>
			<td colspan='1' class="grilla-tab-fila-titulo" align='left'>Proveedor:</td>
			<td colspan='2' class="grilla-tab-fila-campo" align='left'><?php echo $this->_tpl_vars['proveedor']; ?>
</td>
		</tr>
	<tr>	
		<td colspan='1' class="grilla-tab-fila-titulo" align='left'>OC:</td>
		<td colspan='2' class="grilla-tab-fila-campo" align='left'><?php echo $this->_tpl_vars['oc']; ?>
</td>
	</tr>
	<tr>	
		<td colspan='1' class="grilla-tab-fila-titulo" align='left'>Factura:</td>
		<td colspan='2' class="grilla-tab-fila-campo" align='left'><?php echo $this->_tpl_vars['factura']; ?>
</td>
	</tr>
	<tr>	
		<td colspan='1' class="grilla-tab-fila-titulo" align='left'>Guia Despacho:</td>
		<td colspan='2' class="grilla-tab-fila-campo" align='left'><?php echo $this->_tpl_vars['guia_despacho']; ?>
</td>
	</tr>
    ...
    <tr>
		...
		<td colspan='2' class="grilla-tab-fila-campo" align='left'><?php echo $this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['guia']; ?>
</td>
	</tr>	
	<tr>	
		<td colspan='1' class="grilla-tab-fila-titulo" align='left'>Movimiento:</td>
		<td colspan='2' class="grilla-tab-fila-campo" align='left'><?php echo $this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['movimiento']; ?>
</td>
	</tr>
	<tr>	
		<td colspan='1' class="grilla-tab-fila-titulo" align='left'>Bodega:</td>
		<td colspan='2' class="grilla-tab-fila-campo" align='left'><?php echo $this->_tpl_vars['bodega']; ?>
</td>
	</tr>
	<?php if (( ( $this->_tpl_vars['movim'] == '9' ) )): ?>	
		<tr>
			<td colspan='1' class="grilla-tab-fila-titulo" align='left'>Trabajador:</td>
			<td colspan='2' class="grilla-tab-fila-campo" align='left'><?php echo $this->_tpl_vars['trabajador']; ?>
</td>
		</tr>
	<?php endif; ?>
	<?php if (( ( $this->_tpl_vars['movim'] == '10' ) )): ?>	
		<tr>
			<td colspan='1' class="grilla-tab-fila-titulo" align='left'>Trabajador:</td>
			<td colspan='2' class="grilla-tab-fila-campo" align='left'><?php echo $this->_tpl_vars['trabajador']; ?>
</td>
	...
	<tr>	
		...
		<td colspan='2' class="grilla-tab-fila-campo" align='left'><?php echo $this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['obs']; ?>
</td>
	</tr>
	
	<tr>	
		<td colspan='1' class="grilla-tab-fila-titulo" align='left'>Usuario:</td>
		<td colspan='2' class="grilla-tab-fila-campo" align='left'><?php echo $this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['usuario']; ?>
</td>
	</tr>
	<tr>	
		<td colspan='1' class="grilla-tab-fila-titulo" align='left'>Empresa:</td>
		<td colspan='2' class="grilla-tab-fila-campo" align='left'><?php echo $this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['empresa']; ?>
</td>
	</tr>
	<?php if (( ( $this->_tpl_vars['movim'] == '2' ) || ( $this->_tpl_vars['movim'] == '4' ) || ( $this->_tpl_vars['movim'] == '6' ) )): ?>	
		<tr>
			...
			<td colspan='2' class="grilla-tab-fila-campo" align='left'><?php echo $this->_tpl_vars['vendedor']; ?>
</td>
		</tr>
	<?php endif; ?>
	<?php if (( $this->_tpl_vars['movim'] == '6' )): ?>	
		<tr>
			...
			<td colspan='2' class="grilla-tab-fila-campo" align='left'><?php echo $this->_tpl_vars['folio']; ?>
</td>
		</tr>
	<?php endif; ?>
...
?>
	<tr>
		<td class="grilla-tab-fila-campo" align='left'><?php echo $this->_tpl_vars['arrRegistrosDet'][$this->_sections['registrosDet']['index']]['codigo']; ?>
</td>
		<td class="grilla-tab-fila-campo" align='left'><?php echo $this->_tpl_vars['arrRegistrosDet'][$this->_sections['registrosDet']['index']]['descripcion']; ?>
</td>
		<td class="grilla-tab-fila-campo" align='right'><?php echo ((is_array($_tmp=$this->_tpl_vars['arrRegistrosDet'][$this->_sections['registrosDet']['index']]['cantidad'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 0, ',', '.') : number_format($_tmp, 0, ',', '.')); ?>
</td>
...
<tr>
	...
	<td class="grilla-tab-fila-campo" align='right'><b><?php echo ((is_array($_tmp=$this->_tpl_vars['TOTAL_CANTIDAD'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 0, ',', '.') : number_format($_tmp, 0, ',', '.')); ?>
</b></td>
</tr>
</table>
...
<tr>
	<td colspan='1' class="grilla-tab-fila-campo" align='center'><?php echo $this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['usuario']; ?>
</td>
