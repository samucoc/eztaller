<?php /* Smarty version 2.6.18, created on 2014-11-24 15:17:10
         compiled from sg_nylor_autorizacion_cargas_2_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'sg_nylor_autorizacion_cargas_2_list.tpl', 5, false),array('modifier', 'number_format', 'sg_nylor_autorizacion_cargas_2_list.tpl', 76, false),)), $this); ?>
<div id="pivot">
...
<tr>
	...
	<tr>
		...
		<td class="grilla-tab-fila-titulo" align='center' style="width: 25%"></td>
		<td class="grilla-tab-fila-titulo" align='center' style="width: 25%">Pie</td>
		<td colspan='2' class="grilla-tab-fila-titulo" align='center' style="width: 10%">Total</td>
		<td class="grilla-tab-fila-titulo" align='center' style="width: 10%" colspan="2">Autoriza Carga</td>
	</tr>
...
?>
	<tr>
        ...
        <td class="grilla-tab-fila-campo" align='center'><b style="color:#FFCC00"><?php echo ((is_array($_tmp=$this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['pie'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 0, ',', '.') : number_format($_tmp, 0, ',', '.')); ?>
</b></td>
		...
		<td valign='middle' class="grilla-tab-fila-campo" align='center' colspan="2">
			<!--
...
"></textarea></td>
			   <td class="grilla-tab-fila-campo-pequenio" align='right'><?php echo ((is_array($_tmp=$this->_tpl_vars['arrDetalle'][$this->_sections['detalle']['index']]['cantidad'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 0, ',', '.') : number_format($_tmp, 0, ',', '.')); ?>
				...
				<td class="grilla-tab-fila-campo-pequenio" align='center' colspan="2"><?php echo $this->_tpl_vars['arrDetalle'][$this->_sections['detalle']['index']]['nu']; ?>
</td>
