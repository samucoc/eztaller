<?php /* Smarty version 2.6.18, created on 2015-05-19 18:21:11
         compiled from sg_orden_compra_detalle.tpl */ ?>
                                ...
                                <table class="tabla-alycar">
                                    <tr>
                                        <td class="tabla-alycar-label" colspan="5" align="left">
                                            ...
                                            <input type="hidden" name="nro_oc" id="nro_oc" value="<?php echo $this->_tpl_vars['nro_oc']; ?>
"/>
                                        </td>                              
	                                </tr>
                                    <tr>
                                        ...
                                        <td class="tabla-alycar-texto" align="left">
                                            <input type="text" id="fecha_cant_rec" name="fecha_cant_rec" value="" onkeypress="return SoloNumeros(this, event, 0)" maxlength="10" size="10" value="<?php echo $this->_tpl_vars['fecha']; ?>
" />
                                        </td>                              
									</tr>
                                    <tr>
                                        ...
                                        <td class="tabla-alycar-texto" align="left">
                                            <input type="text" id="factura" name="factura" value="" onkeypress="return SoloNumeros(this, event, 0)" maxlength="10" size="10" value="<?php echo $this->_tpl_vars['factura']; ?>
" />
                                        </td>                              
									</tr>
                                    <tr>
                                        ...
                                        <td class="tabla-alycar-texto" align="left">
                                            <input type="text" id="guia_despacho" name="guia_despacho" value="" onkeypress="return SoloNumeros(this, event, 0)" maxlength="10" size="10" value="<?php echo $this->_tpl_vars['guia_despacho']; ?>
" />
                                        </td>                              
									</tr>
                                    <tr>
                                    ...
                                    <tr id="oculto">
                                        ...
                                        <td class="tabla-alycar-texto" align="left">
											<INPUT type="text" id="OBLItxtCodVendedor" name="OBLItxtCodVendedor" tabindex="4" onKeyPress="return SoloNumeros(this, event, 1)" onchange="xajax_CargaDesc(xajax.getFormValues('Form1'),'sgyonley.vendedores', 'VE_CODIGO', 'VE_VENDEDOR', 'OBLItxtCodVendedor', 'OBLItxtDescVendedor', '');" maxLength="10" size="10" value="<?php echo $this->_tpl_vars['cod_vendedor']; ?>
" />
											<INPUT type="text" id="OBLItxtDescVendedor" name="OBLItxtDescVendedor" maxLength="100" size="50" readonly value="<?php echo $this->_tpl_vars['nombre_vendedor']; ?>
"/>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tabla-alycar-texto" align="left">
                                            <INPUT type="text" id="txtCodProducto" name="txtCodProducto" value='' onKeyPress="return SoloNumeros(this, event, 1)" onchange="xajax_CargaDesc(xajax.getFormValues('Form1'), 'sgbodega.tallas', 'ta_ncorr', 'ta_descripcion', 'txtCodProducto', 'txtDescProducto', '<?php echo $this->_tpl_vars['nro_oc']; ?>
');" maxLength="10" style="width: 15%;" />
