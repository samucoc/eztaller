...
$xajax->setRequestURI("sg_informe_movimientos_fecha.php");
...
function ImprimeGuia($data,$guia){
	...
	$_SESSION["alycar_pag_regreso"] = 'sg_informe_movimientos_fecha.php';
...
function Grabar($data){
	...
	if (mysql_num_rows($res) > 0){
		...
		$objResponse->addAssign("divabonos", "innerHTML", $miSmarty->fetch('sg_informe_movimientos_fecha_list.tpl'));
	}else{
...
$miSmarty->display('sg_informe_movimientos_fecha.tpl');
