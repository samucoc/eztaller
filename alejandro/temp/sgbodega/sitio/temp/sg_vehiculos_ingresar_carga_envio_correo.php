...
function Grabar($data){
	...
	$carga_monto	=	ereg_replace("[.]", "", $data["monto"]);
	...
	$id_carga		=	$data["id_carga"];
        ...
        $body             .= "<div>";
        $body             .= "<p>Se ruega autorizar carga al trabajador ".$trabajador." por $".$carga_monto."</p>";
        ...
        $body             .= "<br />";
        $body             .= "<br />";
        $body             .= "<p class='clearBoth'><a href='http://192.168.1.50/sgcopec/sitio/scripts/autoriza_carga.php?id_carga=".$id_carga."'>Aceptar Carga Extra</a></p>";
        ...
        $mail->Subject    = "Solicitud de carga extra Nro. ".$id_carga;
