...
function Grabar($data){
	...
	if ($ingresa == 'SI'){
		$sql = "select US_PASSWORD from usuarios where US_USUARIO = '".$v_login."' and US_PASSWORD = '".$v_clave_actual."'";
	...
	if ($ingresa == 'SI'){
		$sql = "update usuarios set US_PASSWORD = '".$v_clave_nueva1."' where US_USUARIO = '".$v_login."'";
		$res = mysql_query($sql, $conexion);
