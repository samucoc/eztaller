<?php /* Smarty version 2.6.18, created on 2011-01-22 03:51:42
         compiled from sg_informe_movimientos_sector_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'sg_informe_movimientos_sector_list.tpl', 5, false),array('modifier', 'number_format', 'sg_informe_movimientos_sector_list.tpl', 21, false),)), $this); ?>
<br>
<table class="grilla-tab" border="0" cellspacing="0" cellpadding="0" width="100%">

<tr>
	<td colspan='6' class="grilla-tab-fila-titulo-pequenio" align='center'><b>Movimientos Por Sector al <?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d/%m/%Y") : smarty_modifier_date_format($_tmp, "%d/%m/%Y")); ?>
</b></td>
</tr>
<tr>
...
<tr>
	...
	<td colspan='5' class="grilla-tab-fila-campo-pequenio"><?php echo $this->_tpl_vars['SECTOR']; ?>
</td>
</tr>
<tr>
...
<tr>
	...
	<td class="grilla-tab-fila-titulo-pequenio" align='center'>Cargos</td>
	<td class="grilla-tab-fila-titulo-pequenio" align='center'>Abonos</td>
