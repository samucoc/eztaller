...
class DenunciaImpliArchController extends ResourceController
{
    protected $modelName = 'App\Models\DenunciaImpliArchModel';
    ...
    public function new()
    {
        $data = new \App\Entities\DenunciaImpliArch;
        return $this->respond($data);
    }
