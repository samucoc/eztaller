...
class ComunicacionController extends ResourceController
{
    protected $modelName = 'App\Models\ComunicacionModel';
    ...
    public function new()
    {
        $data = new \App\Entities\Comunicacion;
        return $this->respond($data);
    }
    ...
    public function create()
    {
        ...
        if ($this->model->insert($data)) {
            ...
            $mensaje = "Comunicación del usuario rut {$data->user_id} con título {$data->titulo} ha sido insertado.";
            $notificacionController->logNotification($data->user_id, 'insert', 'comunicacion', $mensaje);
    ...
    public function update($id = null)
    {
        ...
        if ($this->model->update($id, $data)) {
            ...
            // Registrar notificación
            $notificacionController = new \App\Controllers\Api\V1\NotificacionController();
            $mensaje = "Comunicación del usuario rut {$data->user_id} con título {$data->titulo} ha sido actualizada.";
            $notificacionController->logNotification($data->user_id, 'update', 'comunicacion', $mensaje);
