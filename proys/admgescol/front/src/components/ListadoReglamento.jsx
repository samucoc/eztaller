...
const ListadoReglamento = ({userDNI,  empresaId}) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const response = await axios.get(`${API_BASE_URL}/documentos/showReglamento/${userSession}`)
...
export default ListadoReglamento;
