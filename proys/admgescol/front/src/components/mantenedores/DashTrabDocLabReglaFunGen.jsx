...
const DashTrabDocLabReglaCarga = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      setError(null);
      try {
        const response = roleSession == 2 ? await axios.get(`${API_BASE_URL}/documentos/showFunGenByEmp/${empresaId}`) : await axios.get(`${API_BASE_URL}/documentos/showFunGenByUserByEmp/${userDNI}/${empresaId}`); // Replace with your API endpoint
