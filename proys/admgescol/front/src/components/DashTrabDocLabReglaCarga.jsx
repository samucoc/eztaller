...
const DashTrabDocLabReglaCarga = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      setError(null);
      try {
        const response = roleSession == 2 ? await axios.get(`${API_BASE_URL}/documentos/showCargaByEmp/${empresaId}`) : await axios.get(`${API_BASE_URL}/documentos/showCargaByUserByEmp/${userDNI}/${empresaId}`); // Replace with your API endpoint
