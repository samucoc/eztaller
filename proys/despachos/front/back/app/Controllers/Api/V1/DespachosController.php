    ...
    public function index()
    {
        ...
        $despachos = $db->query("SELECT despachos.id, fecha, 
					...
					vehiculos.id as vehiculo_id, 
                                        recogido, entregado,
					concat(nombre_estado_1,' - ',rut_estado_1,' - ',time_estado_1) as estado_1,
					concat(nombre_estado_2,' - ',rut_estado_2,' - ',time_estado_2) as estado_2,
                                        concat(nombre_estado_3,' - ',rut_estado_3,' - ',time_estado_3) as estado_3,
                                        concat(nombre_estado_4,' - ',rut_estado_4,' - ',time_estado_4) as estado_4,
                                        concat(nombre_estado_5,' - ',rut_estado_5,' - ',time_estado_5) as estado_5
                                FROM despachos 
