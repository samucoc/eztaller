...
class DetallesGuiaController extends ResourceController
{
    protected $modelName = 'App\Models\DetallesGuiaModel';
    ...
    public function __construct()
    {
        ...
        $this->guiaModel = new \App\Models\GuiasModel();
    }
    ...
    public function index()
    {
        ...
        foreach ($data as $key => $value) {
            $data[$key]['guia'] = $this->guiaModel->find($value['guia_id']);
        }
    ...
    public function show($id = null)
    {
        ...
        $data['guia'] = $this->guiaModel->find($data['guia_id']);
        return $this->respond($data);
    }
    ...
    public function new()
    {
        $data = new \App\Entities\DetallesGuia;
        return $this->respond($data);
    }
