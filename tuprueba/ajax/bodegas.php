<?php
    ...
    if (isset($_GET['id'])){
        ...
        $query=mysqli_query($con, "SELECT * from bodegas where b_ncorr='".$id_expence."'");
        $count=mysqli_num_rows($query);
            if ($delete1=mysqli_query($con,"DELETE FROM bodegas WHERE b_ncorr='".$id_expence."'")){
            ?>
