<?php
    ...
    if (isset($_GET['id'])){
        ...
        $query=mysqli_query($con, "SELECT * from productos where codigo='".$id_expence."'");
        $count=mysqli_num_rows($query);
            if ($delete1=mysqli_query($con,"DELETE FROM productos WHERE codigo='".$id_expence."'")){
            ?>
            ...
            <table class="table table-striped jambo_table bulk_action">
                ...
                ?>
                    ...
                    <tr class="even pointer">
                        <td><?php echo utf8_encode($codigo);?></td>
