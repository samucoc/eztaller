...
<?php	
	...
	while ($row=mysqli_fetch_array($query)) {
    	...
    	echo "</tr>";
		echo "<tr>";
    		echo "<td>Bodega</td><td>".utf8_encode($row['nombre_bodega'])."</td>";
    	echo "</tr>";
		echo "<tr>";
    		echo "<td>Tipo Movimiento</td><td>".utf8_encode($row['nombre_tipo'])."</td>";
    	echo "</tr>";
		echo "<tr>";
    		echo "<td>Vendedor</td><td>".utf8_encode($row['vendedor'])."</td>";
    	echo "</tr>";
		echo "<tr>";
