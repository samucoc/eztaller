...
<body>
    ...
    <main>
        <p class="text-center">
            <strong>APROBACIÓN A LA MODIFICACIÓN DE PROYECTO DE INTERVENCIÓN COMUNAL<br>PROGRAMA HABITABILIDAD</strong>
        </p>
        ...
        <p>
            ...
            la modificación al Proyecto de Intervención Comunal de {{$convocatoria->comuna}}, convocatoria {{$convocatoria->anio}}.
        </p>
        <p>
            El nuevo PIC modificado y aprobado considera las familias y plan de intervención que se resumen en la tabla
            a continuación:
        </p>
        <br>
        <table class="table">
