...
<a href="{{url('actualizar')}}">Actualizar Tabla Ventas</a>
	            ...
	            <div class="box-body no-padding">
	            	<table class="table table-condensed" id="">
	                	<tbody>
	                		...
	                		<tr>
	                			<th colspan="2">
	                				<a href="#" title="Buscar" class="btn btn-info btn-flat pull-right"><i class="fa fa-search" aria-hidden="true"></i> Buscar</a>
	                			</th>
	                		</tr>
	              		</tbody>
	            	</table>
	...
	<div class="col-md-12" id="informe">
		<div class="box box-warning">
            <div class="box-header with-border">
            	<h3 class="box-title">Informe de Revision de Kardex</h3>
