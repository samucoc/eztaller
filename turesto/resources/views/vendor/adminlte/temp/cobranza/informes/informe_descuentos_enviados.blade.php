...
@section('htmlheader_title')
	{{ trans('adminlte_lang::message.informededescuentosenviados') }}
@endsection
...
<i class="fa fa-files-o" aria-hidden="true"></i> Informe Descuentos Enviados
@endsection
	            	...
	            	<table class="table table-condensed" id="">
	                	<tbody>
	                		...
	                		<tr>
	                			...
	                			<th colspan="2">
	                				<input type="text" name="" value="" placeholder="" class="form-control" aria-describedby="helpBlock">
	                				<span id="helpBlock" class="help-block">Deje el campo vacio si quiere buscar entre todos los usuarios.</span>
	                			</th>
	...
	<div class="col-md-12" id="informe">
		<div class="box box-warning">
            <div class="box-header with-border">
            	<h3 class="box-title"><i class="fa fa-list-alt" aria-hidden="true"></i> Informe de Descuentos Enviados</h3>
            ...
            <div class="box-body">
				...
				<div class="table-responsive">
					<table class="table no-margin table-hover" >
						...
						<tfoot>
							<tr>
								<th colspan="10" class="text-right">Total Folios:</th>
								<th>5</th>
							</tr>
							<tr>
								<th colspan="10" class="text-right">Total Descuentos:</th>
								<th>$25.000</th>
							</tr>
						</tfoot>
					</table>
