...
<a class="btn btn-primary " data-toggle="modal" href='#agregar-estadoempleado' title="Agregar Estado Empleados"><i class="fa fa-plus" aria-hidden="true"></i> Agregar Estado Empleados</a>
@endsection
...
@section('main-content')
	...
	<h2>Listado de <small> Estado Empleados</small></h2>
	<div class="row">
		@if ($errors->any())
		...
		<div class="table-responsive">
			<table class="table table-hover" id="listar-estadoempleado">
				<thead>
					<tr>
						<th>ID</th>
						<th>Nombre</th>
...
<div class="modal fade " id="agregar-estadoempleado">
	<div class="modal-dialog">
		<div class="modal-content">

			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4 class="modal-title">Nueva Estado Empleado</h4>
			</div>

			<div class="modal-body">
				<div class="row">
						<form action="{{url('mantenedores/estadoempleado/crear')}}" method="POST" role="form">
					<div class="col-md-12">
...
$(document).ready(function() {
	var tabla = $('#listar-estadoempleado').DataTable({
        processing: true,
        dom: 'Bfrtip',
        buttons: ['print'],
        language: {
        ...
        ajax: '{{url ("mantenedores/estadoempleado/listar")}}',
        columns: [
        	{ data: 'ee_ncorr', name: 'ID' },
