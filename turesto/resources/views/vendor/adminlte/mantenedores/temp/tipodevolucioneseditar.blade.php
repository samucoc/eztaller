...
-->
@php 	$ruta = "tipodevoluciones"; $rutasingular = "tipodevolucion";@endphp
...
<a class="btn btn-info" href="{{ URL('/mantenedores/tipodevolcuiones') }}"><i class="fa fa-angle-left" aria-hidden="true"></i> back</a>
@endsection
...
<div class="container">
	@foreach ($tipodevoluciones as $tipodevolucion)
		<div class="col-md-10 col-xs-9">
			<h2><i class="fa fa-industry" aria-hidden="true"></i> Tipo de Devoluciones</h2>
		</div>
		
		<br>
		<div class="row">
			<div class="col-md-12">
				<form action="{{url('mantenedores/tipodevoluciones/guardar')}}" method="" role="form">
					<div class="form-group">
						<input type="hidden" name="_token" value="{{{ csrf_token() }}}" />
						<input type="hidden" name="txtid" value="{{$tipodevolucion->td_id}}" />
					</div>
					
					<div class="form-group">
						<label for="txtdescripcion"><i class="fa fa-id-card-o" aria-hidden="true" ></i> Descripcion</label>
						<input type="text" class="form-control" name="txtdescripcion" placeholder="" value="{{$tipodevolucion->td_descripcion}}" r>
					</div>
