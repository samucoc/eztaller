...
@php 	$ruta = "tipodepositos"; $modal = "tipodeposito";	 	 @endphp
@extends('adminlte::layouts.app') 

<!-- aqui escribimos el texto que tendra nuestra pagina -->
@section('htmlheader_title')
	{{ trans('adminlte_lang::message.listadotipodepositos') }}
@endsection
...
<a class="btn btn-primary " data-toggle="modal" href='#agregar-{{$modal}}' title="Agregar tipo deposito"><i class="fa fa-plus" aria-hidden="true"></i> Agregar Tipo Deposito</a>
@endsection
...
@section('main-content')
	...
	<h2>Listado de <small> Tipos de Depositos</small></h2>
		<div class="row">
		@if ($errors->any())
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 class="modal-title">Nueva Tipo de Deposito</h4>
			</div>

			<div class="modal-body">
				<div class="row">
						<form action="{{url('mantenedores/tipodepositos/crear')}}" method="POST" role="form">
					<div class="col-md-12">
...
$(document).ready(function() {
	var tabla = $('#listar-tipodepositos').DataTable({
        processing: true,
        dom: 'Bfrtip',
        buttons: [
            'excel', 'pdf','print'
        ...
        ajax: '{{url ("mantenedores/tipodepositos/listar")}}',
        columns: [
            
            { data: 'td_id', name: 'td_id' },
            { data: 'td_descripcion', name: 'td_descripcion' }
