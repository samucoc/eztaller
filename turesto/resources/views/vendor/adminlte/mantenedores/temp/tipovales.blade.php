...
@php 	$ruta = "tipovales"; $modal = "tipovale"; @endphp
...
<a class="btn btn-primary " data-toggle="modal" href='#agregar-{{$modal}}' title="Agregar Rango cuota"><i class="fa fa-plus" aria-hidden="true"></i> Agregar tipo Pie</a>
@endsection
...
@section('main-content')
	...
	<h2>Listado de <small> Tipos de Vales</small></h2>
		<div class="row">
		@if ($errors->any())
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 class="modal-title">Nueva Tipo de Vale</h4>
			</div>

			<div class="modal-body">
				<div class="row">
						<form action="{{url('mantenedores/tipovales/crear')}}" method="POST" role="form">
					<div class="col-md-12">
...
$(document).ready(function() {
	var tabla = $('#listar-{{$ruta}}').DataTable({
        ...
        ajax: '{{url ("mantenedores/tipovales/listar")}}',
        columns: [
            { data: 'tv_id', name: 'tv_id' },
            { data: 'tv_descripcion', name: 'tv_descripcion' },
        ]
    });
