...
<a class="btn btn-primary " data-toggle="modal" href='#agregar-ips' title="Agregar Ips"><i class="fa fa-plus" aria-hidden="true"></i> Agregar Ips</a>
@endsection
...
@section('main-content')
	...
	<h2>Listado de <small> ips</small></h2>
	<div class="row">
		@if ($errors->any())
		...
		<div class="table-responsive">
			<table class="table table-hover" id="listar-ips">
				<thead>
					<tr>
						<th>ID</th>
						<th>Nombre</th>
...
<div class="modal fade " id="agregar-ips">
	<div class="modal-dialog">
		<div class="modal-content">

			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4 class="modal-title">Nueva ips</h4>
			</div>

			<div class="modal-body">
				<div class="row">
						<form action="{{url('mantenedores/ips/crear')}}" method="POST" role="form">
					<div class="col-md-12">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" name="txtporcentaje" placeholder="" value="">
							</div>
...
$(document).ready(function() {
	var tabla = $('#listar-{{$ruta}}').DataTable({
        ...
        ajax: '{{url ("mantenedores/ips/listar")}}',
        columns: [
        	{ data: 'ips_ncorr', name: 'ID' },
            { data: 'nombre', name: 'nombre' },
            { data: 'porc_cot', name: 'porcentaje' },
        ],
        "columnDefs": [ {
            "targets": 3,
            "data": "ips_ncorr",
