...
@php 	$ruta = "intsahorrovol"; $modal = "intsahorrovol";	 	 @endphp
...
<a class="btn btn-primary " data-toggle="modal" href='#agregar-intsahorrovol' title="Agregar Institución Ahorro Voluntario</a>
@endsection"><i class="fa fa-plus" aria-hidden="true"></i> Agregar Institución Ahorro Voluntario</a>
@endsection
...
@section('main-content')
	...
	<h2>Listado de <small> intsahorrovol</small></h2>
	<div class="row">
		@if ($errors->any())
		...
		<div class="table-responsive">
			<table class="table table-hover" id="listar-intsahorrovol">
				<thead>
					<tr>
						<th>ID</th>
						<th>Nombre</th>
...
<div class="modal fade " id="agregar-intsahorrovol">
	<div class="modal-dialog">
		<div class="modal-content">

			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4 class="modal-title">Nueva Institución Ahorro Voluntario</h4>
			</div>

			<div class="modal-body">
				<div class="row">
						<form action="{{url('mantenedores/intsahorrovol/crear')}}" method="POST" role="form">
					<div class="col-md-12">
...
$(document).ready(function() {
	var tabla = $('#listar-{{$ruta}}').DataTable({
        ...
        ajax: '{{url ("mantenedores/intsahorrovol/listar")}}',
        columns: [
        	{ data: 'inst_apv_ncorr', name: 'ID' },
