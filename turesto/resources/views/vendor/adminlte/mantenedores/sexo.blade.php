...
<a class="btn btn-primary " data-toggle="modal" href='#agregar-Sexo' title="Agregar Banco"><i class="fa fa-plus" aria-hidden="true"></i> Agregar Sexo</a>
@endsection
...
@section('main-content')
	...
	<h2>Listado de <small> Sexo</small></h2>
	<div class="row">
		@if ($errors->any())
		...
		<div class="table-responsive">
			<table class="table table-hover" id="listar-Sexo">
				<thead>
					<tr>
						<th>ID</th>
						<th>Nombre</th>
...
<div class="modal fade " id="agregar-Sexo">
	<div class="modal-dialog">
		<div class="modal-content">

			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4 class="modal-title">Nuevo Sexo</h4>
			</div>

			<div class="modal-body">
				<div class="row">
						<form action="{{url('mantenedores/sexo/crear')}}" method="POST" role="form">
					<div class="col-md-12">
...
$(document).ready(function() {
	var tabla = $('#listar-Sexo').DataTable({
        processing: true,
        dom: 'Bfrtip',
        buttons: ['print'],
        language: {
        ...
        ajax: '{{url ("mantenedores/sexo/listar")}}',
        columns: [
        	{ data: 'sexo_ncorr', name: 'ID' },
