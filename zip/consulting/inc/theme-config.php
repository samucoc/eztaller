    ...
    function consulting_config() {
        ...
        switch( $config['layout'] ) {
            case 'layout_denver':
                ...
                $config['secondary_color'] = '#d7562d';
                $config['third_color'] = '#8fc8f8';
            ...
            case 'layout_20':
                ...
                $config['base_color'] = '#baaf92';
                $config['secondary_color'] = '#ff8426';
                $config['third_color'] = '#000000';
...
function consulting_layout_plugins($layout = 'default', $get_layouts = false)
{
