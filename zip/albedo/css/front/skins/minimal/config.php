...
// background-color: #777;
		...
		**/
		...
		/**
			Page 404
		**/
		'page_404_style' => 'minimal',
		'page_404_title_1' => esc_html__( '404', 'albedo' ),
		'page_404_title_2' => esc_html__( 'Sorry! The page not found...', 'albedo' ),
		'page_404_title_3' => esc_html__( 'The Link You Folowed Probably Broken,
or the page has been removed...', 'albedo' ),
		'page_404_display_search' => 'no',
		'page_404_display_home_btn' => 'yes',
		'page_404_home_btn_text' => esc_html__( 'Home Page', 'albedo' ),
		...
		'menu_container_display_shadow' => 'no',
		 ...
		 **/
		'header_layout' => 'style_7',
		'display_header_page_title' => 'no',
		'display_header_page_desc' => 'no',
