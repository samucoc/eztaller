	...
	array(
		...
		'carousel' => array(
			...
			'options' => array(
				...
				'excerpt_length' => array(
					'label' => esc_html__( 'Excerpt length', 'albedo' ),
					'desc' => esc_html__( 'how many words will be displayed', 'albedo' ),
					'type' => 'short-text',
					'value' => ''
				),
				'display_cats' => array(
				...
				'display_button' => array(
					...
					'picker' => array(
						'enabled' => array(
							'label' => esc_html__( 'Display details button', 'albedo' ),
							'type' => 'switch',
							'left-choice' => array(
								'value' => 'no',
								'color' => '#ccc',
					...
					'choices' => array(
						'yes' => array(
							...
							'button_text' => array(
								...
								'value' => esc_html__('Details', 'albedo'),
							),
							'button_style'  => array(
		...
		'style' => array(
			...
			'options' => array(
				...
				'columns_ratio' => array(
					'label' => esc_html__( 'Columns aspect ratio', 'albedo' ),
					'desc' => esc_html__( 'affects thumbnail and content sides of slide', 'albedo' ),
					'type' => 'select',
					'value' => 'col-md-9 col-md-3',
					'choices' => array(
						'col-md-9 col-md-3' => '9 + 3',
						'col-md-8 col-md-4' => '8 + 4',
						'col-md-7 col-md-5' => '7 + 5',
						'col-md-6 col-md-6' => '6 + 6',
						'col-md-5 col-md-7' => '5 + 7',
						'col-md-4 col-md-8' => '4 + 8',
						'col-md-3 col-md-9' => '3 + 9',
					),
				),
				...
				'pagination_color' => array(
					'label' => esc_html__('Pagination bullet color', 'albedo'),
