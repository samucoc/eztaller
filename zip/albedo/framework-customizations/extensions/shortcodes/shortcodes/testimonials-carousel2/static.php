...
if ( ! function_exists( '_action_wplab_albedo_shortcode_testimonials_carousel2_enqueue_dynamic_css') ):

	/**
	 * @internal
	 * @param array $data
	 */
	function _action_wplab_albedo_shortcode_testimonials_carousel2_enqueue_dynamic_css( $data ) {

		$shortcode = 'testimonials-carousel2';
		...
		wp_enqueue_style( 'wplab-albedo-testimonials-carousel2', wplab_albedo_utils::locate_uri( '/css/front/css/shortcodes/testimonials_carousel2.css'), false, _WPLAB_ALBEDO_CACHE_TIME_ );
		wp_enqueue_style( 'wplab-albedo-testimonials-carousel2-variable', wplab_albedo_utils::locate_uri( '/css/front/less/shortcodes/testimonials_carousel2_variable.less'), false, _WPLAB_ALBEDO_CACHE_TIME_ );
	...
	add_action(
		'fw_ext_shortcodes_enqueue_static:testimonials_carousel2',
		'_action_wplab_albedo_shortcode_testimonials_carousel2_enqueue_dynamic_css'
	);
