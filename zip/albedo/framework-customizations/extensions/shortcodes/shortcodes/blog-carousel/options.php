		...
		'carousel' => array(
			...
			'options' => array(
				...
				'display_author' => array(
					'label' => esc_html__( 'Display author name', 'albedo' ),
					'type' => 'switch',
					'value' => 'yes',
					'left-choice' => array(
						'value' => 'no',
				...
				'display_time' => array(
					'label' => esc_html__( 'Display post time', 'albedo' ),
					'type' => 'switch',
					'value' => 'yes',
					'left-choice' => array(
						'value' => 'no',
		...
		'style' => array(
			...
			'options' => array(
				...
				'pagination_position' => array(
					'label' => esc_html__( 'Pagination position', 'albedo' ),
					'type' => 'select',
					'value' => 'left',
					'choices' => array(
				...
				'custom_radius' => array(
					'label' => esc_html__( 'Custom radius', 'albedo' ),
