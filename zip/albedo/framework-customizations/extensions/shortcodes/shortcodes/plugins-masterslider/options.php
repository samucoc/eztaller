...
if( shortcode_exists('masterslider') ) {
	$sliders = $wplab_albedo_core->model( 'thirdparty' )->get_masterslider_sliders();
}
...
$options = array(
	'slider_alias' => array(
		...
		'desc' => esc_html__( 'Select one of created sliders. MasterSlider plugin should be activated.', 'albedo' ),
	),
);
