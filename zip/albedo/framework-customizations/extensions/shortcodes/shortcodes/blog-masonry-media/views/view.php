...
$atts['tpl'] = 'template-parts/blog/masonry-media';
...
if( $posts->have_posts() ):
?>
<div id="shortcode-<?php echo esc_attr( $atts['id'] ); ?>" class="shortcode-blog-masonry-media">

	<div id="posts-container-id-<?php echo esc_attr( $atts['id'] ); ?>" class="blog-masonry-media-posts masonry-grid <?php echo implode(' ', $classes ); ?>">
