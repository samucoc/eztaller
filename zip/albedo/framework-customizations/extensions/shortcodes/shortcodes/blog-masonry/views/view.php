...
$atts['tpl'] = 'template-parts/blog/masonry';
...
if( $posts->have_posts() ):
?>
<div id="shortcode-<?php echo esc_attr( $atts['id'] ); ?>" class="shortcode-blog-masonry">

	<div id="posts-container-id-<?php echo esc_attr( $atts['id'] ); ?>" class="blog-masonry-posts masonry-grid <?php echo implode(' ', $classes ); ?>">
