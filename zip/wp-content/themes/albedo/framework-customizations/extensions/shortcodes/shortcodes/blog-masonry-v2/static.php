...
if ( ! function_exists( '_action_wplab_albedo_shortcode_blog_masonry_v2_enqueue_dynamic_css') ):

	/**
	 * @internal
	 * @param array $data
	 */
	function _action_wplab_albedo_shortcode_blog_masonry_v2_enqueue_dynamic_css( $data ) {
		global $wplab_albedo_core;
		$shortcode = 'blog_masonry_v2';
		...
		wp_enqueue_style( 'wplab-albedo-blog-masonry-v2-variable', wplab_albedo_utils::locate_uri( '/css/front/less/shortcodes/blog_masonry_v2_variable.less'), false, _WPLAB_ALBEDO_CACHE_TIME_ );
	...
	add_action(
		'fw_ext_shortcodes_enqueue_static:blog_masonry_v2',
		'_action_wplab_albedo_shortcode_blog_masonry_v2_enqueue_dynamic_css'
	);
