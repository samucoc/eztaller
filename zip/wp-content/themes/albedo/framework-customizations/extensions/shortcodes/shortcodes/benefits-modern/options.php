	...
	array(
		...
		'colors-settings' => array(
			...
			'options' => array(
				...
				'decor_color' => array(
					'label' => esc_html__('Decor color', 'albedo'),
					'desc' => esc_html__('custom decor color', 'albedo'),
					'type' => 'rgba-color-picker',
				),
				'button_color' => array(
					'label' => esc_html__('Button color', 'albedo'),
					'desc' => esc_html__('custom button color', 'albedo'),
					'type' => 'color-picker',
				),
				'button_hover_color' => array(
					'label' => esc_html__('Button hover color', 'albedo'),
					'desc' => esc_html__('custom button hover color', 'albedo'),
					'type' => 'color-picker',
				),
