...
$classes = array();
$atts['tpl'] = 'template-parts/blog/minimal';
...
if( $posts->have_posts() ):
	...
	$classes[] = 'style-' . esc_attr( $atts['style'] );

?>
<div id="shortcode-<?php echo esc_attr( $atts['id'] ); ?>" class="shortcode-blog-minimal <?php echo implode( ' ', $classes ); ?>">

	<div class="posts-container" id="posts-container-id-<?php echo esc_attr( $atts['id'] ); ?>">
