...
?>
<div class="shortcode-benefits-modern style-<?php echo esc_attr( $style ); ?> items-accent<?php echo esc_attr( $accent ); ?>" id="shortcode-<?php echo esc_attr( $atts['id'] ); ?>">
		...
		<div class="item col-md-<?php echo $column; ?> <?php echo $item['icon_type']['benefit_icon'] == '' ? 'no-icon' : ''; ?> <?php if( $animated ): ?>wow <?php echo esc_attr( $animation ); endif; ?>" <?php if( $animated ): ?>data-wow-delay="<?php echo esc_attr( $animation_step * $counter / 2 ); ?>s"<?php endif; ?>>
			<div class="item-inside">
					...
					<div class="benefit-text">
						...
						<?php if( $item['link'] <> '' && filter_var( $atts['display_button'], FILTER_VALIDATE_BOOLEAN ) ): ?>
						<a target="<?php echo esc_attr( $atts['link_target'] ); ?>" href="<?php echo esc_attr( $item['link'] ); ?>" class="btn"></a>
						<?php endif; ?>
