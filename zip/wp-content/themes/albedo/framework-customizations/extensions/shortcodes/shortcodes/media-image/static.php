...
if (!function_exists('_action_wplab_albedo_shortcode_image_enqueue_dynamic_css')):

	/**
	 * @internal
	 * @param array $data
	 */
	function _action_wplab_albedo_shortcode_image_enqueue_dynamic_css( $data ) {
		...
		wp_enqueue_script( 'wplab-albedo-media', wplab_albedo_utils::locate_uri('/framework-customizations/extensions/shortcodes/shortcodes/media-image/static/js/scripts.js'), array('jquery'), _WPLAB_ALBEDO_CACHE_TIME_, true );
	...
	add_action(
		...
		'_action_wplab_albedo_shortcode_image_enqueue_dynamic_css'
	);
