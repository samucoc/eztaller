<?php
/**
* Layout #9 for Portolio single post
* a screenshot of it: /wp-content/themes/wplab-albedo/images/portfolio_single_layouts/layout_9.jpg
**/
the_post();
$post_id = get_the_ID();
...
<div id="post-<?php the_ID(); ?>" <?php post_class( 'single-portfolio-post-container layout-style_9 content-align-' . $post_text_align ); ?>>
	<div class="container">
