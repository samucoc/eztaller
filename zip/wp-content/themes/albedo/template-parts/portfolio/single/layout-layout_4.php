<?php
/**
 * Layout #4 for Portolio single post
 * a screenshot of it: /wp-content/themes/wplab-albedo/images/portfolio_single_layouts/layout_4.jpg
 **/
	the_post();
	$post_id = get_the_ID();
...
<div id="post-<?php the_ID(); ?>" <?php post_class( 'single-portfolio-post-container layout-style_4 content-align-' . $post_text_align ); ?>>
	<div class="container">
							...
							<?php
								...
								if( $display_post_gallery && function_exists( 'fw_ext_portfolio_get_gallery_images') ):
									...
									if( !empty( $portfolio_images ) ):
										?>
										<div class="single-portfolio-images lightbox-images">
