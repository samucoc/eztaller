<?php
	/**
	 * Sub-header layout style 8, it looks like on following screenshots
	 * /wp-content/themes/wplab-albedo/images/header_layout_8.jpg
	 **/
				...
				<div class="subheader-container">
					...
					<div class="subheader-text">
						...
						<?php if( $display_page_title ): ?>
							<?php wplab_albedo_front::print_page_title( array( 'effect' => 'typed' )); ?>
						<?php endif; ?>
					</div>
