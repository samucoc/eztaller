<?php /* Smarty version 2.6.18, created on 2015-02-03 11:19:28
         compiled from sg_bodega_imp_guia.tpl */ ?>
					...
					<tr>
						<td>
							<table border="0" class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr> 
									<td colspan="2" class="tabla-alycar-fila-informa-requerida-contrato">Imprime Guia</td>
								</tr>
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 20%">Guia:<label class="requerido"> * </label></td>
								...
								<tr align="left">
									<td colspan="6" class="tabla-alycar-fila-botones">
										...
										<?php if (( $this->_tpl_vars['GUIA'] != '' )): ?>
											...
											<!--
											<input type="button" id="btnEliminar" name="btnEliminar" value="Eliminar Gu�a" class="boton" onclick="xajax_LlamaElimina(xajax.getFormValues('Form1'));">
											-->
