<?php /* Smarty version 2.6.18, created on 2016-09-23 11:12:37
         compiled from sg_ot_informe_fecha.tpl */ ?>
					...
					<tr>
						<td>
							<table border="0" class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr> 
									<td colspan="2" class="tabla-alycar-fila-informa-requerida-contrato">Ordenes de Trabajo por fecha</td>
								</tr>
							</table>
						</td>
					</tr>
				...
				<table class="curvar tabla-alycar"  cellpadding="2" cellspacing="2" style="WIDTH: 100%; float: left; border: 1pt solid #B9B9B9; background:#ffffff">
					<tr>
						...
						<td class="tabla-alycar-texto" colspan="3">
							<input type="text" name="fecha1" id="fecha1"> al <input type="text" name="fecha2" id="fecha2">
						</td>
					</tr>
					<tr>
