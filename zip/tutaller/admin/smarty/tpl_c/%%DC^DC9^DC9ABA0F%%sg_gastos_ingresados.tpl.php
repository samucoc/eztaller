<?php /* Smarty version 2.6.18, created on 2011-01-20 12:07:45
         compiled from sg_gastos_ingresados.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'sg_gastos_ingresados.tpl', 82, false),)), $this); ?>
						...
						<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									<td style="width: 7%" align='right'><img src="../images/Gnome-Accessories-Calculator-48.png"></td>
									<td style="width: 93%"><label class="form-titulo">&nbsp;&nbsp; Gastos Ingresados</label></td>
								</tr>
							</table>
							<br>
...
' onKeyPress="return SoloNumeros(this, event, 0)" maxLength="10" size='9'>
								...
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 15%">Estado:<label class="requerido"> * </label></td>
									<td class="tabla-alycar-texto" style="width: 28%">
										<SELECT id="OBLIcboEstado" name="OBLIcboEstado" style="width: 100%" onKeyPress="return Tabula(this, event, 0)">
									...
									<td class="tabla-alycar-texto" style="width: 42%">
										...
										<INPUT type="text" id="txtDescTrabajador" name="txtDescTrabajador" readonly value='' maxLength="100" size="28">
										&nbsp;&nbsp;
