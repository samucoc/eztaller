    ...
    echo "<br>Valor filtro: <b>".$txt_codigo."</b>";
		  ...
		  if ($_POST['OK']=='Guardar y Seguir')
		 {
		   ...
		   $codigo       = trim($_POST['txt_cod']);  
				...
				echo "<script language=Javascript> location.href=\"reclamo_manual.php?id=".$id1."&id2=".$codigo."\"; </script>";	
				}else{
				echo "<script language=Javascript> location.href=\"reclamo_manual.php?id=".$codigo."\"; </script>";
