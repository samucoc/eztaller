          ...
          <table width="100%" height="30">
            <tr>
              ...
              <td valign="bottom"><div align="left">
               ...
               <!-- <input name="OK" type="image" class="boton" title="Guardar y continuar" value="Guardar y Seguir"  src="images/guardar.png" align="left" width="30"  height="30"/>-->
              </div></td>
            </tr>
          </table>
...
if ($_GET["nombre"]!=""){
   ...
   $codigo = " where nombre_equipo like '%" . strtoupper($txt_nombre) . "%' ";
		 ...
		 //  $cod_arriendo = $_GET['cod_arr'];
		   $codigo       = trim($_POST['txt_cod']);
			...
			if (!empty($codigo))
			{
		        ...
		        echo "<script language=Javascript> location.href=\"reparar_equipo.php?txt_nombre_equi=".$codigo."\"; </script>";
			} else {
				$link=mensaje();
			}
		 }
...
?></td>
  ...
  <table width="550" border="0" align="center">
    <tr>
      <td><a href="javascript:history.back()" onmouseover="Volver"><img src="images/volver.png" width="40" height="40" align="right" /></a></td>
    </tr>
  </table>
<br />
</div>
