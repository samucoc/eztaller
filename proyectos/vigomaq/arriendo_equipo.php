...
if (($_POST['buscarcodigo']=='Buscar')||($_POST['tipo_busqueda']=='buscarcodigo'))
{
    ...
    echo "<META HTTP-EQUIV='refresh' CONTENT='0; URL=busca_cod.php?id=$busca_cod&cod_arr=$cod_arriendo'>";
}
//envia el codigo
if (($_POST['buscarnombre']=='Buscar')||($_POST['tipo_busqueda']=='buscarnombre'))
{
	...
	$cod_arriendo=$registro['cod_arriendo'];
    echo "<META HTTP-EQUIV='refresh' CONTENT='0; URL=busca_cod.php?nombre=$busca_nom&cod_arr=$cod_arriendo'>";
}
?>
</td>
                  </tr>
	  ...
	  if ($_POST['OK']=='Continuar')
	  {
		  ...
		  if ($filas>=1)
		  {
			echo "<script language=Javascript> location.href=\"arriendo_datos.php?codarr=".$valor2."\"; </script>";
		  }else{
		  	$link=mensaje();
		  }
	...
	?>
     <?php	 
	  if ($_POST['paso1']=='paso1')
		  {
			echo "<script language=Javascript> location.href=\"arriendo_cliente.php?codarr=".$valor2."\"; </script>";	
		  }	  
	?>
     <?php
