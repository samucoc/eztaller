...
<body>
    ...
    <br class="clearFloat"/>
    <form action="gd_nofacturable.php" method="post" name="frmDatos" id="frmDatos">
    ...
    <tr>
      ...
      <td width="48%"><div align="center" class="Estilo6"><div align="right" class="Estilo20"><strong><font>
        <?php
			...
			?>
        GUIA DE DESPACHO - NO FACTURABLE</font></strong></div></div></td>
    </tr>
    <tr>
            ...
            <tr >
              <td colspan="4" align="right" >
	            ...
	            <?php if (empty($registrogd['id_arriendo']) && empty($registrogd['num_gd'])){
				    ...
				    <?php }?>
	                <a href="gd_nofacturable.pho" class="menulink" onclick="document.getElementById('rut').value = '';">
...
<script>
	...
	$(document).ready(function(){
		$("#txt_gd").bind('blur',function() {
			...
			//location.href="gd_nofacturable.pho?num_gd="+num_gd;
			});
 ...
 <?php   
	...
	if ($_POST['borrar']=='Borrar')	 { 
		 ...
		 if ($codigo_det>0){
			 ...
			 echo "<script language=Javascript> location.href=\"gd_nofacturable.pho?num_gd=".$num_gd."\"; </script>";
		 	}
	 	}   
