...
-->
    ...
    <br />
    <div id="warp">
    	<H4>LISTADO DE EQUIPOS NO DEVUELTOS SIN CIERRE DE MES</H4>
        <H5>Con fechas de arriendo segun rango</H5>
        <div id="div-busqueda">
        ...
        <input class="imprimir" type="button" value="Imprimir" onclick="window.print(); return false" style="background-image:url(images/impresora.gif)"/>
    </div>
    ...
    $(document).ready(function() {
		...
		$(".buscar").click(function(){
			...
			$.ajax({
				url: 'classes/cierre_mes/buscar_equipos_fecha.php?inicio='+inicio+'&fin='+fin,
