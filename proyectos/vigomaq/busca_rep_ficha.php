...
if ($_GET["nombre"]!=""){
   ...
   $codigo = " where nombre_repuesto like '%" . strtoupper($txt_nombre) . "%' ";
...
if(isset($txt_codigo)){
	...
	?>
      ...
      <br><a href="repuesto.php" onmouseover="Volver"></a>
    ...
    if($pagina>1)
    {
	   ...
	   echo "<a class='p' href='".$_SERVER["PHP_SELF"]."?pagina=".($pagina-1)."&orden=".$orden."&nombre=".$txt_codigo."'>";
    ...
    for($i=$inicio;$i<=$final;$i++)
    {
       if($i==$pagina)
       {
		  ...
		  echo "<a class='p' href='".$_SERVER["PHP_SELF"]."?pagina=".$i."&orden=".$orden."&nombre=".$txt_codigo."'>";
...
?></td>
      ...
      <table width="100%" border="0">
        <tr>
          <td><a href="repuesto.php" onmouseover="Volver"><img src="images/volver.png" width="40" height="40" align="right" title="Volver" border="0"/></a></td>
        </tr>
      </table>
      </form></td>
    </tr>
