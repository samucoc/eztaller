     ...
     <td valign="middle"><div align="right" class="Estilo2"><br />
       ...
       Sistema de Arriendo y Facturación - Vigomaq</span></div></td>
        ...
        <div id="div-menu">
			...
			?>
<input type="hidden" id="arriendos" value="<?php
if ($_POST["arriendos"]!=""){
   	echo $_POST["arriendos"];
	}
if ($_GET["arriendos"]!=""){
	echo $_GET['arriendos'];
	}
...
<div align="center" class="Estilo6 Estilo1 Estilo8 Estilo9  Estilo12" style="padding:10px;">
  <div align="right" class="Estilo19">
    <div align="right" class="Estilo20">ARRIENDO - EQUIPOS POR FACTURAR</div>
  </div>
</div>
<div align="left" class="control_gd" style="background-color:#06327D !important">
	<span class="Estilo7" >SELECCIONAR N&deg; GUÍA DESPACHO </span>
  	<input  id="gd-control" name="gd-control" style="padding:5px; border:#FF0 1px solid"/>
</div>
<div id="resultado"> 
</div>
...
<script>
	$(document).ready(function() {
		$( "#gd-control" ).autocomplete({
			source: "classes/arriendos_fact/buscar_guia_despacho.php",
			minLength: 1,
			focus: function(event,ui){
				var value =  ui.item.value;
				$.ajax({
					url: 'classes/arriendos_fact/buscar_equipos_gd.php?num_gd='+value,
					type : 'POST',
