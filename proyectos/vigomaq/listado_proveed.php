      ...
      <tr> 
        <td colspan="2" class='titulo_fondo'><div align="center" class="Estilo6 Estilo1 Estilo8 Estilo9  Estilo12">
          <div align="right" class="Estilo19">
            <div align="right" class="Estilo20">LISTADO PROVEEDORES</div>
          </div>
      </div></td>
      </tr>
      <tr>
...
$sql = "SELECT * FROM proveedor order by cod_fabricante asc;";
...
echo "</font></div>";
?></td>
 <td align="right" valign="top" bgcolor="#FFFFFF"><?php echo "<a href='imp_list_pro.php' target='_blank'>Vista Preliminar</a>"; ?></td>
      </tr>
      <tr><td colspan="2" valign="top" bgcolor="#06327D"><div align="left"><span class="Estilo7">LISTADO PROVEEDORES</span></div></td>
      </tr>
      ...
      <tr>
        <td colspan="2"><table width="100%" border="0" align="center">
          ...
          <tr>
            ...
            <th bgcolor="#06327D"><div align="center" class="Estilo17">Tel&eacute;fono</div></th>
            <th bgcolor="#06327D"><div align="center" class="Estilo17">Direcci&oacute;n</div></th>
            ...
            <th bgcolor="#06327D"><div align="center" class="Estilo17">Fono Contacto</div></th>
            <th bgcolor="#06327D"><div align="center" class="Estilo17">Email Contacto</div></th>
            </tr>
          <tr>
...
?>
            ...
            <td><?php echo $registro['email_cont1'] ; ?></td>
            </tr>
          <tr>
            <td>----------------</td>
            <td>-------------------------------------</td>
