...
<li><a href="arriendo_devolver.php" target="_parent">Devolver Arriendo</a></li>
  ...
  <li><a href="#" class="menulink">Facturación</a>
		  ...
		  <ul>
             ...
             <li><a href="rentabilidad.php">Rentabilidad Activos</a></li>
          ...
          <table width="100%" height="30">
            <tr>
              ...
              <td valign="bottom"><div align="left">
                ...
                <input type="submit" name="OK" value="Equipo a Evaluar" title="Equipo a Evaluar"  />
...
if(isset($txt_codigo)){
		  ...
		  if ($_POST['OK']=='Equipo a Evaluar')
		 {
	           ...
	           echo "<script language=Javascript> location.href=\"devolucion.php?codequipo=".$codigo."&nomequipo=".$nomequipo."\"; </script>";
			} else {
				$link=mensaje();
			}
		 }
	?>
      ...
      <br><a href="evaluacion.php" onmouseover="Volver"><img src="images/volver.png" width="40" height="40" align="right" border="0"/></a>
