...
$rut_param = $rut;
$parte3 = substr($rut_param, -3,3); // la cuenta va de derecha a izq  
$parte2 = substr($rut_param, -6,3);  
$parte1 = substr($rut_param, 0,-6); //de esta manera toma todos los caracteres desde el 8 hacia la izq 
$rut = $parte1.".".$parte2.".".$parte3; 
...
$sql_eq_no_dev = "
		...
		where equipos_arriendo.estado_equipo_arr in ('NO DEVUELTO','DEVUELTO-NO FACTURADO')
			and arriendo.rut_cliente like '".$rut."-%'
...
while($row_eq_no_dev = mysql_fetch_array($res_eq_no_dev)){
	...
	echo "<td>".iconv("UTF-8", "UTF-8//IGNORE",(($row_eq_no_dev['nombre_obra'])))."</td>";
