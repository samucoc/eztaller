...
include("../conex.php");
	...
	// 				            <RznSocRecep>'.str_replace("Ã‘",'N',$registro['raz_social']).'</RznSocRecep>
	// 				            <GiroRecep>'.str_replace("Ã‘",'N',$registro['giro_cliente']).'</GiroRecep>
	// 				            <DirRecep>'.str_replace("Ã‘",'N',$registro['direcc_cliente']).'</DirRecep>
	// 				            <CmnaRecep>'.str_replace("Ã‘",'N',$registrocom['comuna']).'</CmnaRecep>
	// 				            <CiudadRecep>'.str_replace("Ã‘",'N',$registrociu['ciudad']).'</CiudadRecep>
	// 				        </Receptor>
	// 				        ';
	...
	$sqlobra   = "SELECT nombre_obra,direcc_obra FROM obra WHERE cod_obra =".$registroguia['cod_obra'];
	...
	if ($tipo==""){
		...
		if(!empty($registroguia['id_arriendo'])){
			$sql_reclamo   = "select hora_devol as hora_reclamo
