...
class tc_calendar{
	var $icon;
	var $objname;
	var $txt = "Seleccione Día"; //display when no calendar icon found or set up
	...
	function getMonthNames(){
		return array("Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noveimbre", "Diciembre");		
	}
