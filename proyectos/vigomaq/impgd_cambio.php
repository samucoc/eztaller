...
<form method="post" name="frmDatos" id="frmDatos">
  ...
  <tr>
    ...
    <td></td>
    <td colspan="2"><?php echo ($registro['giro_cliente']);?><br /></td>
  </tr>
  <tr>
    <td><br /></td>
    <td><?php
  ...
  <table width="100%" height="85" border="0">
    <tr>
    <td height="81"><table width="1190" border="0">
      <tr>
        <td align="center">&nbsp;</td>
      ...
      <tr>
        <td align="center"><?php echo($registrodet['cantidad']); ?></td>
        <td align="left" valign="bottom">&nbsp;</td>
        <td align="left"><?php 
				  if (!empty($valor1))
					  {
						  ...
						  if($posicion == 1){
						  echo '<strong>CAMBIO DE</strong><br /> ';
						  }else{
						   echo '<strong>POR </strong><br />';
						  }
						  ...
						  {
						   	echo ' ,  INCLUYE MOTOR N. '.$registronrep['cod_motor'];
						  }
        ...
        <td align="center"><?php echo("$ ".number_format($registrodet['precio'], 0, ",", ".")) ;?></td>
      </tr>
      <tr>
        <td align="center"></td>
        <td width="51" align="center" valign="bottom"></td>
        <td align="center"></td>
        <td width="171" align="center"><?php
				}
