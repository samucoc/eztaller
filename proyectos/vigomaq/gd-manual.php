...
<body>
    ...
    <br class="clearFloat"/>
    <form action="gd-manual.php" method="post" name="frmDatos" id="frmDatos">
            ...
            <tr >
              <td colspan="4" align="right" >
	            ...
	            <?php if (empty($registrogd['id_arriendo']) && empty($registrogd['num_gd'])){
					...
					?>             
				    <a id="imprimir-gd" href="#" ><img width="45" height="45" border="0" class="oculto" title="Imprimir Guía Despacho" src="images/gest_fin/factura.png"></a>
				    <?php }?>
	                <a href="gd-manual.php" class="menulink" onclick="document.getElementById('rut').value = '';">
...
<script>
	...
	$(document).ready(function(){
		...
		$('#agregar-fila').live('click',function() {
			...
			var num_gd = $("#txt_gd").val();
			if (num_gd > 0){
				$("#imprimir-gd").attr('href','classes/consulta-gd/vista-previa-gd-manual.php?num_gd'+num_gd);
				}
 ...
 <?php   
	...
	if ($_POST['borrar']=='Borrar')	 { 
		 ...
		 if ($codigo_det>0){
			 ...
			 echo "<script language=Javascript> location.href=\"gd-manual.php?num_gd=".$num_gd."\"; </script>";
		 	}
	 	}   
