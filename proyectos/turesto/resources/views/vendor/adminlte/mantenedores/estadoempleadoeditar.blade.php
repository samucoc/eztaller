...
<a class="btn btn-info" href="{{ URL('/mantenedores/estadoempleado') }}"><i class="fa fa-angle-left" aria-hidden="true"></i> back</a>
@endsection
...
<div class="container">
@foreach ($estadoempleado as $banco)
		<div class="col-md-10 col-xs-9">
			<h2><i class="fa fa-industry" aria-hidden="true"></i> Estado Empleados</h2>
		</div>
	</div>
	<br>
	<div class="row">
		<div class="col-md-12">
			<form action="{{url('mantenedores/estadoempleado/guardar')}}" method="" role="form">
				<div class="form-group">
					<input type="hidden" name="_token" value="{{{ csrf_token() }}}" />
					<input type="hidden" name="txtid" value="{{$banco->tc_ncorr}}" />
