...
@section('htmlheader_title')
	{{ trans('adminlte_lang::message.listadoestadoventas') }}
@endsection
...
<a class="btn btn-primary " data-toggle="modal" href='#agregar-estadoventas' title="Agregar perfil"><i class="fa fa-plus" aria-hidden="true"></i> Agregar Estado de Venta</a>
@endsection
...
@section('main-content')
	...
	<h2>Listado de <small> Estados de Ventas</small></h2>
		<div class="row">
		@if ($errors->any())
		...
		<div class="table-responsive">
			<table class="table table-hover" id="listar-estadoventas">
				<thead>
					<tr>
						<th>ID</th>
						<th>Descripcion</th>
...
<div class="modal fade " id="agregar-estadoventas">
	<div class="modal-dialog">
		<div class="modal-content">

			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4 class="modal-title">Nuevo Estado de Ventas</h4>
			</div>

			<div class="modal-body">
				<div class="row">
						<form action="{{url('mantenedores/estadoventas/crear')}}" method="POST" role="form">
					<div class="col-md-12">
...
$(document).ready(function() {
	var tabla = $('#listar-estadoventas').DataTable({
        processing: true,
        dom: 'Bfrtip',
        buttons: [
            'excel', 'pdf','print'
        ...
        ajax: '{{url ("mantenedores/estadoventas/listar")}}',
        columns: [
            { data: 'ev_id', name: 'ev_id' },
            { data: 'ev_descripcion', name: 'ev_descripcion' }
        ]
    });
