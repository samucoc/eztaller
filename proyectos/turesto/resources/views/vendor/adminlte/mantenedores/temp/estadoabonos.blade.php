...
@php 	$ruta = "estadoabonos"; $modal = "estadoabono";	 	 @endphp
@extends('adminlte::layouts.app') 

<!-- aqui escribimos el texto que tendra nuestra pagina -->
@section('htmlheader_title')
	{{ trans('adminlte_lang::message.listadoestadoabonos') }}
@endsection
...
<a class="btn btn-primary " data-toggle="modal" href='#agregar-{{$modal}}' title="Agregar Rango cuota"><i class="fa fa-plus" aria-hidden="true"></i> Agregar Estado de Abono</a>
@endsection
...
@section('main-content')
	...
	<h2>Listado de <small> tipos de Estado de Abonos</small></h2>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 class="modal-title">Nuevo Tipo de Estado de Abono</h4>
			</div>

			<div class="modal-body">
				<div class="row">
						<form action="{{url('mantenedores/estadoabonos/crear')}}" method="POST" role="form">
					<div class="col-md-12">
...
$(document).ready(function() {
	var tabla = $('#listar-{{$ruta}}').DataTable({
        ...
        ajax: '{{url ("mantenedores/estadoabonos/listar")}}',
        columns: [
        	{ data: 'ea_id', name: 'ea_id' },
            { data: 'ea_descripcion', name: 'ea_descripcion' },
