...
@php 	$ruta = "tipoproductos"; $modal = "tipoproducto"; @endphp
...
<a class="btn btn-primary " data-toggle="modal" href='#agregar-{{$modal}}' title="Agregar nueva marca"><i class="fa fa-plus" aria-hidden="true"></i> Agregar Tipo de Producto</a>
@endsection
...
<div class="container-fluid spark-screen" >
	<h2>Listado de <small> Tipos de Productos</small></h2>
		<div class="row">
			@if ($errors->any())
			...
			<div class="modal-body">
				<div class="row">
					...
					<div class="col-md-12">
							...
							<div class="form-group">
								<label for="txtcategoria"><i class="fa fa-id-card-o" aria-hidden="true" ></i> Categoria</label>
								<select name="txtcategoria" class="form-control">
									<option value="0">Seleccione...</option>
									@foreach($categorias as $categoria)
										<option value="{{ $categoria->categoria_id }}">{{ $categoria->categoria_descripcion }}</option>
									@endforeach
								</select>	
							</div>
...
$(document).ready(function() {
	var tabla = $('#listar-{{$ruta}}').DataTable({
        ...
        ajax: '{{url ("mantenedores/tipoproductos/listar")}}',
        columns: [
            { data: 'tproducto_id', name: 'tproducto_id' },
            { data: 'tproducto_descripcion', name: 'tproducto_descripcion' },
            {data: 'categorias.categoria_descripcion', name: 'categorias'},
