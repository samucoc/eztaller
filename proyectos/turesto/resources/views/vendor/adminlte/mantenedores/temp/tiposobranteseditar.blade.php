...
-->
@php 	$ruta = "tiposobrantes"; $rutasingular = "tiposobrante";@endphp
...
<a class="btn btn-info" href="{{ URL('/mantenedores/tiposobrantes') }}"><i class="fa fa-angle-left" aria-hidden="true"></i> back</a>
@endsection
...
<div class="container">
	@foreach ($tiposobrantes as $tiposobrante)
		...
		<div class="row">
			<div class="col-md-12">
				<form action="{{url('mantenedores/tiposobrantes/guardar')}}" method="" role="form">
					<div class="form-group">
						<input type="hidden" name="_token" value="{{{ csrf_token() }}}" />
						<input type="hidden" name="txtid" value="{{$tiposobrante->ts_id}}" />
					</div>
					
					<div class="form-group">
						<label for="txtdescripcion"><i class="fa fa-id-card-o" aria-hidden="true" ></i> Descripcion</label>
						<input type="text" class="form-control" name="txtdescripcion" placeholder="" value="{{$tiposobrante->ts_descripcion}}" r>
					</div>
