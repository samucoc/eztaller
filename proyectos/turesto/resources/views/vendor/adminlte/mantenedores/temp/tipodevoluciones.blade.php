...
@php 	$ruta = "tipodevoluciones"; $modal = "tipodevolucion";	 	 @endphp
@extends('adminlte::layouts.app') 

<!-- aqui escribimos el texto que tendra nuestra pagina -->
@section('htmlheader_title')
	{{ trans('adminlte_lang::message.listadotipodevoluciones') }}
@endsection
...
<a class="btn btn-primary " data-toggle="modal" href='#agregar-{{$modal}}' title="Agregar Rango cuota"><i class="fa fa-plus" aria-hidden="true"></i> Agregar tipo devolucion</a>
@endsection
...
@section('main-content')
	...
	<h2>Listado de <small> Tipos de Devoluciones</small></h2>
		<div class="row">
		@if ($errors->any())
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 class="modal-title">Nueva RaTipo de Devolucion</h4>
			</div>

			<div class="modal-body">
				<div class="row">
						<form action="{{url('mantenedores/tipodevoluciones/crear')}}" method="POST" role="form">
					<div class="col-md-12">
...
$(document).ready(function() {
	var tabla = $('#listar-{{$ruta}}').DataTable({
        ...
        ajax: '{{url ("mantenedores/tipodevoluciones/listar")}}',
        columns: [
