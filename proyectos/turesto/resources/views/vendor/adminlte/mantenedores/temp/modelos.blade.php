...
@php 	$ruta = "modelos"; $modal = "modelo"; @endphp
...
<a class="btn btn-primary " data-toggle="modal" href='#agregar-{{$modal}}' title="Agregar nueva marca"><i class="fa fa-plus" aria-hidden="true"></i> Agregar Modelo</a>
@endsection
...
<div class="container-fluid spark-screen" >
	<h2>Listado de <small> modelos</small></h2>
		<div class="row">
			@if ($errors->any())
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
						<form action="{{url('mantenedores/modelos/crear')}}" method="POST" role="form">
					<div class="col-md-12">
							...
							<div class="form-group">
								<label for="txtbusqueda"><i class="fa fa-id-card-o" aria-hidden="true" ></i> Texto de Busqueda</label>
								<input type="text" class="form-control" name="txtbusqueda" placeholder="" value="" >
							</div>						
...
$(document).ready(function() {
	var tabla = $('#listar-{{$ruta}}').DataTable({
        ...
        ajax: '{{url ("mantenedores/modelos/listar")}}',
        columns: [
            { data: 'modelo_id', name: 'modelo_id' },
            { data: 'modelo_descripcion', name: 'modelo_descripcion' },
            { data: 'modelo_busqueda', name: 'modelo_busqueda' },
