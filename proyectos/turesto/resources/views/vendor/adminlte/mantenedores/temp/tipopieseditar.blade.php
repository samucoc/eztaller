...
-->
@php 	$ruta = "tipopies"; $rutasingular = "tipopie";@endphp
...
<a class="btn btn-info" href="{{ URL('/mantenedores/tipopies') }}"><i class="fa fa-angle-left" aria-hidden="true"></i> volver</a>
@endsection
...
<div class="container">
	@foreach ($tipopies as $tipopie)
		...
		<div class="row">
			<div class="col-md-12">
				<form action="{{url('mantenedores/tipopies/guardar')}}" method="" role="form">
					<div class="form-group">
						<input type="hidden" name="_token" value="{{{ csrf_token() }}}" />
						<input type="hidden" name="txtid" value="{{$tipopie->tp_id}}" />
					</div>
					
					<div class="form-group">
						<label for="txtdescripcion"><i class="fa fa-id-card-o" aria-hidden="true" ></i> Descripcion</label>
						<input type="text" class="form-control" name="txtdescripcion" placeholder="" value="{{$tipopie->tp_descripcion}}" r>
					</div>
