...
-->
@php 	$ruta = "estadoabonos"; $rutasingular = "estadoabono";@endphp
...
<a class="btn btn-info" href="{{ URL('/mantenedores/estadoabonos') }}"><i class="fa fa-angle-left" aria-hidden="true"></i> volver</a>
@endsection
...
<div class="container">
	@foreach ($estadoabonos as $estadoabono)
		...
		<div class="row">
			<div class="col-md-12">
				<form action="{{url('mantenedores/estadoabonos/guardar')}}" method="" role="form">
					<div class="form-group">
						<input type="hidden" name="_token" value="{{{ csrf_token() }}}" />
						<input type="hidden" name="txtid" value="{{$estadoabono->ea_id}}" />
					</div>
					
					
							<div class="form-group">
								<label for="txtdescripcion"><i class="fa fa-id-card-o" aria-hidden="true" ></i> Descripcion</label>
								<input type="text" class="form-control" name="txtdescripcion" placeholder="" value="{{$estadoabono->ea_descripcion}}" >
							</div>
