...
@section('htmlheader_title')
	{{ trans('adminlte_lang::message.listadotipoabonos') }}
@endsection
...
<a class="btn btn-primary " data-toggle="modal" href='#agregar-tipoabono' title="Agregar perfil"><i class="fa fa-plus" aria-hidden="true"></i> Agregar Tipo de Abono</a>
@endsection
...
@section('main-content')
	...
	<h2>Listado de <small> tipos de Abonos</small></h2>
		<div class="row">
		@if ($errors->any())
		...
		<div class="table-responsive">
			<table class="table table-hover" id="listar-tipoabonos">
				<thead>
					<tr>
						<th>ID</th>
						<th>Descripcion</th>
...
<div class="modal fade " id="agregar-tipoabono">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
						<form action="{{url('mantenedores/tipoabonos/crear')}}" method="POST" role="form">
					<div class="col-md-12">
...
$(document).ready(function() {
	var tabla = $('#listar-tipoabonos').DataTable({
        processing: true,
        dom: 'Bfrtip',
        buttons: [
            'excel', 'pdf','print'
        ...
        ajax: '{{url ("mantenedores/tipoabonos/listar")}}',
        columns: [
            
            { data: 'ta_id', name: 'ta_id' },
            
            { data: 'ta_descripcion', name: 'ta_descripcion' }
        ]
    });
