...
@php 	$ruta = "tiposobrantes"; $modal = "tiposobrante";	 	 @endphp
@extends('adminlte::layouts.app') 

<!-- aqui escribimos el texto que tendra nuestra pagina -->
@section('htmlheader_title')
	{{ trans('adminlte_lang::message.listadotiposobrantes') }}
@endsection
...
<a class="btn btn-primary " data-toggle="modal" href='#agregar-{{$modal}}' title="Agregar Rango cuota"><i class="fa fa-plus" aria-hidden="true"></i> Agregar tipo Sobrante</a>
@endsection
...
@section('main-content')
	...
	<h2>Listado de <small> Tipos de Sobrantes</small></h2>
		<div class="row">
		@if ($errors->any())
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 class="modal-title">Nueva Tipo de Sobrante</h4>
			</div>

			<div class="modal-body">
				<div class="row">
						<form action="{{url('mantenedores/tiposobrantes/crear')}}" method="POST" role="form">
					<div class="col-md-12">
...
$(document).ready(function() {
	var tabla = $('#listar-{{$ruta}}').DataTable({
        ...
        ajax: '{{url ("mantenedores/tiposobrantes/listar")}}',
        columns: [
            { data: 'ts_id', name: 'ts_id' },
            { data: 'ts_descripcion', name: 'ts_descripcion' },
        ]
    });
