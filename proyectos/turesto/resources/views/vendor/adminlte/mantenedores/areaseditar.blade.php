...
<a class="btn btn-info" href="{{ URL('/mantenedores/areas') }}"><i class="fa fa-angle-left" aria-hidden="true"></i> back</a>
@endsection
...
<div class="container">
@foreach ($areas as $banco)
		<div class="col-md-10 col-xs-9">
			<h2><i class="fa fa-industry" aria-hidden="true"></i> Áreas</h2>
		</div>
	</div>
	<br>
	<div class="row">
		<div class="col-md-12">
			<form action="{{url('mantenedores/areas/guardar')}}" method="" role="form">
