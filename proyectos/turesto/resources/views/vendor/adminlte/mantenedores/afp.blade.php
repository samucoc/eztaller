...
<a class="btn btn-primary " data-toggle="modal" href='#agregar-afp' title="Agregar Afp"><i class="fa fa-plus" aria-hidden="true"></i> Agregar Afp</a>
@endsection
...
@section('main-content')
	...
	<h2>Listado de <small> Afp</small></h2>
	<div class="row">
		@if ($errors->any())
		...
		<div class="table-responsive">
			<table class="table table-hover" id="listar-afp">
				<thead>
					<tr>
						<th>ID</th>
						<th>Nombre</th>
...
<div class="modal fade " id="agregar-afp">
	<div class="modal-dialog">
		<div class="modal-content">

			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4 class="modal-title">Nueva Afp</h4>
			</div>

			<div class="modal-body">
				<div class="row">
						<form action="{{url('mantenedores/afp/crear')}}" method="POST" role="form">
					<div class="col-md-12">
...
$(document).ready(function() {
	var tabla = $('#listar-{{$ruta}}').DataTable({
        ...
        ajax: '{{url ("mantenedores/afp/listar")}}',
        columns: [
        	{ data: 'afp_ncorr', name: 'ID' },
