...
<a class="btn btn-info" href="{{ URL('/mantenedores/tiposcuentas') }}"><i class="fa fa-angle-left" aria-hidden="true"></i> back</a>
@endsection
...
<div class="container">
@foreach ($TiposCuentas as $banco)
		<div class="col-md-10 col-xs-9">
			<h2><i class="fa fa-industry" aria-hidden="true"></i> Tipos de Cuentas</h2>
		</div>
	</div>
	<br>
	<div class="row">
		<div class="col-md-12">
			<form action="{{url('mantenedores/tiposcuentas/guardar')}}" method="" role="form">
