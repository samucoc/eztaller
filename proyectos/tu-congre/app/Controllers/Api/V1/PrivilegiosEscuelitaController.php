...
class PrivilegiosEscuelitaController extends ResourceController
{
    protected $modelName = 'App\Models\PrivilegiosEscuelitaModel';
    ...
    public function __construct()
    {
        ...
        $this->privilegioModel = new \App\Models\PrivilegiosEscuelitaModel();
    ...
    public function new()
    {
        $data = new \App\Entities\PrivilegiosEscuelita;
        return $this->respond($data);
    }
