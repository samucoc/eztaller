...
class ReglasPrivilegiosHermanosController extends ResourceController
{
    protected $modelName = 'App\Models\ReglasPrivilegiosHermanosModel';
    ...
    public function new()
    {
        $data = new \App\Entities\ReglasPrivilegiosHermanos;
        return $this->respond($data);
    }
