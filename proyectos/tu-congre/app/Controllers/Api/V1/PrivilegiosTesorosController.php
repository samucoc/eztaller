...
class PrivilegiosTesorosController extends ResourceController
{
    protected $modelName = 'App\Models\PrivilegiosTesorosModel';
    ...
    public function new()
    {
        $data = new \App\Entities\PrivilegiosTesoros;
        return $this->respond($data);
    }
