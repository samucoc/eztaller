...
window.location.href='busca_reclamo_nombre_manual.php?nombre='+nombre;
}
...
window.location.href='busca_reclamo_nombre_manual.php?nombre='+nombre+'&tipo=id2&id1='+id1;
}
...
<p>&nbsp;</p>
<form action="reclamo_manual.php" method="post" enctype="multipart/form-data" name="frmDatos" id="frmDatos"> 
						...
						if (empty($registro_nombre['cod_equipo']) && $_POST["buscar_equi"]=="Buscar_Equi")
						 {
							 ...
							 echo "<script language=Javascript> location.href=\"reclamo_manual.php\"; </script>";
	  ...
	  if ($num_gdingreso==$num_gdsalida){	
	 	 $link=mensaje3();
                ...
                <div class="floatRight">
                    ...
                    <a id="vista-previa-gd-cambio" href="#" >
...
<script>
	...
	$(window).load(function() {
		var num_gd = $("#txt_gd_sali").val();
		if (num_gd){
			$("#vista-previa-gd-cambio").attr('href','classes/consulta-gd/vista-previa-gd-manual.php?num_gd='+num_gd);
			}
		});    		
</script>
