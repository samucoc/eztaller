      ...
      <td width="48%"><div align="center" class="Estilo6 Estilo1 Estilo8 Estilo9  Estilo12 Estilo20">
          <div align="right" class="Estilo22">
            ...
            <?php
					...
					$sqlfact = "SELECT * FROM vigomaq_intranet.nota_credito WHERE num_nota_cred ='$nota_credito'";						
      ...
      <td height="372" colspan="2" valign="top"><form method="post" name="frmDatos" id="frmDatos">
		...
		?>
		 ...
		 ?>
              ...
              <td class="CONT"><input type="image" name="impresion" value="Impresion" src="images/impresora.gif" onclick="window.print();" width="25" height="25" title="Imprimir Nota de Credito"  class="oculto" /></td>
            </tr>
          </table>
      </form></td>
    </tr>
