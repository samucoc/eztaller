...
<body>
<div id="text" style="float:left; clear:left; width:90%; margin-top:10px">
  <script type="text/javascript">
  ...
  <form>
    <table width="80%" border="0" align="center" class="bord_img">
      <tr> 
...
{
?>
            <td><?php echo $registro['cod_repuesto'] ;?></td>
