...
while ($row_factura = mysql_fetch_array($res_factura)){
	$sql_equipos ="	SELECT distinct det_factura.cod_equipo
							FROM  factura
								INNER JOIN det_factura
									ON det_factura.num_factura = factura.num_factura
								INNER JOIN equipos_arriendo
									ON (equipos_arriendo.nro_factura = factura.num_factura
										AND equipos_arriendo.arrendado_hasta >= factura.fecha)
										or (equipos_arriendo.nro_factura = factura.num_factura
											AND equipos_arriendo.arrendado_hasta <= factura.fecha)
							where factura.fecha between '".$inicio."' and '".$fin."'
								and equipos_arriendo.arrendado_desde >= '".$inicio."' 
								and equipos_arriendo.arrendado_hasta <= '".$fin."'
								and equipos_arriendo.nro_factura = ".$row_factura['nro_factura']."
								and factura.num_factura = ".$row_factura['nro_factura']."
							order by equipos_arriendo.nro_factura";
	...
	while ($row_equipos = mysql_fetch_array($res_equipos)){
		$sql_obtener_equipos ="	SELECT distinct det_factura.num_factura, factura.fecha, factura.cod_cliente,
								...
								where factura.fecha between '".$inicio."' and '".$fin."'
									and equipos_arriendo.nro_factura = ".$row_factura['nro_factura']."
									and factura.num_factura = ".$row_factura['nro_factura']."
									and equipos_arriendo.cod_equipo = ".$row_equipos['cod_equipo']."
									and det_factura.cod_equipo = ".$row_equipos['cod_equipo']."
								order by equipos_arriendo.nro_factura";
