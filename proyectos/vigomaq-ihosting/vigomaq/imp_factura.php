      ...
      <td height="372" colspan="2" valign="top"><form method="post" name="frmDatos" id="frmDatos">
		...
		?>
				  ...
				  if (!empty($valor1))
					  {
						...
						//  echo($registronob['nombre_equipo']);
		 ...
		 ?>
              ...
              <td height="21" align="right"><input type="image" name="impresion" value="Impresion" src="images/impresora.gif" onclick="window.print();elimina=confirm('�Impresion Correcta?');return elimina;" width="25" height="25" title="Imprimir Factura"/></td>
            </tr>
          </table>
           <?php	
