  ...
  <tr>
    <td height="592"><table width="95%" border="0" align="center">
	 ...
	 ?>
      ...
      <tr>
        <td valign="top"><form action="consulta_nc.php" method="post"  name="frmDatos" id="frmDatos">
          <table width="100%" height="544" border="0" align="center">
            ...
            <tr>
              ...
              <table class="sortable" id="tabla-pre" width="100%" border="0" align="center" cellpadding="1" cellspacing="1" >
                <tr>
                  <th width="9%" bgcolor="#06327D">&nbsp;</th>
                  <th width="51%" bgcolor="#06327D" class="CONT"><span class="Estilo17">Observaciones</span></th>
                  <th width="11%" bgcolor="#06327D" class="CONT">&nbsp;</th>
                  <th width="13%" bgcolor="#06327D" class="CONT"><span class="Estilo17">Monto</span></th>
                  <th width="16%" bgcolor="#06327D" class="Estilo17">&nbsp;</th>
                </tr>
                <?php 
                ...
                <tr>
                  <td></td>
                  <td><?php echo $registronc['referencias'];?></td>
                  <td>&nbsp;</td>
                  <td><?php echo $registronc['monto']; ?></td>
                  <td>&nbsp;</td>
                </tr>
                <?php }?>
                </table>
