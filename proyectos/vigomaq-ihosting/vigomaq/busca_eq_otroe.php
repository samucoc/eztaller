...
//fin consulta con limites
		  ...
		  if ($_POST['OK']=='Guardar y Seguir')
		 {
		   ...
		   $codigo       = trim($_POST['txt_cod']);
		        ...
		        echo "<script language=Javascript> location.href=\"otros_gastos_e.php?codigo=".$codigo."\"; </script>";
			} else {
				$link=mensaje();
			}
	//	 }
...
?></td>
      ...
      </form><a href="otros_gastos_e.php" title="Volver página ajustes rentabilidad"><img src="images/volver.png" width="40" height="40" align="right" border="0" /></a></td>
    </tr>
  </table>
  <br />
</div>
