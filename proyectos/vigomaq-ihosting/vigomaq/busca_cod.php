          ...
          <table width="100%" height="30">
            ...
            <tr>
              ...
              <td valign="bottom"><div align="left">
                ...
                <input type="submit" name="OK" id="button" value="Guardar y Seguir" style="background-image:url(images/siguiente.png); width:40px; height:40px" class="formato_boton"  title="Guardar y continuar" align="left" />

                <!--<input name="OK" type="image" class="boton" title="Guardar y continuar" value="Guardar y Seguir"  src="images/siguiente.png" align="left" width="30"  height="30"/>-->
...
if ($_GET["id"]!=""){
   ...
   $codigo = " where cod_equipo like '".trim($txt_codigo) ."%' 
   				...
   				and cod_estado_equipo = 1 

				and id_tipo_equipo <> 39  

				and id_tipo_equipo <> 40  

				and id_tipo_equipo <> 41 ";
...
if(isset($txt_codigo)){
    ...
    echo "<br>Valor filtro: <b>".$txt_codigo."</b>";
		 ...
		 ?>
            ...
            <tr bordercolor="#FFFFFF" bgcolor="#B4B4B4" title="Clic para mostrar contenido" class="CONT" onmouseover="this.style.cursor='hand';this.style.cursor='pointer';" onclick="asignar_valor(this)">
              ...
              <td bgcolor="#FFFFFF"><?php $cantidad = strlen($registro['cod_equipo']); 
				   ...
				   if ($cantidad==8) { echo $registro['cod_equipo'];}?> </td>
...

		 {
		   ...
		   $codigo       = trim($_POST['txt_cod']);
...

			{
				...
				//ingresa el equipo al detalle del arriendo

				mysql_query("insert into equipos_arriendo_temp (`cod_arriendo`, `cod_equipo`, `num_gd`, `cod_reclamo`, `arrendado_desde`, `hora_arr`, 
                                                        `arrendado_hasta`, `hora_devol`, `comentarios`, `estado_equipo_arr`, `inc_accesorio`, `usuario`) 
                                                values ('$cod_arriendo', '$codigo', '0',  '0', '".date("Y-m-d")."',  '".date("H:i:s")."', 
                                                        '".date("Y-m-d")."',  '".date("H:i:s")."','', 'NO DEVUELTO','0','$usuario')",$link) or die(mysql_error()); 
				...
				//$sql = "UPDATE equipo SET cod_estado_equipo='3' where cod_equipo='$codigo'";
	...
	$pag=$pagina-5;
	   ...
	   echo  "<a class='p' href='".$_SERVER["PHP_SELF"]."?nombre=".$_GET['nombre']."&cod_arr=".$_GET['cod_arr']."&pagina=".$pag."'>";
...

    {
...

       {
		  ...
		  echo  "<a class='p' href='".$_SERVER["PHP_SELF"]."?nombre=".$_GET['nombre']."&cod_arr=".$_GET['cod_arr']."&pagina=".$i."'>";
...
?></td>
  ...
  <table width="550" border="0" align="center">
    ...
    <tr>
      ...
      <td><a href="javascript:history.back()" onmouseover="Volver"><img src="images/volver.png" width="40" height="40" align="right" border="0" /></a></td>
