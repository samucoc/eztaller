        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "time": {
                    ...
                    "alertText": "* Hora inválida, por favor utilize el formato HH:MM horas (24-h)"
                },
                "ipv4": {
                ...
                "ajaxUserCall": {
				 ...
				 "gd_salida": {
	                    // Error
	                    "alertText": "* La guia de despacho ya existe en el sistema",
	                    // Disponible
						"alertTextOk": "* Guía de despacho disponible",
						// Cargando
	                    "alertTextLoad": "* Cargando, espere por favor"
	                },
                "ajaxNameCall": {
