        ...
        <td valign="top"><form action="consulta_nc.php" method="post"  name="frmDatos" id="frmDatos">
          <table width="100%" height="544" border="0" align="center">
            ...
            <tr>
              ...
              <td>
                <a href="consulta_nc.php" class="menulink">
                <input name="Limpiar" type="image" title="Limpiar"  width="42" height="42" value="Limpiar"  src="images/clean.png"/>
                </a>
                <a id="vista-previa-nc" href="#" download><img width="42" src="images/gest_fin/factura.png" alt="" border="0" /></a>
                </td>
            </tr>
            <tr>
              <td></td>
...
<script>
    ...
    $("#vista-previa-nc").attr('href','classes/nc/vista-previa-nc.php?num_nc=<?php echo $num_nc?>');
		$("#vista-previa-nc").attr('title','Descargar Nota de Crédito : <?php echo $num_nc?>');
		});    		
</script>
</body>
