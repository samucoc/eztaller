...
class DiagnosticoController extends Controller
{
     ...
     */
    public function visarDiagnosticoFamilia(Beneficiario $beneficiario, $beneficiarioId, $visar)
    {
        $beneficiarioAux = $beneficiario->find($beneficiarioId);

        $diagnostico = $beneficiarioAux->diagnostico;
...
<<<<<<< HEAD
        $values = $request->all()['editedItem'];

        $update_GF = GrupoFamiliar::where('run', $values['run'])
            ->where('beneficiario_id', $beneficiacioId)
            ->update([
...
=======
        ...
        // $update_GF = GrupoFamiliar::where('run', $values['rut'])
        //     ->where('beneficiario_id', $beneficiacioId)
        //     ->update([
        //         'parentesco' => $values['parentesco'],
        //         'componente_id' => $compId,
        ...
        //         'tipo_cama' => $values['tipo_cama']
        //     ]);
>>>>>>> 4f4cb98641269bbc7eef6cfeeb9ac0e673a31020
    }
            ...
            if ($HPHD['error'] == true) {
                ...
                if ($HR['error'] == true) {
                    ...
                    if ($HGF['error'] == true) {
                        ...
                        DiagnosticoFamilia::where('beneficiario_id', $beneficiarioId)->update(['estado_id' => Const_Global_Diag::ENVISACION]);
