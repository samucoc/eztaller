...
$sql = "insert into cargas_vehiculos (carga_veh,carga_pers,carga_monto,carga_fecha,carga_tipo,ce_ncorr)
                    values ('".$carga_veh."','".$carga_pers."','".$carga_monto."','".$carga_fecha."','2','".$id_carga."')";
$res = mysql_query($sql,$conexion);
