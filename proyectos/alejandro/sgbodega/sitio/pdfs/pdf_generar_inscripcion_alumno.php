...
$pdf->SetAutoPageBreak(true,25);  
	...
	$pdf->Ln();
	$pdf->SetXY($x,$y+50);	
	$pdf->Cell(200,5,'CERTIFICADO DE ALUMNO REGULAR',0,0,'C');
	$pdf->Ln();
	$pdf->Ln();
	...
	$pdf->Row(array(utf8_decode('Sr. Apoderado:' )),0);
	$pdf->Row(array(utf8_decode('Junto con saludar, queremos solicitar autorización para que nuestro personal ARCOIRIS, pueda realizar mudas, cambios de ropa y/o limpiar cuando haya defecado u orinado su hijo(a).' )),0);
	$pdf->SetAligns(array('C'));
	$pdf->Row(array(utf8_decode('AUTORIZO' )),0);
	$pdf->SetAligns(array('J'));
	$pdf->Row(array(utf8_decode('Yo,_______________________________________________________________________, Rut __________________, apoderado de ____________________________________________________________________' )),0);
	$pdf->Row(array(utf8_decode('AUTORIZO al personal ARCOIRIS a (marcar con una X)' )),0);
	$pdf->SetWidths(array(30, 170));
	$pdf->SetAligns(array('L','L'));
	$pdf->Ln();
	$pdf->Ln();
	$pdf->Row(array(utf8_decode('_____________' ),utf8_decode('Mudar.' )),0);
	$pdf->Row(array(utf8_decode('_____________' ),utf8_decode('Cambiar ropa.' )),0);
	$pdf->Row(array(utf8_decode('_____________' ),utf8_decode('Limpiar cuando haya defecado.' )),0);
	$pdf->Ln();
	$pdf->Ln();
	$pdf->Ln();
	$pdf->Ln();
	...
	$pdf->SetWidths(array(160));
	$pdf->SetAligns(array('C'));
	$pdf->Row(array(utf8_decode('___________________' )),0);
	$pdf->Row(array(utf8_decode('FIRMA' )),0);
