...
$xajax->setRequestURI("sg_informe_alumnos_beneficio_pie.php");
...
function CargaPagina($data){
	...
	if (mysql_num_rows($res)>0){
		...
		$objResponse->addAssign("divabonos", "innerHTML", $miSmarty->fetch('sg_informe_alumnos_beneficio_pie_list.tpl'));
	}
	else{
...
$miSmarty->display('sg_informe_alumnos_beneficio_pie.tpl');
