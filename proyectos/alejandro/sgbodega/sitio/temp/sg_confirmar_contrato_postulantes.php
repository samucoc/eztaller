...
<HTML>
	...
	<body bgcolor="#ffffff">
		<form id="Form1" name="Form1" method="post" runat="server" action='sg_alumnos_imprimir_contrato.php'>
			<table>
				<tr>
					<td colspan="2" style="text-align: left" class="titulo">Contrato postulante</td>
				</tr>
				<tr>
				...
				<tr>
					<td style="text-align: left" class="titulo">Colegiatura</td>
					<td style="text-align: left">
						<input type="text" name="colegiatura" id="colegiatura" value="<?php echo $colegiatura?>"></td>
				</tr>
			</table>
			<input type="submit" name="btnGuardar" id="btnGuardar" value="Imprimir" <?php if($rut_apo=='0'){?> disabled='disabled' <?php } ?>>
		</form>
	</body>
</HTML>