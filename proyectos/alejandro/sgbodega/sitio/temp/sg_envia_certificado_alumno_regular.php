...
$xajax->setRequestURI("sg_envia_certificado_alumno_regular.php");
...
function Grabar($data){
    ...
    $email						=		$data['email']    ;
   	...
   	$objResponse->addScript("showPopWin('pdfs/pdf_enviar_certificado_alumno_regular.php?email=$email&alumno=$alumno&observacion=$observacion', 'Imprime PDF', 800, 600, null);");
...
$miSmarty->display('sg_envia_certificado_alumno_regular.tpl');
