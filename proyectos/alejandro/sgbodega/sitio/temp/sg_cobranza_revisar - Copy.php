...
$xajax->setRequestURI("sg_cobranza_revisar.php");
...
function LlamaMantenedorVxC($data){
	...
	$_SESSION["alycar_pagina_volver"]	=   'sg_cobranza_revisar.php';
...
function CargaListado($data){
	...
	$sql_ve = "select  
				*
				...
				where
				NumeroRutAlumno = '".$alumno."' and FechaVencimiento between '".$anio."-1-1' and '".$anio."-12-31' ";
	...
	if (mysql_num_rows($res_ve) > 0){
		...
		$objResponse->addAssign("divabonos", "innerHTML", $miSmarty->fetch('sg_cobranza_revisar_list.tpl'));
...
$miSmarty->display('sg_cobranza_revisar.tpl');
