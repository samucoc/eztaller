...
$xajax->setRequestURI("sg_informe_resumen_matriculas.php");
...
function Grabar($data){
	...
	$miSmarty->assign('anio_siguiente',$anio_siguiente);
			...
			$objResponse->addAssign("divresultado", "innerHTML", $miSmarty->fetch('sg_informe_resumen_matriculas_list.tpl'));
