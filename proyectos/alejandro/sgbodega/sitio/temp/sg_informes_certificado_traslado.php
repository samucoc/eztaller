...
$xajax->setRequestURI("sg_informes_certificado_traslado.php");
...
function Grabar($data){
	...
	if ($flag=='0000-00-00'){
		$objResponse->addAssign("divabonos", "innerHTML", $miSmarty->fetch('sg_informes_certificado_traslado_list.tpl'));	
...
function GenerarPDF($data){
	...
	$objResponse->addScript("showPopWin('pdfs/pdf_generar_certificado_traslado_alumno.php?alumno=$alumno&observacion=$observacion&certificados=$certs', 'Imprime PDF', 1000, 700, null);");
...
function EnivarPDF($data){
	...
	$objResponse->addScript("showPopWin('sg_envia_certificado_traslado_alumno.php?alumno=$alumno&observacion=$observacion', 'Enviar PDF', 600, 200, null);");
...
$miSmarty->display('sg_informes_certificado_traslado.tpl');
