...
$xajax->setRequestURI("sg_informes_alumnos_dos_semestral_notas.php");
...
function ImprimePDF($data,$rut_alumno,$semestre){
	...
	$objResponse->addScript("showPopWin('pdfs/pdf_informe_alumnos_dos_semestral_notas.php?rut=$rut_alumno&semestre=$semestre', 'Imprime PDF', 800, 600, null);");
...
function EnviarPDF($data,$rut_alumno,$semestre){
	...
	$objResponse->addScript("showPopWin('pdfs/pdf_enviar_informe_alumnos_dos_semestral_notas.php?rut=$rut_alumno&semestre=$semestre', 'Imprime PDF', 800, 600, null);");
...
function ImprimePDFCurso($data){
	...
	$objResponse->addScript("showPopWin('pdfs/pdf_informe_alumnos_dos_semestral_notas_todos.php?curso=$curso&semestre=$semestre', 'Imprime PDF', 800, 600, null);");
...
function EnviarPDFCurso($data){
	...
	$objResponse->addScript("showPopWin('pdfs/pdf_enviar_informe_alumnos_dos_semestral_notas_todos.php?curso=$curso&semestre=$semestre', 'Imprime PDF', 800, 600, null);");
...
$miSmarty->display('sg_informes_alumnos_dos_semestral_notas.tpl');
