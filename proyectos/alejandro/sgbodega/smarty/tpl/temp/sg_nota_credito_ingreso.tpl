						...
						<form id="Form1" name="Form1" method="post" runat="server">
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%"><label class="form-titulo">&nbsp;&nbsp;Ingreso de Nota de Credito</label></td>
								</tr>
							</table>
							<br>
							<table class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
							  <tr align="left">
							    ...
							    <td class="tabla-alycar-texto" style="width: 20%"><input name="OBLIempresa" type="text" id="OBLIempresa" value="{$nombre_empresa}" size="50"/>
									<input type="hidden" id="nombre_empresa" name="nombre_empresa"  value="{$nombre_empresa}"/>
									<input type="hidden" id="rut_empresa" name="rut_empresa"  value="{$empresa}"/></td>
						      </tr>
							  <tr align="left">
								...
								<tr align="left">
								  <td class="tabla-alycar-label" style="width: 15%">Nro Nota Credito: </td>
								  <td class="tabla-alycar-texto" style="width: 15%"><input id="OBLI_nc" name="OBLI_nc"  size="50" value="" /></td>
							  </tr>
								<tr align="left">
								  <td class="tabla-alycar-label" style="width: 15%">Nro Factura Asociada: </td>
								  <td class="tabla-alycar-texto" style="width: 15%"><input id="OBLIboleta" name="OBLIboleta"  size="50" value="{$nro_factura}" /></td>
							  </tr>
								<tr align="left">
