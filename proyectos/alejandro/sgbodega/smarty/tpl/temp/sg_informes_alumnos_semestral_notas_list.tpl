<div id='pivot'>
    ...
    <tr>
        ...
        {section name=registrosRP loop=$arrRegistrosMaximo}
		   	<td class="grilla-tab-fila-titulo-pequenio" align="center">
				N-{$arrRegistrosMaximo[registrosRP].nro_nota}
            </td>
        {/section}
        <td class="grilla-tab-fila-titulo-pequenio" align="center">
				Promedio
        ...
        <tr onmouseover='this.style.background="#FFFF88"' onmouseout='this.style.background="white"'>
            <td class='grilla-tab-fila-campo-pequenio' align='left'>
                ...
                {section name=registrosDetalle loop=$arrRegistrosDetalle}
       	            {if ($arrRegistros[registros].asignatura == $arrRegistrosDetalle[registrosDetalle].CodigoRamo)}
                        <td class='grilla-tab-fila-campo-pequenio' align='center' >
