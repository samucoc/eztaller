							...
							<table class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left">
								  ...
								  <td class="tabla-alycar-texto" style="width: 20%">
                                  		<input type="text" name="txtFecha1" id="txtFecha1" value='{"-1 month"|date_format:"%d/%m/%Y"}'></input> 
                                  		al <input type="text" name="txtFecha2" id="txtFecha2" value='{$smarty.now|date_format:"%d/%m/%Y"}'></input>
                                  </td>
							  	</tr>
								<tr align="left">
