												...
												{if ($arrRegistrosDet[registrosDet].mhij_contr=='fancybox')}
						                            <a href='{$arrRegistrosDet[registrosDet].mhij_link}' class='menu_link fancybox.iframe'>{$arrRegistrosDet[registrosDet].mhij_desc}</a>
						                           	{section name=registrosDet_1 loop=$arrRegistrosDet_1}
					                					{if ($arrRegistros[registros].menu_ncorr==$arrRegistrosDet_1[registrosDet_1].menu_ncorr)}
					                						<li>
															{if ($arrRegistrosDet_1[registrosDet_1].mhij_contr=='fancybox')}
									                            <a href='{$arrRegistrosDet_1[registrosDet_1].mhij_link}' class='menu_link fancybox.iframe'>{$arrRegistrosDet_1[registrosDet_1].mhij_desc}</a>
									                        {else}
