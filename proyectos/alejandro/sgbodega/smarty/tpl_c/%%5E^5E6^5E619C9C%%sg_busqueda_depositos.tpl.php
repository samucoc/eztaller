<?php /* Smarty version 2.6.18, created on 2012-02-08 11:04:06
         compiled from sg_busqueda_depositos.tpl */ ?>
						...
						<form id="Form1" name="Form1" method="post" runat="server">
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%"><label class="form-titulo">&nbsp;&nbsp; Revisión de Depósitos</label></td>
								</tr>
							</table>
							<br>
							<table class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left">
									...
									<td class="tabla-alycar-texto" style="width: 35%">
										<SELECT id="OBLIcboEmpresa" name="OBLIcboEmpresa" style="width: 100%" onKeyPress="return SoloNumeros(this, event, 0)" onchange="xajax_CargaSectores(xajax.getFormValues('Form1')), xajax_CargaCobradores(xajax.getFormValues('Form1'))"></SELECT>
									</td>	
