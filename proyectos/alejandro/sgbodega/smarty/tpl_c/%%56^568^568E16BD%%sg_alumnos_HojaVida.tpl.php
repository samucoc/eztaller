<?php /* Smarty version 2.6.18, created on 2019-05-08 10:34:14
         compiled from sg_alumnos_HojaVida.tpl */ ?>
							...
							<table class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left">
                                    	<td class="tabla-alycar-texto" colspan="2">
											<a href="#" onclick="location.href='sg_mant_alumnos.php?rut=<?php echo $this->_tpl_vars['rut']; ?>
&readonly=<?php echo $this->_tpl_vars['readonly']; ?>
'">
												<img src='../images/gest_esc/ficha-alumno.png' title='Fichas Alumnos' width="32"/>
											</a>
											<a href="#" onclick="location.href='sg_alumnos_notas.php?rut=<?php echo $this->_tpl_vars['rut']; ?>
&readonly=<?php echo $this->_tpl_vars['readonly']; ?>
'">
												<img src='../images/gest_esc/promedio.png' title='Notas' width="32"/>
											</a>
											<a href="#" onclick="location.href='sg_alumnos_HojaVida.php?rut=<?php echo $this->_tpl_vars['rut']; ?>
&readonly=<?php echo $this->_tpl_vars['readonly']; ?>
'">
												<img src='../images/gest_fin/respaldos.png' title='Hoja de vida' width="32"/>
											</a>
											<a href="#" onclick="location.href='sg_alumnos_Asistencia.php?rut=<?php echo $this->_tpl_vars['rut']; ?>
&readonly=<?php echo $this->_tpl_vars['readonly']; ?>
'">
												<img src='../images/fin_comp/bitacora.png' title='Asistencia' width="32"/>
											</a>
											<a href="#" onclick="location.href='sg_alumnos_Apoderado.php?rut=<?php echo $this->_tpl_vars['rut']; ?>
&readonly=<?php echo $this->_tpl_vars['readonly']; ?>
'">
												<img src='../images/gest_esc/ficha-apoderado.png' title='Apoderados' width="32"/>
											</a>
											<a href="#" id="contenedor" onclick="location.href='sg_mant_tablas.php?tbl=BitacorasAcademicas&rut=<?php echo $this->_tpl_vars['rut']; ?>
&readonly=<?php echo $this->_tpl_vars['readonly']; ?>
'" title="Bit&aacute;cora Acad&eacute;mica" >
											...
											<a href="#" id="contenedor" onclick="location.href='sg_mant_tablas.php?tbl=Entrevistas&rut=<?php echo $this->_tpl_vars['rut']; ?>
&readonly=<?php echo $this->_tpl_vars['readonly']; ?>
