<?php
/* Smarty version 3.1.33, created on 2019-09-27 00:42:16
  from '/home/dominios/gescol.cl/web/80/www.gescol.cl/public_html/nmva/sgadministrativo/smarty/tpl/sg_notas_ingresar_cm.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5d8d8518de63e8_24604593',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '600350a98d19557f81e7ab3d8a29366e0743a30f' => 
    array (
      0 => '/home/dominios/gescol.cl/web/80/www.gescol.cl/public_html/nmva/sgadministrativo/smarty/tpl/sg_notas_ingresar_cm.tpl',
      1 => 1569555673,
      2 => 'file',
    ),
  ),
...
function content_5d8d8518de63e8_24604593 (Smarty_Internal_Template $_smarty_tpl) {
...
>
 ...
 type="text/javascript" > 
            ...
            function copiarValor(){
				var elementos = document.getElementsByClassName("nota");
				var nota  = elementos[0].value;
				for (x=1;x<elementos.length;x++)
				    elementos[x].value = nota;
            	}
					...
					<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%">
                                    	<label class="form-titulo">&nbsp;&nbsp;Ingresar Nota</label>
                                        <input type="hidden" name="anio" id="anio" value="<?php echo $_smarty_tpl->tpl_vars['anio']->value;?>
"/>
                                        <input type="hidden" name="semestre" id="semestre" value="<?php echo $_smarty_tpl->tpl_vars['semestre']->value;?>
"/>
                                        <input type="hidden" name="curso" id="curso" value="<?php echo $_smarty_tpl->tpl_vars['curso']->value;?>
"/>
                                        <input type="hidden" name="asignatura" id="asignatura" value="<?php echo $_smarty_tpl->tpl_vars['asignatura']->value;?>
"/>
                                        <input type="hidden" name="prueba" id="prueba" value="<?php echo $_smarty_tpl->tpl_vars['prueba']->value;?>
"/>
                                        <input type="hidden" name="nro_nota" id="nro_nota" value="<?php echo $_smarty_tpl->tpl_vars['nro_nota']->value;?>
"/>
                                    </td>
								</tr>
							</table>
							...
							<table class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left">
								  ...
								  <td class="tabla-alycar-texto" style="width: 20%">
                                  	<input type="text" id="txt_anio" name="txt_anio" readonly="readonly" size="100" width="100"	/>
                                  </td>
							  	</tr> 
								<tr align="left">
								  <td class="tabla-alycar-label" style="width: 15%">Semestre:</td>
								  <td class="tabla-alycar-texto" style="width: 20%">
                                  	<input type="text" id="txt_semestre" name="txt_semestre" readonly="readonly" size="100" width="100"/>
                                  </td>
							  	</tr>
								<tr align="left">
								  <td class="tabla-alycar-label" style="width: 15%">Curso:</td>
								  <td class="tabla-alycar-texto" style="width: 20%">
                                  	<input type="text" id="txt_curso" name="txt_curso" readonly="readonly" size="100" width="100"/>
                                  </td>
							  	</tr>
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 15%">Asignatura:</td>
									<td class="tabla-alycar-texto" style="width: 85%">
										<input type="text" name="txt_asignatura" id="txt_asignatura" readonly="readonly" size="100" width="100"/>
									</td>	
								</tr>
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 15%">Prueba:</td>
									<td class="tabla-alycar-texto" style="width: 85%">
										<input type="text" name="txt_prueba" id="txt_prueba" readonly="readonly" size="100" width="100"/>
									</td>	
								</tr>
								<tr align="left">
								...
								<tr align="left">
									<td colspan="2" class="tabla-alycar-fila-botones">
										<a href="#" id="btnEnviar" onclick="document.getElementById('btnEnviar').style.display = 'none'; xajax_Grabar(xajax.getFormValues('Form1'));">
