<?php /* Smarty version 2.6.18, created on 2017-09-01 22:18:05
         compiled from sg_envia_asistencia_por_alumno.tpl */ ?>
					...
					<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%">
                                    	<label class="form-titulo">Enviar Asistencia por Alumno por Correo</label>
                                    	</label>
                                    </td>
								</tr>
							</table>
								...
								<tr align="left">
									<td colspan="2" class="tabla-alycar-fila-botones">
										<a href="#" onclick="xajax_Grabar(xajax.getFormValues('Form1'));">
											<img src='../images/basicos/email2.png' title='Enviar Asistencia por Alumno por Correo' width="32"/>
										</a>
										</td>
								</tr>
