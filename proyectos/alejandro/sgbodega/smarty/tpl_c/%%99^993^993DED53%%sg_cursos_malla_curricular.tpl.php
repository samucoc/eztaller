<?php /* Smarty version 2.6.18, created on 2016-06-01 21:05:20
         compiled from sg_cursos_malla_curricular.tpl */ ?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<!--<body style="background:#ffffff;"> -->
		<form id="Form1" name="Form1" method="post" runat="server">
			<input type="hidden" id="curso" name="curso" value=<?php echo $this->_tpl_vars['curso']; ?>
>
