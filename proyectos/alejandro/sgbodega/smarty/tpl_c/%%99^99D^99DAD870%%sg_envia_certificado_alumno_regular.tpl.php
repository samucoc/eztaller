<?php /* Smarty version 2.6.18, created on 2017-04-07 21:12:35
         compiled from sg_envia_certificado_alumno_regular.tpl */ ?>
							...
							<table class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left">
								  ...
								  <td class="tabla-alycar-texto" style="width: 20%">
                                  	...
                                  	<input type="hidden" id="alumno" name="alumno" value="<?php echo $this->_tpl_vars['alumno']; ?>
"></input>
                                  	<input type="hidden" id="observacion" name="observacion" value="<?php echo $this->_tpl_vars['observacion']; ?>
"></input>
                                  </td>
							  	</tr> 
								<tr align="left">
