<?php /* Smarty version 2.6.18, created on 2010-08-27 20:53:25
         compiled from sg_listado_archivos_subidos.tpl */ ?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<HEAD>
		...
		<title> Listado de Archivos Subidos </title>
						...
						<td>
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%"><label class="form-titulo">&nbsp;&nbsp; Listado de Archivos Subidos</label></td>
								</tr>
							</table>
							<table border="0" class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 20%">Código Asignado:</td>
									<td class="tabla-alycar-texto" style="width: 80%"><?php echo $this->_tpl_vars['SINIESTRO']; ?>

										<INPUT type="hidden" id="txtCodigo" name="txtCodigo" value='<?php echo $this->_tpl_vars['SINIESTRO']; ?>
