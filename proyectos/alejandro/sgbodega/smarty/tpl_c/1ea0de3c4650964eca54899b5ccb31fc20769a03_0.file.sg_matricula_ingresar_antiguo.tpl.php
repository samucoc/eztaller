<?php
/* Smarty version 3.1.33, created on 2019-10-08 19:04:28
  from '/home/dominios/gescol.cl/web/80/www.gescol.cl/public_html/nmva/sgadministrativo/smarty/tpl/sg_matricula_ingresar_antiguo.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5d9d07ec1591a5_53466110',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '1ea0de3c4650964eca54899b5ccb31fc20769a03' => 
    array (
      0 => '/home/dominios/gescol.cl/web/80/www.gescol.cl/public_html/nmva/sgadministrativo/smarty/tpl/sg_matricula_ingresar_antiguo.tpl',
      1 => 1570572263,
      2 => 'file',
    ),
  ),
...
function content_5d9d07ec1591a5_53466110 (Smarty_Internal_Template $_smarty_tpl) {
                           ...
                           $.datepicker.setDefaults($.datepicker.regional['es']);                            
                            $('#txtFecha1,#txtFecha2').datepicker({
							 ...
							 $("#OBLI-cboAlumno").autocomplete({
                                source : 'busquedas/busqueda_alumnos_antiguos.php',
...
>
 ...
 type="text/javascript" > 
                        function verificaValor(temp){
                            if (temp==''){
                                document.getElementById('OBLIRutAlumno').value="";
                                }
                            }
					...
					<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%"><label class="form-titulo">&nbsp;&nbsp;Autoriza Matriculas Alumnos Antiguos</label></td>
								</tr>
							</table>
							<br>
							<table class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								...
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 15%">Nombre Alumno:</td>
									<td class="tabla-alycar-texto" style="width: 85%">
										<input type="text" name="OBLI-cboAlumno" id="OBLI-cboAlumno" size="65" widht="65" onblur="verificaValor(this.value)" />
