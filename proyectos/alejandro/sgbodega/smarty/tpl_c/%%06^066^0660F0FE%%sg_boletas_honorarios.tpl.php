<?php /* Smarty version 2.6.18, created on 2013-04-01 16:46:38
         compiled from sg_boletas_honorarios.tpl */ ?>
			...
			$(document).ready(function() { 
                           ...
                           $.datepicker.setDefaults($.datepicker.regional[\'es\']);                            
							...
							$("#OBLIcliente").autocomplete({
                                source : \'busquedas/busqueda_prestador.php\', 
                           ...
                           $("#OBLIempresa").autocomplete({
							...
							$("#OBLItxtMontoIngresar").blur(function(){
                                    ...
                                    var iva = parseInt(valor1)*0.1;
									document.getElementById(\'iva\').value = Math.round(iva);
									var total = parseInt(valor1)*0.9;
						...
						<form id="Form1" name="Form1" method="post" runat="server">
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%"><label class="form-titulo">&nbsp;&nbsp;Ingreso de Boletas de Honorarios</label></td>
								</tr>
							</table>
							<br>
...
"/>
                                    <input type="hidden" id="empresa" name="empresa"  value="<?php echo $this->_tpl_vars['empresa']; ?>
"/>
                                </td>
						      </tr>
							  <tr align="left">
							    <td class="tabla-alycar-label" style="width: 15%">Fecha:</td>
							    <td class="tabla-alycar-texto" style="width: 20%"><input type="text" id="OBLI-txtFecha" name="OBLI-txtFecha" onkeypress="return SoloNumeros(this, event, 0)"  /></td>
						      </tr>
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 15%">Rut Prestador:</td>
									<td class="tabla-alycar-texto" style="width: 20%">
									  	<input name="OBLIcliente" type="text" id="OBLIcliente" size="50"  />
										<input type="hidden" id="rut_cliente" name="rut_cliente"  />
                                        <input type="button" name="mant" id="mant" onclick="" value="Mantenedor Prestadores" class="boton"/>
									</td>	
								</tr>
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 15%">Nro Boleta: </td>
									<td class="tabla-alycar-texto" style="width: 15%">
                                     	<input id="OBLIboleta" name="OBLIboleta"  size="50" /> 
                                                                        </td>	
								</tr>
								<tr align="left">
								  <td class="tabla-alycar-label" style="width: 15%">Bruto:</td>
								  <td class="tabla-alycar-texto" ><input type="text" id="OBLItxtMontoIngresar" name="OBLItxtMontoIngresar"  onkeypress="return SoloNumeros(this, event, 0)"  size="50"/></td>
							  </tr>
								<tr align="left">
								  <td class="tabla-alycar-label" style="width: 15%">Retencion:</td>
								  <td class="tabla-alycar-texto" ><input type="text" id="iva" name="iva"  onkeypress="return SoloNumeros(this, event, 0)" size="50" readonly="readonly" style="text-align:right" value="0"/></td>
							  </tr>
								<tr align="left">
								  <td class="tabla-alycar-label" style="width: 15%">Total:</td>
								  <td class="tabla-alycar-texto" ><input type="text" id="total" name="total"  onkeypress="return SoloNumeros(this, event, 0)"  size="50" readonly="readonly" style="text-align:right" value="0"/></td>
							  </tr>
								<tr align="left">
