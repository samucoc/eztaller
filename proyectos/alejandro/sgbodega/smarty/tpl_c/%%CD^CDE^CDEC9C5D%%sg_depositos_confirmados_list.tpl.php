<?php /* Smarty version 2.6.18, created on 2012-02-09 11:54:22
         compiled from sg_depositos_confirmados_list.tpl */ ?>
...
' readonly>
		...
		<td class='grilla-tab-fila-campo-pequenio' align='left'><?php echo $this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['usuario_conf']; ?>
</td>
		<td class='grilla-tab-fila-campo-pequenio' align='left'><?php echo $this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['fecha_conf']; ?>
</td>
		<td class='grilla-tab-fila-campo-pequenio' align='center'>
			<input type='button' name='btnOK' value='Anular Confirmación' class='botondestaca' onclick="xajax_Anular('<?php echo $this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['ncorr']; ?>
');">
		</td>
