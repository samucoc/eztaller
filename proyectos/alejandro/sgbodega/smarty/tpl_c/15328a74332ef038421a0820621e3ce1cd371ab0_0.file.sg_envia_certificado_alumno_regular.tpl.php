<?php
/* Smarty version 3.1.33, created on 2020-03-30 15:59:00
  from '/home/dominios/gescol.cl/web/80/www.gescol.cl/public_html/arcoiris/sgadministrativo/smarty/tpl/sg_envia_certificado_alumno_regular.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5e824174b1eef4_54004160',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '15328a74332ef038421a0820621e3ce1cd371ab0' => 
    array (
      0 => '/home/dominios/gescol.cl/web/80/www.gescol.cl/public_html/arcoiris/sgadministrativo/smarty/tpl/sg_envia_certificado_alumno_regular.tpl',
      1 => 1579573426,
      2 => 'file',
    ),
  ),
...
function content_5e824174b1eef4_54004160 (Smarty_Internal_Template $_smarty_tpl) {
					...
					<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%">
                                    	<label class="form-titulo">Enviar Certificado Alumno Regular por Correo</label>
                                    	</label>
                                    </td>
								</tr>
							</table>
							...
							<table class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left">
								  <td class="tabla-alycar-label" style="width: 15%">Email Apoderado:</td>
								  <td class="tabla-alycar-texto" style="width: 20%">
                                  	<input type="text" id="email" name="email" size="50" width="50"/>
                                  	<input type="hidden" id="alumno" name="alumno" value="<?php echo $_smarty_tpl->tpl_vars['alumno']->value;?>
"></input>
                                  	<input type="hidden" id="observacion" name="observacion" value="<?php echo $_smarty_tpl->tpl_vars['observacion']->value;?>
"></input>
                                  </td>
							  	</tr> 
								<tr align="left">
									<td colspan="2" class="tabla-alycar-fila-botones">
										<a href="#" onclick="xajax_Grabar(xajax.getFormValues('Form1'));">
											<img src='../images/basicos/email2.png' title='Enviar Certificado Alumno Regular por Correo' width="32"/>
										</a>
										</td>
								</tr>
