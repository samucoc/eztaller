<?php
/* Smarty version 3.1.33, created on 2019-09-09 15:56:08
  from '/home/dominios/gescol.cl/web/80/www.gescol.cl/public_html/nmva/sgadministrativo/smarty/tpl/sg_matricula_actualizar_antiguo.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5d76a048dd4036_82469067',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b6405e0dae513042f405c959472a3b67886c5003' => 
    array (
      0 => '/home/dominios/gescol.cl/web/80/www.gescol.cl/public_html/nmva/sgadministrativo/smarty/tpl/sg_matricula_actualizar_antiguo.tpl',
      1 => 1563312331,
      2 => 'file',
    ),
  ),
...
function content_5d76a048dd4036_82469067 (Smarty_Internal_Template $_smarty_tpl) {
					...
					<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%">
                                    	<label class="form-titulo">Matricular Alumno Antiguo</label>
...
"/>
							...
							<table class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left">
								  <td class="tabla-alycar-label" style="width: 15%">Curso Antiguo:</td>
								  <td class="tabla-alycar-texto" style="width: 20%">
                                  	<input type="text" id="txt_curso" name="txt_curso" readonly="readonly" size="50" width="50"/>
                                  </td>
							  	</tr>
								<tr align="left">
								  <td class="tabla-alycar-label" style="width: 15%">Curso Nuevo:</td>
								  <td class="tabla-alycar-texto" style="width: 20%">
                                  	<!--<select id="cboCurso" name="cboCurso">
                                    </select>-->
                                    <input type="hidden" id="cboCurso" name="cboCurso" />
                                    <input type="text" name="nombre_curso" id="nombre_curso" readonly="readonly" size="50" width="50"/>
                                  </td>
							  	</tr>
								<tr align="left">
                                ...
                                <tr align="left">
									<td class="tabla-alycar-label" style="width: 15%">Autoriza / Rechaza:</td>
									<td class="tabla-alycar-texto" style="width: 85%">
								...
								<tr align="left">
									<td colspan="2" class="tabla-alycar-fila-botones">
										<a href="#" onclick="xajax_Grabar(xajax.getFormValues('Form1'));" id="grabar_alumno_antiguo" name="grabar_alumno_antiguo">
