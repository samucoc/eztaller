<?php /* Smarty version 2.6.18, created on 2017-05-30 21:13:35
         compiled from sg_informe_consulta_calendario_planificacion.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'sg_informe_consulta_calendario_planificacion.tpl', 192, false),)), $this); ?>
							...
							<table class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left">
								  ...
								  <td class="tabla-alycar-texto" style="width: 20%">
                                  		<input type="text" name="txtFecha1" id="txtFecha1" value='<?php echo ((is_array($_tmp="-1 month")) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d/%m/%Y") : smarty_modifier_date_format($_tmp, "%d/%m/%Y")); ?>
'></input> 
                                  		al <input type="text" name="txtFecha2" id="txtFecha2" value='<?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d/%m/%Y") : smarty_modifier_date_format($_tmp, "%d/%m/%Y")); ?>
'></input>
                                  </td>
							  	</tr>
								<tr align="left">
