...
$pdf->SetAutoPageBreak(true,25);  
	...
	$path = 'pdfs/'.$fecha.'_'.$rut."_aviso_cobranza.pdf";  	
        ...
        $correo->Subject = utf8_decode('Sistema Gestión Escolar - '.$nombre_establecimiento.' - Aviso de Cobranza Pre-Judicial');         
		...
		$body .= "<p>Adjunto envío aviso de cobranza pre-judicial año ".$anio.".</p>";
