...
function CargaListado($data){
	...
	$select_nombre_alumno = "select concat(PaternoAlumno, ' ', MaternoAlumno, ' ', NombresAlumno) as nombre_alumno,
									...
									TiposApoderados.nombre as nombre
							from gescolcl_arcoiris_administracion.Apoderados
								inner join gescolcl_arcoiris_administracion.Apoderados_tienen_Alumnos
								...
								inner join gescolcl_arcoiris_administracion.alumnos
									on alumnos.NumeroRutAlumno = Apoderados_tienen_Alumnos.RutAlumno
								inner join gescolcl_arcoiris_administracion.TiposApoderados
