...
$xajax->setRequestURI("sg_enviar_cobranza_alumnos_morosos.php");
...
function Grabar($data){
    ...
    $email					 =		 $data['email']    ;
   	...
   	$objResponse->addScript("showPopWin('pdf_cobranza_alumnos_morosos.php?rut=$rut&fecha_buscar=$fecha_buscar&email=$email', 'Enviar PDF', 800, 600, null);");
