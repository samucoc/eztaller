...
$xajax->setRequestURI("sg_descuentos_faltantes.php");
...
function CargaListado($data){
	...
	if ($dias >= 0){
		...
		$tbl 	.=	"<tr>";
		$tbl 	.=	"<td colspan='12' class='grilla-tab-fila-titulo-rev' align='center'><b>Listado de Sobrantes y Faltantes al $fecha</b></td>";
		$tbl 	.=	"</tr>";
		$tbl 	.=	"<tr>";
		...
		$tbl 	.=	"<td class='grilla-tab-fila-titulo-rev' align='center'><b>Sobrante Cobrador</b></td>";
		$tbl 	.=	"<td class='grilla-tab-fila-titulo-rev' align='center'><b>Faltante Cobrador</b></td>";
		$tbl 	.=	"<td class='grilla-tab-fila-titulo-rev' align='center'><b>Sobrante Supervisor</b></td>";
		$tbl 	.=	"<td class='grilla-tab-fila-titulo-rev' align='center'><b>Faltante Supervisor</b></td>";
		$tbl 	.=	"</tr>";
		...
		while ($i <= $dias) {
			...
			*/
			...
			$sql_dep = "select sum(depo_monto) as total_deposito from depositos
						where 
			...
			$sql_pve = "select sum(pven_monto) as total_pie_vendedor from pie_vendedor
						where 
						empe_rut = '".$empe_rut."' and
						sect_cod = '".$sect_cod."' and
						co_codigo = '".$co_codigo."' and
			...
			$sql_scli = "select sum(scli_monto) as total_sob_cliente from sobrante_cliente
						where 
						empe_rut = '".$empe_rut."' and
						sect_cod = '".$sect_cod."' and
						co_codigo = '".$co_codigo."' and
			...
			$sql_socu = "select sum(a.scas_monto) as total_sob_ocupado from 
						sobrante_cliente_asignacion a, sobrante_cliente b
						where 
			...
			*/
			...
			$tbl 	.=	"<td class='grilla-tab-fila-campo-rev' align='left'>".$co_nombre."</td>";
			$tbl 	.=	"<td class='grilla-tab-fila-campo-rev' align='left'>".$sp_nombre."</td>";
			$tbl 	.=	"<td class='grilla-tab-fila-campo-rev' align='center'>".$fecha1esp."</td>";
			$tbl 	.=	"<td class='grilla-tab-fila-campo-rev' align='right'>".number_format($sobrante, 0, ',', '.')."</td>";
			$tbl 	.=	"<td class='grilla-tab-fila-campo-rev' align='right'>".number_format($faltante, 0, ',', '.')."</td>";
			$tbl 	.=	"<td class='grilla-tab-fila-campo-rev' align='right'>".number_format($sobrante_sup, 0, ',', '.')."</td>";
			$tbl 	.=	"<td class='grilla-tab-fila-campo-rev' align='right'>".number_format($faltante_sup, 0, ',', '.')."</td>";
			$tbl 	.=	"</tr>";
		...
		$tbl 	.=	"<tr>";
		$tbl 	.=	"<td colspan='7' class='grilla-tab-fila-campo-rev' align='right'><b>Totales</b></td>";
		$tbl 	.=	"<td class='grilla-tab-fila-campo-rev' align='right'><b>".number_format($total_sobrante + $total_sobrante_sup , 0, ',', '.')."</b></td>";
		$tbl 	.=	"<td class='grilla-tab-fila-campo-rev' align='right'><b>".number_format($total_faltante + $total_faltante_sup, 0, ',', '.')."</b></td>";
		$tbl 	.=	"</tr>";
		
		$tbl 	.=	"<tr>";
		$tbl 	.=	"<td colspan='7' class='grilla-tab-fila-campo' align='right'><b>".$texto_total_sup."</b></td>";
		$tbl 	.=	"<td colspan='2' class='grilla-tab-fila-campo' align='center'><b>".number_format($resultado_total_sup, 0, ',', '.')."</b></td>";
		$tbl 	.=	"</tr>";
		
		$tbl 	.=	"<tr>";
		$tbl 	.=	"<td colspan='7' class='grilla-tab-fila-campo' align='right'><b>".$texto_total."</b></td>";
		$tbl 	.=	"<td colspan='2' class='grilla-tab-fila-campo' align='center'><b>".number_format($resultado_total, 0, ',', '.')."</b></td>";
		$tbl 	.=	"</tr>";
...
$miSmarty->display('sg_descuentos_faltantes.tpl');
