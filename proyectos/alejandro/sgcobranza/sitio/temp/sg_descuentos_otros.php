...
$xajax->setRequestURI("sg_descuentos_otros.php");
...
function Grabar($data){
	...
	$sql = "insert into otros_descuentos (  tipo, `trabajador`, `monto`, `fecha`, `usuario`, `fecha_digitacion`, `estado` ) 
			values ( '$tipo', '$trabajador','$monto','$fecha','$usuario','$fecha_digitacion','$estado' )";
			
	$res = mysql_query($sql,$conexion) or die(mysql_error());
	$objResponse->addAlert("Otro descuento ingresado correctamente.");
...
$miSmarty->display('sg_descuentos_otros.tpl');
