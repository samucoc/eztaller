...
$xajax->setRequestURI("sg_informe_descuentos_prestamos_caja.php");
...
function Grabar($data){
	...
	if (($OBLItxtFecha1 != '') && ($OBLItxtFecha2 != '') ){
		...
		$and .= " and prestamos_caja.fecha between '".$OBLItxtFecha1."' and '".$OBLItxtFecha2."' ";
	}
	...
	if (mysql_num_rows($res_pd) > 0){
		...
		$objResponse->addAssign("divabonos", "innerHTML", $miSmarty->fetch('sg_informe_descuentos_prestamos_caja_list.tpl'));
...
$miSmarty->display('sg_informe_descuentos_prestamos_caja.tpl');
