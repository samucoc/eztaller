...
$xajax->setRequestURI("sg_descuentos_control_vendedor.php");
...
function Grabar($data){
	...
	$sql = "insert into control_vendedor (  `trabajador`, `monto`, `fecha`, `usuario`, `fecha_digitacion`, `estado` ) 
			values ( '$trabajador','$monto','$fecha','$usuario','$fecha_digitacion','$estado' )";
			
	$res = mysql_query($sql,$conexion) or die(mysql_error());
	$objResponse->addAlert("Control vendedor ingresado correctamente.");
...
$miSmarty->display('sg_descuentos_control_vendedor.tpl');
