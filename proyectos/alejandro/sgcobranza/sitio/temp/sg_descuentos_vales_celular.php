...
$xajax->setRequestURI("sg_descuentos_vales_celular.php");
...
function Grabar($data){
	...
	$sql = "insert into vales_celular (  `trabajador`, `monto`, `fecha`, `usuario`, `fecha_digitacion`, `estado` ) 
			values ( '$trabajador','$monto','$fecha','$usuario','$fecha_digitacion','$estado' )";
			
	$res = mysql_query($sql,$conexion) or die(mysql_error());
	$objResponse->addAlert("Vales por celular ingresado correctamente.");
...
$miSmarty->display('sg_descuentos_vales_celular.tpl');
