...
$xajax->setRequestURI("sg_informe_descuentos_desc_folios.php");
...
function Grabar($data){
	...
	if (($OBLItxtFecha1 != '') && ($OBLItxtFecha2 != '') ){
		...
		$and .= " and desc_folios.fecha between '".$OBLItxtFecha1."' and '".$OBLItxtFecha2."' ";
	}
	...
	if (mysql_num_rows($res_pd) > 0){
		...
		$objResponse->addAssign("divabonos", "innerHTML", $miSmarty->fetch('sg_informe_descuentos_desc_folios_list.tpl'));
...
$miSmarty->display('sg_informe_descuentos_desc_folios.tpl');
