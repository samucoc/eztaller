...
$xajax->setRequestURI("sg_cobranza_grafico_pagos.php");
...
function Grabar($data){
	...
	$objResponse->addScript("showPopWin('sg_cobranza_visualizador_grafico_pagos.php?anio=".$anio."&mes=".$mes."', 'Estad&iacute;stica de Recaudaci&oacute;n Mensual', 1200, 650, null);");
...
$miSmarty->display('sg_cobranza_grafico_pagos.tpl');
