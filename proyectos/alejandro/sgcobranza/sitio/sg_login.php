...
function CargaPagina($data){
	...
	$objResponse->addScript("xajax_CargaSelect(xajax.getFormValues('Form1'),'OBLIanio','gescolcl_arcoiris_administracion.Periodos','','','distinct AnoAcademico','AnoAcademico', ' order by AnoAcademico desc')");
...
$sql_ac = "SELECT * FROM gescolcl_arcoiris_administracion.Establecimiento";
$res_ac = mysql_query($sql_ac,$conexion) or die(mysql_error());
$row_ac = mysql_fetch_array($res_ac);

$miSmarty->assign('anio_cursante', $row_ac['PeriodoEstablecimiento']);
