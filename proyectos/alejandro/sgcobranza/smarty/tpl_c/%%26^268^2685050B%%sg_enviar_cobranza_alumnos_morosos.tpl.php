<?php /* Smarty version 2.6.18, created on 2017-07-18 20:46:05
         compiled from sg_enviar_cobranza_alumnos_morosos.tpl */ ?>
					...
					<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%">
                                    	<label class="form-titulo">Enviar Informe Alumnos Morosos - <div id="nombre_alumno" name="nombre_alumno"></div></label>
                                    	</label> 
                                    </td>
								</tr>
							</table>
							...
							<table class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left">
								  ...
								  <td class="tabla-alycar-texto" style="width: 20%">
                                  	...
                                  	<input type="hidden" id="rut" name="rut" value="<?php echo $this->_tpl_vars['rut']; ?>
"></input>
                                  	<input type="hidden" id="fecha_buscar" name="fecha_buscar" value="<?php echo $this->_tpl_vars['fecha_buscar']; ?>
"></input>
                                  	<input type="hidden" id="semestre" name="semestre" value="<?php echo $this->_tpl_vars['semestre']; ?>
"></input>
                                  </td>
							  	</tr> 
								<tr align="left">
									<td colspan="2" class="tabla-alycar-fila-botones">
										<a href="#" onclick="xajax_Grabar(xajax.getFormValues('Form1'));">
											<img src='../../sige/images/basicos/email2.png' title='Enviar Informe Alumno Moroso por Correo' width="32"/>
										</a>
										</td>
								</tr>
