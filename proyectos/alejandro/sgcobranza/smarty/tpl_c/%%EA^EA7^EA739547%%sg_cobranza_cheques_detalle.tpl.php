<?php /* Smarty version 2.6.18, created on 2017-07-28 20:45:42
         compiled from sg_cobranza_cheques_detalle.tpl */ ?>
					...
					<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%">
                                    	<label class="form-titulo">&nbsp;&nbsp;Detalle Cheques</label>
                                    	<input type="hidden" name="cheque_ncorr" id="cheque_ncorr" value="<?php echo $this->_tpl_vars['cheque_ncorr']; ?>
" />
                                    </td>
								</tr>
							</table>
							<br>
							<table class="tabla-alycar"  border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									<td class="tabla-alycar-label" style="width: 15%">Alumno:</td>
								  	<td class="tabla-alycar-texto" style="width: 20%">
                                       	<input type="text" name="alumno" id="alumno" value=""  readonly="readonly" />
                                    </td>
								</tr>
								<tr align="left" valign="middle">
									<td class="tabla-alycar-label" style="width: 15%">Nro Cheque:</td>
								  	<td class="tabla-alycar-texto" style="width: 20%">
                                       	<input type="text" name="NumeroCheque" id="NumeroCheque" value=""/>
                                    </td>
								</tr>
								<tr align="left" valign="middle">
									<td class="tabla-alycar-label" style="width: 15%">Banco:</td>
								  	<td class="tabla-alycar-texto" style="width: 20%">
                                    	<input type="text" name="NombreBanco" id="NombreBanco" value="<?php echo $this->_tpl_vars['banco']; ?>
"/>
                                    	<input type="hidden" name="CodigoBanco" id="CodigoBanco" value="<?php echo $this->_tpl_vars['banco']; ?>
"/>
                                    	
                                    </td>
								</tr>
								<tr align="left" valign="middle">
									<td class="tabla-alycar-label" style="width: 15%">Valor:</td>
								  	<td class="tabla-alycar-texto" style="width: 20%">
                                    	<input type="text" name="ValorCheque" id="ValorCheque" value="<?php echo $this->_tpl_vars['valor']; ?>
"/>
								...
								<tr align="left" valign="middle">
									<td class="tabla-alycar-label" style="width: 15%">Fecha:</td>
								  	<td class="tabla-alycar-texto" style="width: 20%">
                                    	<input type="text" name="FechaCheque" id="FechaCheque" value="<?php echo $this->_tpl_vars['fecha']; ?>
"/>
                                    </td>
								</tr>
								<tr align="left" valign="middle">
									<td class="tabla-alycar-label" style="width: 15%">Estado:</td>
								  	<td class="tabla-alycar-texto" style="width: 20%">
								  		<select name="EstadoCheque" id="EstadoCheque" >
								...
								<tr>
									<td colspan="4" class="tabla-alycar-label" >
								            <a href="#" onclick="xajax_Actualizar(xajax.getFormValues('Form1'));">
								                <img src='../images/basicos/guardar.png' title='Imprimir' width="32"/>
								            </a>
	                                </td>
                            	</tr>
							</table>
