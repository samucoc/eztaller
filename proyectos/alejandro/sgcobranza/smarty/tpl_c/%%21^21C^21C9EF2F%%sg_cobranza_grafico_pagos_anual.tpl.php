<?php /* Smarty version 2.6.18, created on 2018-06-19 20:52:50
         compiled from sg_cobranza_grafico_pagos_anual.tpl */ ?>
					...
					<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%">
                                    	<label class="form-titulo">&nbsp;&nbsp;Compara Estad&iacute;sticas de Recaudaci&oacute;n Anual</label>
							...
							<table class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left">
								  ...
								  <td class="tabla-alycar-texto" style="width: 20%">
                                  	<select id="anio" name="anio[]" multiple style="width: 100px">
                                  	</select>
                                  </td>
							  	</tr> 
								<tr align="left">
									<td colspan="2" class="tabla-alycar-fila-botones">
										<a href="#" onclick="xajax_Grabar(xajax.getFormValues('Form1'));">
											<img src='../images/basicos/buscar.png' title='Generar Estad&iacute;stica de Recaudaci&oacute;n Anual' width="32"/>
										</a>
									</td>
								</tr>
