<?php /* Smarty version 2.6.18, created on 2013-08-29 14:00:13
         compiled from sg_busqueda_tbl.tpl */ ?>
					...
					<tr>
						<td>
							<table border="0" class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<INPUT type="hidden" id="txtTbl" name="txtTbl" value='<?php echo $this->_tpl_vars['TBL']; ?>
'>
								<INPUT type="hidden" id="txttgas_ncorr" name="txttgas_ncorr" value='<?php echo $this->_tpl_vars['TGAS_NCORR']; ?>
'>
