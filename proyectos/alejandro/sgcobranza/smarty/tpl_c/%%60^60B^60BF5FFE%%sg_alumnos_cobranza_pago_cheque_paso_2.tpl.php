<?php /* Smarty version 2.6.18, created on 2016-03-18 20:49:42
         compiled from sg_alumnos_cobranza_pago_cheque_paso_2.tpl */ ?>
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%"><label class="form-titulo">&nbsp;&nbsp;Pagos Alumno</label>
                                      	<input type="hidden" name="boleta_temp" id="boleta_temp" value="<?php echo $this->_tpl_vars['boleta_temp']; ?>
"/>
					...
					<tr>
						<td>
                            <table border="0" class="grilla-tab" cellpadding="0" cellspacing="0" style="width: 100%">
                                  <tr>
                                  		<td colspan="2" lass="grilla-tab-fila-titulo" align="right">
                                  		 Boleta : 
                                  		 <input type="text" name="boleta" id="boleta" style="font-size:30px; color:#0C0; text-align:right" width="10" size="10"  value="<?php echo $this->_tpl_vars['boleta']; ?>
"/>
