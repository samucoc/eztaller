<?php /* Smarty version 2.6.18, created on 2018-08-24 17:18:07
         compiled from sg_becas_todas.tpl */ ?>
	...
	<HEAD>
       ...
       <meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
                            ...
                            $(\'#txtFecha1,#txtFecha2\').datepicker({
							 ...
							 $("#OBLI-cboAlumno").autocomplete({
                                ...
                                select: function( event, ui ) {
                                    var rut = ui.item.id;
                                    document.getElementById(\'rutAlumno\').value = rut;
                                    }
                                });
		...
		function ExportToExcel(mytblId){
		       var htmltable= document.getElementById(\'tabla_1\');
					...
					<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%"><label class="form-titulo">Ver Becas</label></td>
								</tr>
							</table>
							<br>
							<table class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								...
								<tr>
									<td  class="tabla-alycar-label" style="width: 7%" align='left'>Alumno</td>
									<td  class="tabla-alycar-texto" style="width: 93%">
										<input name="OBLI-cboAlumno" id="OBLI-cboAlumno" size="65" widht="65" class="ui-autocomplete-input" autocomplete="off" type="text"><span role="status" aria-live="polite" class="ui-helper-hidden-accessible"></span>
                                        <input name="rutAlumno" id="rutAlumno" type="hidden">
									</td>
								</tr>
								<tr align="left">
