<?php /* Smarty version 2.6.18, created on 2013-09-10 15:20:41
         compiled from sg_descuentos_otros.tpl */ ?>
						...
						<form id="Form1" name="Form1" method="post" runat="server">
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%"><label class="form-titulo">&nbsp;&nbsp; Otros Descuentos</label></td>
								</tr>
							</table>
							<br>
							<table class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
                                ...
                                <tr align="left">
                                	<td height="35" class="tabla-alycar-label" style="width: 15%">Tipo de descuento:<label class="requerido"> * </label></td>
									<td class="tabla-alycar-texto" style="width: 35%"><input name="OBLItipo" type="text" id="OBLItipo" value="" size="75" />
							      </td>
							  </tr>
                              <tr align="left">
