<?php /* Smarty version 2.6.18, created on 2013-09-26 14:52:52
         compiled from sg_informe_descuentos_pie_vendedor.tpl */ ?>
						...
						<form id="Form1" name="Form1" method="post" runat="server">
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									<td style="width: 7%" align='right'><img src="../images/Gnome-System-Search-48.png"></td>
									<td style="width: 93%"><label class="form-titulo">&nbsp;&nbsp; Consulta de Pie Vendedor</label></td>
								</tr>
							</table>
							<br>
							<table class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left">
									...
									<td class="tabla-alycar-texto" style="width: 35%">
										<SELECT id="OBLIcboEmpresa" name="OBLIcboEmpresa" style="width: 100%" onKeyPress="return SoloNumeros(this, event, 0)" onchange="xajax_CargaSectores(xajax.getFormValues('Form1')), xajax_CargaVendedores(xajax.getFormValues('Form1')), xajax_CargaCobradores(xajax.getFormValues('Form1'))"></SELECT>
									</td>	
									<td class="tabla-alycar-label" style="width: 15%">Sector:</td>
									<td class="tabla-alycar-texto" style="width: 35%">
										<SELECT id="cboSector" name="cboSector" style="width: 100%" onKeyPress="return SoloNumeros(this, event, 0)">
											<option value=''>Todos</option>
										</SELECT>
									</td>	
								</tr>
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 15%">Vendedor:</td>
									<td class="tabla-alycar-texto" style="width: 35%">
										<SELECT id="cboVendedor" name="cboVendedor" style="width: 100%" onKeyPress="return SoloNumeros(this, event, 0)">
											<option value=''>Todos</option>
										</SELECT>
									</td>	
									<td class="tabla-alycar-label" style="width: 15%">Cobrador:</td>
									<td class="tabla-alycar-texto" style="width: 35%">
										<SELECT id="cboCobrador" name="cboCobrador" style="width: 100%" onKeyPress="return SoloNumeros(this, event, 0)">
											<option value=''>Todos</option>
										</SELECT>
									</td>	
								</tr>
								<tr align="left">
									...
									<td colspan='3' class="tabla-alycar-texto" style="width: 35%">
