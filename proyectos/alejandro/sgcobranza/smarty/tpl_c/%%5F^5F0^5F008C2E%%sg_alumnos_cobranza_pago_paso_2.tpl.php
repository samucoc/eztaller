<?php /* Smarty version 2.6.18, created on 2016-01-12 08:40:33
         compiled from sg_alumnos_cobranza_pago_paso_2.tpl */ ?>
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%"><label class="form-titulo">&nbsp;&nbsp;Pagos Alumno</label>
                                      	<input type="hidden" name="boleta" id="boleta" value="<?php echo $this->_tpl_vars['boleta']; ?>
"/>
