<?php /* Smarty version 2.6.18, created on 2014-01-16 17:54:13
         compiled from sg_informe_ayudas_economicas_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'sg_informe_ayudas_economicas_list.tpl', 18, false),array('modifier', 'number_format', 'sg_informe_ayudas_economicas_list.tpl', 21, false),)), $this); ?>
<div id="pivot">										
...
<tr>
	...
	<td class="grilla-tab-fila-titulo" align='center'><a href="#" style="cursor: hand;" onclick="xajax_Ordenar(xajax.getFormValues('Form1'), 'trab_ben');">Trabajador Beneficiario</a></td>
	<td class="grilla-tab-fila-titulo" align='center'><a href="#" style="cursor: hand;" onclick="xajax_Ordenar(xajax.getFormValues('Form1'), 'trab_apo');">Trabajador Aportante</a></td>
...
?>
		...
		<td class="grilla-tab-fila-campo" align='left'><?php echo $this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['trabajador_beneficiario']; ?>
</td>
		<td class="grilla-tab-fila-campo" align='left'><?php echo $this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['trabajador_aportador']; ?>
</td>
...
<tr>
	...
	<td class="grilla-tab-fila-campo" align="right" colspan="3"> <?php echo ((is_array($_tmp=$this->_tpl_vars['total'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 0, ".", ",") : number_format($_tmp, 0, ".", ",")); ?>
</td>
</tr>
<tr>
