<?php /* Smarty version 2.6.18, created on 2015-10-23 19:42:20
...
'"  class="boton" value="Asistencia"/>
		                                	<input type="button" name="btnAsistencia" id="btnAsistencia" onclick="location.href='sg_alumnos_Apoderado.php?rut=<?php echo $this->_tpl_vars['rut']; ?>
'"  class="boton" value="Apoderado"/>
                                    	</td>
                                    </tr>
                                <tr align="left">
