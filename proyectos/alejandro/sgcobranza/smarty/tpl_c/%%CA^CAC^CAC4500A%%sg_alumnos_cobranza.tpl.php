<?php /* Smarty version 2.6.18, created on 2018-09-05 21:06:15
         compiled from sg_alumnos_cobranza.tpl */ ?>
	...
	<HEAD>
       ...
       <meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
		...
		'; ?>
			...
			<?php if (( $this->_tpl_vars['enmarcado'] != '0' )): ?>
		<?php echo '
				#contenedor{
                            ...
                            <table border="0" class="grilla-tab" cellpadding="0" cellspacing="0" style="width: 100%">
                                <tr>
                                	<td class="grilla-tab-fila-titulo" colspan="4">
										...
										<a href="#" onclick='showPopWin("sg_alumnos_cobranza_pago.php?rut_alumno=<?php echo $this->_tpl_vars['rut_alumno']; ?>
", "Ingresar Pago", 800, 600, null);' title='Pagar'>
											<img src='../images/fin_comp/pago.png'  title='Pagar' width="48"/>
										</a>
										<a href="#" onclick='showPopWin("sg_confirmar_alumnos_imprimir_contrato.php?rut_alumno=<?php echo $this->_tpl_vars['rut_alumno']; ?>
", "Imprime Contrato", 800, 600, null);' title="Ver Contrato" >
											<img src='../images/fin_comp/contrato.png' title="Ver Contrato"  width="48"/>
										</a>
										<a href="#" onclick='showPopWin("sg_alumnos_imprimir_certificado_beca.php?rut_alumno=<?php echo $this->_tpl_vars['rut_alumno']; ?>
", "Imprime Certificado Beca", 800, 600, null);' title="Ver Certificado Beca" >
											<img src='../images/fin_comp/beca.png' title="Ver Certificado Beca"  width="48"/>
										</a>
									    <a href="#" id="contenedor" onclick='showPopWin("sg_mant_tablas.php?tbl=Bitacoras&rut=<?php echo $this->_tpl_vars['rut_alumno']; ?>
", "Bitacoras", 800, 600, null);' title="Bit&aacute;coras del Alumno" >
                                    ...
                                    <td class="grilla-tab-fila-titulo" align="center">
                                    	<a href="#" onclick='showPopWin("../../sige/sitio/sg_mant_consulta_alumno.php?tbl=alumnos&rut=<?php echo $this->_tpl_vars['rut_alumno']; ?>
", "Consulta Ficha Alumnos", 1200, 600, null);' title="Consulta Ficha Alumnos" >
											<img src='../images/gest_esc/ficha-alumno.png' title="Consulta Ficha Alumnos"  width="48"/>
										</a>										
                                    </td>
                                    <td class="grilla-tab-fila-titulo" align="center">
                                        <a href="#" onclick="xajax_Volver(xajax.getFormValues('Form1'),'<?php echo $this->_tpl_vars['rut_alumno']; ?>
');">
