<?php /* Smarty version 2.6.18, created on 2014-01-16 17:27:08
         compiled from sg_informe_ayudas_economicas.tpl */ ?>
                           ...
                           $.datepicker.setDefaults($.datepicker.regional[\'es\']);                            
                            ...
                            $("#cboPersona").autocomplete({
                             ...
                             $("#cboPersona_2").autocomplete({
                                ...
                                select: function( event, ui ) {
                                    var rut = ui.item.id;
                                    document.getElementById(\'txtCodCobrador_2\').value = rut;
                                    }
                                });
                            });
		</script>
						...
						<form id="Form1" name="Form1" method="post" runat="server">
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%"><label class="form-titulo">&nbsp;&nbsp;Consulta de Ayudas Economicas
</label></td>
								</tr>
							</table>
							<br>
							<table class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								...
								<tr align="left">
									...
									<td class="tabla-alycar-texto" style="width: 85%">
                                        <input name="cboPersona_2" id="cboPersona_2" value="" onchange="verificaValor(this.value)" size="50"/>
                                        <input type="hidden" name="txtCodCobrador_2" id="txtCodCobrador_2"></input>
									</td>	
								</tr>
								<tr align="left">
