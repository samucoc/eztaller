<?php /* Smarty version 2.6.18, created on 2017-10-10 00:50:30
         compiled from sg_informe_detalle_matriculas.tpl */ ?>
					...
					<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%">
                                    	<label class="form-titulo">Informe Detalle de Matriculas</label>
                                    </td>
								</tr>
							</table>
							<br>
							<table class="tabla-alycar"  border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left">
									...
									<td class="tabla-alycar-texto" style="width: 35%">
										<SELECT id="anio" name="anio" style="width: 100%" onKeyPress="return SoloNumeros(this, event, 0)">
										</SELECT>
									</td>	
								</tr>
								<tr align="left" valign="middle">
