<?php /* Smarty version 2.6.18, created on 2018-06-19 20:30:07
         compiled from sg_cobranza_grafico_pagos.tpl */ ?>
					...
					<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%">
                                    	<label class="form-titulo">&nbsp;&nbsp;Estad&iacute;sticas de Recaudaci&oacute;n Mensual</label>
								...
								<tr align="left">
									<td colspan="2" class="tabla-alycar-fila-botones">
										<a href="#" onclick="xajax_Grabar(xajax.getFormValues('Form1'));">
											<img src='../images/basicos/buscar.png' title='Generar Estad&iacute;stica de Recaudaci&oacute;n Mensual' width="32"/>
										</a>
									</td>
								</tr>
