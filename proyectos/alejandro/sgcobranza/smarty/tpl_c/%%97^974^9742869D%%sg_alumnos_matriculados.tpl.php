<?php /* Smarty version 2.6.18, created on 2017-08-07 20:17:26
         compiled from sg_alumnos_matriculados.tpl */ ?>
...
"/>
							...
							<table class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
                                ...
                                <tr align="left">
								  <td class="tabla-alycar-label">Valor</td>
								  <td class="tabla-alycar-texto">
                                  	<input name="valor_colegiatura" type="text" id="valor_colegiatura" value="<?php echo $this->_tpl_vars['colegiatura']; ?>
" readonly="readonly"/>
                                  </td>
								  <td class="tabla-alycar-label">Beca</td>
								  <td class="tabla-alycar-texto">
								  ...
								  <td class="tabla-alycar-label">A Cancelar</td>
								  <td class="tabla-alycar-texto">
                                  	<input name="a_cancelar_colegiatura" type="text" id="a_cancelar_colegiatura" value="<?php echo $this->_tpl_vars['colegiatura']; ?>
" readonly="readonly"/>
                                  </td>
							  	</tr>
								<tr align="left">
								  ...
								  <td class="tabla-alycar-label">Valor Cuota</td>
								  <td class="tabla-alycar-texto">
                                  	<input name="valor_cuota_colegiatura" type="text" id="valor_cuota_colegiatura" value="<?php echo $this->_tpl_vars['valor_cuota_colegiatura']; ?>
" readonly="readonly"/>
                                  </td>
							  	</tr>
								<tr align="left">
