<?php /* Smarty version 2.6.18, created on 2019-03-08 20:30:23
         compiled from sg_consultas_detalle_boletas.tpl */ ?>
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								...
								<tr align="left" valign="middle">
									...
									<td style="width: 93%">
                                    	...
                                    	<label class="form-titulo">Detalle Boletas</label>
...
"/>
							...
							<table class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								...
								<tr align="left">
								  ...
								  <td class="tabla-alycar-label" style="width: 15%">Rango de Fechas</td>
								...
								<tr align="left">
									...
									<td colspan="2" class="tabla-alycar-fila-botones">
										...
										<a href="#" onclick="xajax_CargaPagina(xajax.getFormValues('Form1'));">
