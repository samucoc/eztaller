...
{section name=registros loop=$arrRegistros}
        <tr>
		<td class="grilla-tab-fila-campo" align='left'>{$arrRegistros[registros].centro_costo}</td>
        ...
        <td class="grilla-tab-fila-campo" align='right'>{$arrRegistros[registros].monto}</td>
		<td class="grilla-tab-fila-campo" align='left'>{$arrRegistros[registros].forma_pago}</td>
...
<tr>
	...
	<td class="grilla-tab-fila-campo" align="right" colspan="4"> {$total|number_format:0:".":","}</td>
</tr>
<tr>
