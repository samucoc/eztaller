...
{section name=registros loop=$arrRegistros}
		...
		<td class="grilla-tab-fila-campo" align='left'>{$arrRegistros[registros].trabajador_beneficiario}</td>
		<td class="grilla-tab-fila-campo" align='left'>{$arrRegistros[registros].trabajador_aportador}</td>
...
<tr>
	...
	<td class="grilla-tab-fila-campo" align="right" colspan="3"> {$total|number_format:0:".":","}</td>
</tr>
<tr>
