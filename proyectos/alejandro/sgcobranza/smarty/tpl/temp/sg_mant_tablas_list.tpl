...
{elseif ($TBL == 'trabajadores')}
	<tr>
		...
		<td class="grilla-tab-fila-titulo" align='center'>Sector Vendedor</td>
		...
		<td class="grilla-tab-fila-titulo" align='center'>Sector Supervisor</td>
	...
	{section name=registros loop=$arrRegistros}
		<tr onmouseover='this.style.background="#FFFF88"' onmouseout='this.style.background="white"'>
			...
			<td class="grilla-tab-fila-campo"><a href='#' onclick="xajax_TraeValor(xajax.getFormValues('Form1'),'{$arrRegistros[registros].ncorr}');">{$arrRegistros[registros].sect_vend}</a></td>
			...
			<td class="grilla-tab-fila-campo"><a href='#' onclick="xajax_TraeValor(xajax.getFormValues('Form1'),'{$arrRegistros[registros].ncorr}');">{$arrRegistros[registros].sect_sup}</a></td>
