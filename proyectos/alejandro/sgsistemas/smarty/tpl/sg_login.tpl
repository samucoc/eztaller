					...
					<tr>
						<td align='center'>
							...
							<table align='center' border="0" class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%; float: left;">
								...
								<tr>
									<td onmouseover="this.style.background='#447CAD'; this.style.color='#FFFFFF'; cambiar('sist3', '../images/gest_fin/respaldos.png');xajax_Acceso(xajax.getFormValues('Form1'), 'Gesti&oacute;n y Rendici&oacute;n de Cuentas');" onmouseout="this.style.background='#F2F2F2'; this.style.color='#1B4978';  cambiar('sist3', '../images/gest_fin/respaldos.png'); xajax_Acceso(xajax.getFormValues('Form1'), 'Seleccione un Acceso');" 
										align='center' class="tabla-alycar-label" style="width: 25%" onclick="xajax_Ingresa(xajax.getFormValues('Form1'), '3');">
										<br>
										<img onMouseOver="cambiar('sist3', '../images/gest_fin/respaldos.png');" onMouseOut="cambiar('sist3', '../images/gest_fin/respaldos.png');" src="../images/gest_fin/respaldos.png" name="sist3" >
										<br><br>
										Gesti&oacute;n y Rendici&oacute;n de Cuentas
										<br><br>
									</td>
									<td onmouseover="this.style.background='#447CAD'; this.style.color='#FFFFFF'; cambiar('sist4', '../images/gest_fin/respaldos.png');xajax_Acceso(xajax.getFormValues('Form1'), 'Control de Gesti&oacute;n');" onmouseout="this.style.background='#F2F2F2'; this.style.color='#1B4978';  cambiar('sist4', '../images/gest_fin/respaldos.png'); xajax_Acceso(xajax.getFormValues('Form1'), 'Seleccione un Acceso');" 
										align='center' class="tabla-alycar-label" style="width: 25%" onclick="xajax_Ingresa(xajax.getFormValues('Form1'), '4');">
										<br>
										<img onMouseOver="cambiar('sist4', '../images/gest_fin/respaldos.png');" onMouseOut="cambiar('sist4', '../images/gest_fin/respaldos.png');" src="../images/gest_fin/respaldos.png" name="sist4" >
										<br><br>
