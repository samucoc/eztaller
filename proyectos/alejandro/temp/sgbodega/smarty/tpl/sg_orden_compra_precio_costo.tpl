						...
						<form id="Form1" name="Form1" method="post" runat="server">
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<input type="hidden" name="fecha_cant_rec" id="fecha_cant_rec" value="{$fecha_cant_rec}">
									<input type="hidden" name="factura" id="factura" value="{$factura}">
									<input type="hidden" name="guia_despacho" id="guia_despacho" value="{$guia_despacho}">
									<input type="hidden" name="OBLItxtCodVendedor" id="OBLItxtCodVendedor" value="{$OBLItxtCodVendedor}">
									<input type="hidden" name="OBLItxtDescVendedor" id="OBLItxtDescVendedor" value="{$OBLItxtDescVendedor}">
							...
							<table class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left">
									...
									<td class="tabla-alycar-texto" style="width: 35%">
										<INPUT type="text" id="txtCodProducto" name="txtCodProducto" value='{$codigo}' maxLength="10" style="width: 15%;" readonly="readonly"/>
