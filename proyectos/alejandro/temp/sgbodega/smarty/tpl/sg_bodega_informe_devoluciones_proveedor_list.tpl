...
<tr>
	<td colspan='11' class="grilla-tab-fila-titulo" align='center'><b>Informe Devoluciones a Proveedor al {$smarty.now|date_format:"%d/%m/%Y"}</b></td>
</tr>
<tr>
	<td colspan='3' class="grilla-tab-fila-titulo" align='left'>Periodo:</td>
	<td colspan='8' class="grilla-tab-fila-campo" align='left'>Desde: {$DESDE} Hasta: {$HASTA}</td>
</tr>
<tr>
	<td colspan='3' class="grilla-tab-fila-titulo" align='left'>Proveedor:</td>
	<td colspan='8' class="grilla-tab-fila-campo" align='left'>{$PROVEEDOR}</td>
</tr>
<tr>
...
<tr>
	...
	<td colspan='8' class="grilla-tab-fila-campo" align='left'>{$TOTAL_MOVIM|number_format:0:',':'.'}</td>
</tr>
<tr>
