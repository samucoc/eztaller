...
<tr>
	<td colspan='20' class="grilla-tab-fila-titulo" align='center'><b>Consulta Stock Vendedor al {$smarty.now|date_format:"%d/%m/%Y"}</b></td>
</tr>

<tr>
	<td colspan='1' class="grilla-tab-fila-titulo" align='left'>Empresa:</td>
	<td colspan='19' class="grilla-tab-fila-campo" align='left'>{$EMPRESA}</td>
</tr>
<tr>
	<td colspan='1' class="grilla-tab-fila-titulo" align='left'>Vendedor:</td>
	<td colspan='19' class="grilla-tab-fila-campo" align='left'>{$COBRADOR}</td>
</tr>
...
{section name=registros loop=$arrRegistros}
	<tr>
		...
		<td class="grilla-tab-fila-campo-rev" align='right'>{$arrRegistros[registros].aumentos_nb|number_format:0:',':'.'}</td>
		<td class="grilla-tab-fila-campo-rev" align='right'>{$arrRegistros[registros].aumentos_ub|number_format:0:',':'.'}</td>
...
<tr>
	...
	<td class="grilla-tab-fila-campo" align='right'>{$TOTAL_AUMENTOS_NB|number_format:0:',':'.'}</td>
	<td class="grilla-tab-fila-campo" align='right'>{$TOTAL_AUMENTOS_UB|number_format:0:',':'.'}</td>
