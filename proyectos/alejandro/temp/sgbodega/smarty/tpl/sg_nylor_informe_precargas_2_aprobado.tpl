					...
					<tr>
						<td>
							<table border="0" class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr> 
									<td colspan="2" class="tabla-alycar-fila-informa-requerida-contrato">Autorizaciones 
	<input type="hidden" name="txtFolio" id="txtFolio" value={$folio}/>
	<input type="hidden" name="txtCodigo" id="txtCodigo" value={$codigo}/></td>
								</tr>
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 20%">Autorizado</td>
									<td class="tabla-alycar-texto" style="width: 70%">
										<Input type='radio' name='OBLIpedido' id='OBLIpedido' value='autorizado' />
									</td>
								</TR>
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 20%">Rechazado</td>
									<td class="tabla-alycar-texto" style="width: 70%">
										<Input type='radio' name='OBLIpedido' id='OBLIpedido' value='rechazado' />
									</td>
								</TR>
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 20%">Anulado</td>
									<td class="tabla-alycar-texto" style="width: 70%">
										<Input type='radio' name='OBLIpedido' id='OBLIpedido' value='anulado' />
									</td>
								</TR>
								
                                	<td class="tabla-alycar-label" style="width: 20%">Observacion</td>
									<td class="tabla-alycar-texto" style="width: 70%">
