					...
					<tr>
						<td>
							<table border="0" class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr> 
									<td colspan="2" class="tabla-alycar-fila-informa-requerida-contrato">Aumentos a Bodega Central</td>
								</tr>
								<tr align="left">
							...
							<table class="grilla-tab" border="0" cellspacing="0" cellpadding="0" width="100%">
								<tr>
									...
									<td class="grilla-tab-fila-campo" style="width: 5%" align='center'>N/U</td>
									<td class="grilla-tab-fila-campo" style="width: 8%" align='center'>Valor Costo</td>
									<td class="grilla-tab-fila-campo" style="width: 5%" align='center'>Cant.</td>
									<td class="grilla-tab-fila-campo" style="width: 8%" align='center'>Sub. Neto</td>
									<td class="grilla-tab-fila-campo" style="width: 8%" align='center'>Descuento</td>
									<td class="grilla-tab-fila-campo" style="width: 8%" align='center'>Sub. total</td>
									<td class="grilla-tab-fila-campo" align='center'></td>
								</tr>								
								<tr>
									<td class="grilla-tab-fila-campo" style="width: 45%" align='left'>
										<INPUT type="text" id="OBLItxtCodProducto" name="OBLItxtCodProducto" value='' onKeyPress="return SoloNumeros(this, event, 1)" onchange="xajax_CargaDesc(xajax.getFormValues('Form1'), 'sgbodega.tallas', 'ta_ncorr', 'ta_descripcion', 'OBLItxtCodProducto', 'OBLItxtDescProducto', '');" maxLength="10" style="width: 15%">
									...
									<td class="grilla-tab-fila-campo" style="width: 8%" align='center'>
										<INPUT type="text" style="width: 99%" id="OBLItxtSubNeto" name="OBLItxtSubNeto" onKeyPress="return SoloNumeros(this, event, 0)" value='' readonly maxLength="10">
									</td>
									<td class="grilla-tab-fila-campo" style="width: 8%" align='center'>
									...
									<td class="grilla-tab-fila-campo" style="width: 8%" align='center'>
										<INPUT type="text" style="width: 99%" id="OBLItxtSubTotal" name="OBLItxtSubTotal" onKeyPress="return SoloNumeros(this, event, 0)" value='' readonly maxLength="10">
									</td>
