					...
					<tr>
						<td>
							<table border="0" class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr> 
									<td colspan="2" class="tabla-alycar-fila-informa-requerida-contrato">Movimientos Por Vendedor</td>
								</tr>
								<tr align="left">
								...
								<tr align="left">
									...
									<td class="tabla-alycar-texto" style="width: 80%">
										...
										<INPUT type="text" id="OBLI-txtFechaDesde" name="OBLI-txtFechaDesde" value='' onKeyPress="return SoloNumeros(this, event, 0)" readonly maxLength="10" size="10">
										&nbsp;
										al
										&nbsp;
								...
								<tr align="left">
									...
									<td class="tabla-alycar-texto" style="width: 80%" align='left'>
										<INPUT type="text" id="txtCodProducto" name="txtCodProducto" value='' onKeyPress="return SoloNumeros(this, event, 1)" onchange="xajax_CargaDesc(xajax.getFormValues('Form1'), 'sgbodega.tallas', 'ta_ncorr', 'ta_descripcion', 'txtCodProducto', 'txtDescProducto', '');" maxLength="10" size="10">
					...
					<tr>
						<td>
							<table border="0" class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left">
									<td>
										<div id='divnoencontrados' style="display: none;"><div>
									</td>
								</TR>
								<tr align="left">
									<td>
