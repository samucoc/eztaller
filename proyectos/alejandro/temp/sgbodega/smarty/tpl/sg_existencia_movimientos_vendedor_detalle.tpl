						...
						<td>
							<table border="0" class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left">
									...
									<INPUT type="hidden" id="txtDescripcion" name="txtDescripcion" value='{$DESCRIPCION}'>
									<INPUT type="hidden" id="txtFecha1" name="txtFecha1" value='{$FECHA1}'>
									<INPUT type="hidden" id="txtFecha2" name="txtFecha2" value='{$FECHA2}'>
									<INPUT type="hidden" id="txtCobrador" name="txtCobrador" value='{$COBRADOR}'>
									<INPUT type="hidden" id="txtEmpresa" name="txtEmpresa" value='{$EMPRESA}'>
									<INPUT type="hidden" id="txtUltGuia" name="txtUltGuia" value='{$ULT_GUIA}'>
									<td>
