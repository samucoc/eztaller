...
{section name=registros loop=$arrRegistros}
	<tr>
		...
		<td class="grilla-tab-fila-campo" align='center'>
			<SELECT id="{$arrRegistros[registros].ncorr}cboNU" name="{$arrRegistros[registros].ncorr}cboNU">
				<option value='{$arrRegistros[registros].nu}'>{$arrRegistros[registros].nu}</option>
