					...
					<tr>
						<td>
							<table border="0" class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 35%">Motivo:<label class="requerido"> * </label></td>
									<td class="tabla-alycar-texto" style="width: 65%">
										<INPUT type="hidden" id="txtNcorr" name="txtNcorr" value='{$NCORR}'>
										<SELECT id="OBLI-cboMotivo" name="OBLI-cboMotivo" onKeyPress="return SoloNumeros(this, event, 0)"></SELECT>
									</td>	
								</TR>
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 35%">Observación:</td>
									<td class="tabla-alycar-texto" style="width: 65%">
										<textarea id="txtObservacion" name="txtObservacion" cols="40" rows="4" ></textarea>
									</td>
								</TR>
								<tr align="left">
									<td colspan="6" class="tabla-alycar-fila-botones">
										<input type="button" id="btnBuscar" name="btnBuscar" value="Confirmar Eliminación" class="boton" onclick="javascript: ValidaFormularioMantenedor();">
									</td>
								</tr>
							</table>
						</td>
