					...
					<tr>
						<td>
							<table border="0" class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left">
									<td class="tabla-alycar-label-peq" style="width: 30%">Código:</td>
									<td class="tabla-alycar-texto-peq" style="width: 70%">
										<INPUT type="text" id="txtNcorr" name="txtNcorr" value='{$NCORR}' size="9" readonly>
									</td>
								</tr>
								<tr align="left">
									<td class="tabla-alycar-label-peq" style="width: 30%">Tipo de Operación:<label class="requerido"> * </label></td>
									<td class="tabla-alycar-texto-peq" style="width: 70%">
								...
								<tr align="left">
									<td class="tabla-alycar-label-peq" style="width: 30%">Fecha Emisión:<label class="requerido"> * </label></td>
									<td class="tabla-alycar-texto-peq" style="width: 70%">
