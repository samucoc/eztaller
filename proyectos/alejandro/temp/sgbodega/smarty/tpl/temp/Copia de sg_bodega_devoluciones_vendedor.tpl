...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<HEAD>
		...
		<title> Devoluciones de Vendedor </title>
					...
					<tr>
						<td>
							<table border="0" class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr> 
									<td colspan="2" class="tabla-alycar-fila-informa-requerida-contrato">Devoluciones de Vendedor</td>
								</tr>
								<tr align="left">
								...
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 25%">Vendedor:<label class="requerido"> * </label></td>
									<td class="tabla-alycar-texto" style="width: 75%">
										<INPUT type="text" id="OBLI-txtCodCobrador" name="OBLI-txtCodCobrador" value='' onKeyPress="return SoloNumeros(this, event, 1)" onchange="xajax_CargaDesc(xajax.getFormValues('Form1'),'sgbodega.vendedores', 'VE_CODIGO', 'VE_VENDEDOR', 'OBLI-txtCodCobrador', 'OBLI-txtDescCobrador', '');" maxLength="10" size="10">
							...
							<table class="grilla-tab" border="0" cellspacing="0" cellpadding="0" width="100%">
								<tr>
									<td class="grilla-tab-fila-campo" style="width: 45%" align='center'></td>
									<td colspan='2' class="grilla-tab-fila-campo" style="width: 14%" align='center'>Stock Vendedor</td>
									<td colspan='2' class="grilla-tab-fila-campo" style="width: 14%" align='center'>Stock Bodega</td>
									<td colspan='3' class="grilla-tab-fila-campo" style="width: 7%" align='center'></td>
								</tr>								
								<tr>
									...
									<td class="grilla-tab-fila-campo" style="width: 7%" align='center'>N</td>
									<td class="grilla-tab-fila-campo" style="width: 7%" align='center'>U</td>
									<td class="grilla-tab-fila-campo" style="width: 7%" align='center'>N</td>
									<td class="grilla-tab-fila-campo" style="width: 7%" align='center'>U</td>
									<td class="grilla-tab-fila-campo" style="width: 7%" align='center'>N/U</td>
								...
								<tr>
									<td class="grilla-tab-fila-campo" style="width: 45%" align='left'>
										<INPUT type="text" id="OBLItxtCodProducto" name="OBLItxtCodProducto" value='' onKeyPress="return SoloNumeros(this, event, 5)" onchange="xajax_CargaDesc(xajax.getFormValues('Form1'), 'sgbodega.tallas', 'ta_ncorr', 'ta_descripcion', 'OBLItxtCodProducto', 'OBLItxtDescProducto', '');" maxLength="10" style="width: 15%">
									...
									<td class="grilla-tab-fila-campo" style="width: 7%" align='center'>
										<INPUT type="text" style="width: 99%" id="OBLItxtStockVendedorN" name="OBLItxtStockVendedorN" onKeyPress="return SoloNumeros(this, event, 0)" readonly value='' maxLength="10">
									</td>
									<td class="grilla-tab-fila-campo" style="width: 7%" align='center'>
										<INPUT type="text" style="width: 99%" id="OBLItxtStockVendedorU" name="OBLItxtStockVendedorU" onKeyPress="return SoloNumeros(this, event, 0)" readonly value='' maxLength="10">
									</td>
									<td class="grilla-tab-fila-campo" style="width: 7%" align='center'>
										<INPUT type="text" style="width: 99%" id="OBLItxtStockBodegaN" name="OBLItxtStockBodegaN" onKeyPress="return SoloNumeros(this, event, 0)" readonly value='' maxLength="10">
									</td>
									<td class="grilla-tab-fila-campo" style="width: 7%" align='center'>
										<INPUT type="text" style="width: 99%" id="OBLItxtStockBodegaU" name="OBLItxtStockBodegaU" onKeyPress="return SoloNumeros(this, event, 0)" readonly value='' maxLength="10">
									</td>
									
									<td class="grilla-tab-fila-campo" style="width: 7%" align='center'>
										<SELECT id="cboNU" name="cboNU" style="width: 99%" onKeyPress="return SoloNumeros(this, event, 0)">
