	...
	{if ($arrRegistros[registros].cod_vendedor == $arrRegistrosVend[vendedor].ncorr)}
		{section name=detalle loop=$arrDetalle}
			...
			<td class="grilla-tab-fila-campo-pequenio" align='center'>
				{if ($arrRegistros[registros].usuario == 'mdiaz') || ($arrRegistros[registros].usuario == 'jruz') || ($arrRegistros[registros].usuario == 'ssilva')}
                        <a href="#" onclick="xajax_Pedido(xajax.getFormValues('Form1'),{$arrRegistros[registros].folio},{$arrDetalle[detalle].codigo});" title="Pedido" ><img src="../images/pedido.png" title="Pedido" /></a>
                {/if}
                {if (($arrRegistros[registros].usuario == 'imolina') || ($arrRegistros[registros].usuario == 'fballadares') || ($arrRegistros[registros].usuario == 'jruz') || ($arrRegistros[registros].usuario == 'ssilva')) }
						<a href="#" onclick="xajax_Despacho(xajax.getFormValues('Form1'),{$arrRegistros[registros].folio},{$arrDetalle[detalle].codigo});" title="Despachado" ><img src="../images/despachado.png" title="Despachado" /></a>
                {/if}
                {if (($arrRegistros[registros].usuario == 'ofernandez') || ($arrRegistros[registros].usuario == 'jruz') || ($arrRegistros[registros].usuario == 'ssilva'))} 
						<a href="#" onclick="xajax_Aprobado(xajax.getFormValues('Form1'),{$arrRegistros[registros].folio},{$arrDetalle[detalle].codigo});" title="Aprobado" ><img src="../images/aprobado.png" title="Aprobado" /></a>
                {/if}
...
{section name=vendedor loop=$arrRegistrosVend_1}
		
		<tr>
			<td colspan='3' class="grilla-tab-fila-titulo" align='left'>Vendedor:</td>
			<td colspan='11' class="grilla-tab-fila-campo" align='left'>{$arrRegistrosVend_1[vendedor].ncorr} - {$arrRegistrosVend_1[vendedor].nombre}</td>
		</tr>
	...
	{section name=registros loop=$arrRegistros_1}
	{if ($arrRegistros_1[registros].cod_vendedor == $arrRegistrosVend_1[vendedor].ncorr)}
		{section name=detalle loop=$arrDetalle_1}
			{if ($arrRegistros_1[registros].ncorr == $arrDetalle_1[detalle].ncorr)}
			<tr>
				{if ($arrRegistros_1[registros].estado_venta == 'POR APROBAR')}
					<td class="grilla-tab-fila-campo">
						<a href="#" style="cursor: hand;"><img  src="../images/estados/aprobar.png" border=0 title="Venta Por Aprobar"></a>
						<br>
						APR
			...
			<td class="grilla-tab-fila-campo" align='center'><b>{$arrRegistros_1[registros].item}</b></td>
			<td class="grilla-tab-fila-campo" align='right'>
				<b>
					<a href="#" onclick="showPopWin('sg_ventas_revisar_preventas_informe_hv.php?folio={$arrRegistros[registros].folio}', 'Revision', 800, 600, null);" >{$arrRegistros_1[registros].folio}
					</a>
				</b></td>
			<td class="grilla-tab-fila-campo" align='right'><b>{$arrRegistros_1[registros].empresa}</b></td>
            <td class="grilla-tab-fila-campo" align='right'><b>{$arrRegistros_1[registros].sector}</b></td>
			<td class="grilla-tab-fila-campo" align='right'><b>{$arrRegistros_1[registros].fecha_tarjeta}</b></td>
			<td class="grilla-tab-fila-campo" align='left'><b>{$arrRegistros_1[registros].cliente}</b></td>
	
			<td class="grilla-tab-fila-campo-pequenio" align='right'>{$arrDetalle_1[detalle].codigo}</td>
			<td class="grilla-tab-fila-campo-pequenio" align='left'>{$arrDetalle_1[detalle].descripcion}</td>
		        <td class="grilla-tab-fila-campo-pequenio" align='right'>{$arrDetalle_1[detalle].observacion}</td>
			<td class="grilla-tab-fila-campo-pequenio" align='right'>{$arrDetalle_1[detalle].cantidad|number_format:0:',':'.'}</td>
			<td class="grilla-tab-fila-campo-pequenio" align='right'>{$arrDetalle_1[detalle].pedido|date_format:"%d/%m/%Y"}</td>
			<td class="grilla-tab-fila-campo-pequenio" align='right'>{$arrDetalle_1[detalle].despachado|date_format:"%d/%m/%Y"}</td>
			<td class="grilla-tab-fila-campo-pequenio" align='center'>
				{if ($arrRegistros_1[registros].usuario == 'mdiaz') || ($arrRegistros_1[registros].usuario == 'jruz') || ($arrRegistros_1[registros].usuario == 'ssilva')}
                        <a href="#" onclick="xajax_Pedido(xajax.getFormValues('Form1'),{$arrRegistros_1[registros].folio},{$arrDetalle_1[detalle].codigo});" title="Pedido" ><img src="../images/pedido.png" title="Pedido" /></a>
                {/if}
                {if (($arrRegistros_1[registros].usuario == 'imolina') || ($arrRegistros_1[registros].usuario == 'fballadares') || ($arrRegistros_1[registros].usuario == 'jruz') || ($arrRegistros_1[registros].usuario == 'ssilva')) }
						<a href="#" onclick="xajax_Despacho(xajax.getFormValues('Form1'),{$arrRegistros_1[registros].folio},{$arrDetalle_1[detalle].codigo});" title="Despachado" ><img src="../images/despachado.png" title="Despachado" /></a>
                {/if}
                {if (($arrRegistros_1[registros].usuario == 'ofernandez') || ($arrRegistros_1[registros].usuario == 'jruz') || ($arrRegistros_1[registros].usuario == 'ssilva'))} 
						<a href="#" onclick="xajax_Aprobado(xajax.getFormValues('Form1'),{$arrRegistros_1[registros].folio},{$arrDetalle_1[detalle].codigo});" title="Aprobado" ><img src="../images/aprobado.png" title="Aprobado" /></a>
                {/if}
                		<a href="#" onclick="xajax_Historial(xajax.getFormValues('Form1'),{$arrRegistros_1[registros].folio},{$arrDetalle_1[detalle].codigo});" title="Historial" ><img src="../images/historial.png" title="Historial" /></a>
			</td>
				
			<td class="grilla-tab-fila-campo-pequenio" align='center'>{$arrDetalle_1[detalle].nu}</td>
				</tr>
			{/if}
		{/section}
	{/if}
