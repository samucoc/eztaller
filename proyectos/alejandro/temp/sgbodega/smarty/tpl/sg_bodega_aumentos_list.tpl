...
{section name=registros loop=$arrRegistros}
	<tr>
		...
		<td class="grilla-tab-fila-campo" style="width: 5%">{$arrRegistros[registros].nu}</td>
		...
		<td class="grilla-tab-fila-campo" style="width: 8%" align='right'>{$arrRegistros[registros].subneto|number_format:0:',':'.'}</td>
		<td class="grilla-tab-fila-campo" style="width: 8%" align='right'>{$arrRegistros[registros].descuento|number_format:0:',':'.'}</td>
		<td class="grilla-tab-fila-campo" style="width: 8%" align='right'>{$arrRegistros[registros].subtotal|number_format:0:',':'.'}</td>
