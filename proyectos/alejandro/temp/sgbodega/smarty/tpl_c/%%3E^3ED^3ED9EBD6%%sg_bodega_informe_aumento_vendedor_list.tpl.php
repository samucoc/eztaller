<?php /* Smarty version 2.6.18, created on 2013-08-21 14:39:19
         compiled from sg_bodega_informe_aumento_vendedor_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'sg_bodega_informe_aumento_vendedor_list.tpl', 5, false),array('modifier', 'number_format', 'sg_bodega_informe_aumento_vendedor_list.tpl', 36, false),)), $this); ?>
<div id="pivot">										

<table class="grilla-tab" border="0" cellspacing="0" cellpadding="0" width="100%">
<tr>
	<td colspan='10' class="grilla-tab-fila-titulo" align='center'><b>Informe Aumentos a Vendedor al <?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d/%m/%Y") : smarty_modifier_date_format($_tmp, "%d/%m/%Y")); ?>
</b></td>
</tr>
<tr>
