<?php /* Smarty version 2.6.18, created on 2014-02-05 15:10:31
         compiled from sg_bodega_modificar_guia.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'sg_bodega_modificar_guia.tpl', 135, false),)), $this); ?>
					...
					<tr>
						<td>
							<table border="0" class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr> 
									<td colspan="2" class="tabla-alycar-fila-informa-requerida-contrato">Modificar Guia
                                      <input type="hidden" name="ncorr" id="ncorr" value="<?php echo $this->_tpl_vars['ncorr']; ?>
"/>
									</td>
								</tr>
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 30%">Nro Guia:<label class="requerido"> * </label></td>
									<td class="tabla-alycar-texto" style="width: 70%">
										<input type="text" name="movim_ncorr" id="movim_ncorr" />
                                        <input type="button" name="btnBuscar" value="Buscar" class="boton" onclick="xajax_CargaPagina(xajax.getFormValues('Form1'));"> 
									</td>	
								</TR>
								<tr align="left">
