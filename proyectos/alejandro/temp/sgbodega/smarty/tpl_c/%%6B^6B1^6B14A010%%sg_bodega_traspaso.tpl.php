<?php /* Smarty version 2.6.18, created on 2013-12-02 16:42:19
         compiled from sg_bodega_traspaso.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'sg_bodega_traspaso.tpl', 111, false),)), $this); ?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<HEAD>
		...
		<title> Traspaso a Bodega Central (Desde Bodega Con Con) </title>
					...
					<tr>
						<td>
							<table border="0" class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr>
								  <td colspan="2" class="tabla-alycar-fila-informa-requerida-contrato">Traspaso entre Bodegas</td>
							  </tr>
							  	<tr align="left">
								  <td class="tabla-alycar-label" style="width: 30%">Bodega Actual:
								    <label class="requerido"> * </label></td>
								  <td class="tabla-alycar-texto" style="width: 70%">
                                  	<?php echo $this->_tpl_vars['BODEGA']; ?>

                                    <input type="hidden" name="bodega" id="bodega" value="<?php echo $this->_tpl_vars['NRO_BODEGA']; ?>
"/>
                                  </td>
							  </tr>
									<tr align="left">
								  <td class="tabla-alycar-label" style="width: 30%">Bodega Traspaso:
								    <label class="requerido"> * </label></td>
								  <td class="tabla-alycar-texto" style="width: 70%"><select id="OBLIcboBodega" name="OBLIcboBodega" onkeypress="return SoloNumeros(this, event, 0)">
							      </select></td>
							  </tr>
								<tr align="left">
							...
							<table class="grilla-tab" border="0" cellspacing="0" cellpadding="0" width="100%">
								<tr>
									<td class="grilla-tab-fila-campo" style="width: 45%" align='center'>Producto
										<a href="#" style="cursor: hand;"><img  src="../images/magnify.png" border=0 title="Click para Buscar" onclick="showPopWin('sg_busqueda_traspaso.php?entidad=4&obj1=OBLItxtCodProducto&obj2=OBLItxtDescProducto', 'Busca Artículo', 550, 350, null);"></a>
									</td>
								...
								<tr>
									<td class="grilla-tab-fila-campo" style="width: 45%" align='left'>
										<INPUT type="text" id="OBLItxtCodProducto" name="OBLItxtCodProducto" value='' onKeyPress="return SoloNumeros(this, event, 1)" onchange="xajax_CargaDesc(xajax.getFormValues('Form1'), 'sgbodega.tallasnew', 'ta_ncorr', 'ta_descripcion', 'OBLItxtCodProducto', 'OBLItxtDescProducto', '');document.getElementById('OBLItxtCant').focus();" maxLength="10" style="width: 15%">
