<?php /* Smarty version 2.6.18, created on 2017-04-26 15:31:25
         compiled from sg_bodega_toma_inventario_total_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'sg_bodega_toma_inventario_total_list.tpl', 5, false),array('modifier', 'number_format', 'sg_bodega_toma_inventario_total_list.tpl', 33, false),)), $this); ?>
<div id="pivot">										
...
<tr>
	...
	<td class="grilla-tab-fila-titulo" align='center'><?php echo $this->_tpl_vars['fecha_cierre']; ?>
</td>
</tr>
</table>
...
?>
	<tr>
		...
		<td class="grilla-tab-fila-campo" align='right'><?php echo ((is_array($_tmp=$this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['cantidad_1'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 0, ',', '.') : number_format($_tmp, 0, ',', '.')); ?>
</td>
		<td class="grilla-tab-fila-campo" align='right'><?php echo ((is_array($_tmp=$this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['cantidad_2'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 0, ',', '.') : number_format($_tmp, 0, ',', '.')); ?>
</td>
		<td class="grilla-tab-fila-campo" align='right'><?php echo ((is_array($_tmp=$this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['cantidad_3'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 0, ',', '.') : number_format($_tmp, 0, ',', '.')); ?>
</td>
	</tr>
