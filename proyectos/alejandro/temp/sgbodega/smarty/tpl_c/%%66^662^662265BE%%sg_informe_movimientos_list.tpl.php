<?php /* Smarty version 2.6.18, created on 2016-11-10 12:00:55
         compiled from sg_informe_movimientos_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'sg_informe_movimientos_list.tpl', 5, false),array('modifier', 'number_format', 'sg_informe_movimientos_list.tpl', 57, false),)), $this); ?>
<div id="pivot">										
...
<tr>
	...
	<td colspan='10' class="grilla-tab-fila-campo" align='left'><?php echo $this->_tpl_vars['CODIGO']; ?>
</td>
</tr>
<tr>
	<td colspan='3' class="grilla-tab-fila-titulo" align='left'>Descripcion:</td>
	<td colspan='10' class="grilla-tab-fila-campo" align='left'><?php echo $this->_tpl_vars['DESCRIPCION']; ?>
</td>
</tr>
<tr>
...
?>
	<tr>
		...
		<td class="grilla-tab-fila-campo" align='right'><?php echo $this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['bodega']; ?>
</td>
...
<tr>
	...
	<td colspan='2' class="grilla-tab-fila-campo" align='left'><?php echo ((is_array($_tmp=$this->_tpl_vars['TOTAL_1'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 0, ',', '.') : number_format($_tmp, 0, ',', '.')); ?>
</td>
	<td colspan='2' class="grilla-tab-fila-campo" align='left'><?php echo ((is_array($_tmp=$this->_tpl_vars['TOTAL_2'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 0, ',', '.') : number_format($_tmp, 0, ',', '.')); ?>
</td>
	<td colspan='2' class="grilla-tab-fila-campo" align='left'><?php echo ((is_array($_tmp=$this->_tpl_vars['TOTAL_3'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 0, ',', '.') : number_format($_tmp, 0, ',', '.')); ?>
</td>
	<td colspan='2' class="grilla-tab-fila-campo" align='left'><?php echo ((is_array($_tmp=$this->_tpl_vars['TOTAL_5'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 0, ',', '.') : number_format($_tmp, 0, ',', '.')); ?>
</td>
</tr>
<tr>
