<?php /* Smarty version 2.6.18, created on 2014-10-30 12:25:45
         compiled from sg_orden_compra_solicitud.tpl */ ?>
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%"><label class="form-titulo">
											Ingreso segun Orden de Compra Nro: <?php echo $this->_tpl_vars['nro_oc']; ?>
</label>
                                    ...
                                    <input type="hidden" id="nro_oc" name="nro_oc" value="<?php echo $this->_tpl_vars['nro_oc']; ?>
"/>
                                    </td>
								</tr>
							</table>
