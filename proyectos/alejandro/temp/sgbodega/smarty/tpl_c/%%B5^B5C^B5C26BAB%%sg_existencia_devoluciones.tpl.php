<?php /* Smarty version 2.6.18, created on 2013-08-12 13:34:01
         compiled from sg_existencia_devoluciones.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'sg_existencia_devoluciones.tpl', 166, false),)), $this); ?>
							...
							<table border="0" class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr> 
									<td colspan="2" class="tabla-alycar-fila-informa-requerida-contrato">Devoluciones de Clientes
										<INPUT type="hidden" id="txtFolioOculto" name="txtFolioOculto" value='<?php echo $this->_tpl_vars['FOLIO']; ?>
'>
									</td>
								</tr>
								<tr align="left">
							...
							<table border="0" class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 50%">
								...
								<tr align="left">
									...
									<td class="tabla-alycar-texto" style="width: 60%">
										...
										<INPUT type="text" id="OBLI-txtFechaRevision" name="OBLI-txtFechaRevision" value='<?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d/%m/%Y") : smarty_modifier_date_format($_tmp, "%d/%m/%Y")); ?>
' onKeyPress="return SoloNumeros(this, event, 0)" onchange="xajax_CalculaPrimerVencimiento(xajax.getFormValues('Form1'));" maxLength="10" size="10">
								...
								<tr align="left">
									...
									<td class="tabla-alycar-texto" style="width: 60%">
										...
										<INPUT type="text" id="OBLI-txtFechaDescuento" name="OBLI-txtFechaDescuento" value='<?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d/%m/%Y") : smarty_modifier_date_format($_tmp, "%d/%m/%Y")); ?>
