<?php /* Smarty version 2.6.18, created on 2015-04-09 16:00:28
         compiled from sg_bodega_informe_devoluciones_proveedor.tpl */ ?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<HEAD>
		...
		<title> Informe Devoluciones a Proveedor </title>
					...
					<tr>
						<td>
							<table border="0" class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr> 
									<td colspan="2" class="tabla-alycar-fila-informa-requerida-contrato">Informe Devoluciones a Proveedor</td>
								</tr>
								<tr align="left">
								...
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 20%">Proveedor:</td>
									<td class="tabla-alycar-texto" style="width: 80%">
										<INPUT type="text" id="txtCodProveedor" name="txtCodProveedor" value='' onKeyPress="return SoloNumeros(this, event, 1)" onchange="xajax_CargaDesc(xajax.getFormValues('Form1'),'sgbodega.proveedor', 'pr_rut', 'pr_razon', 'txtCodProveedor', 'txtDescProveedor', '');" maxLength="10" size="10">
										<INPUT type="text" id="txtDescProveedor" name="txtDescProveedor" value='' maxLength="100" size="50" readonly>
										<a href="#" style="cursor: hand;"><img  src="../images/magnify.png" border=0 title="Click para Buscar" onclick="showPopWin('sg_busqueda_proveedor.php?obj1=txtCodProveedor&obj2=txtDescProveedor', 'Busca Proveedor', 550, 350, null);"></a>
									</td>
								</TR>
								<tr align="left">
