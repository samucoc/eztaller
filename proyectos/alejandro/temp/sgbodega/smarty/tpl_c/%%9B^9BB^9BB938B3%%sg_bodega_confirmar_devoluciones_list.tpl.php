<?php /* Smarty version 2.6.18, created on 2013-08-26 18:01:21
         compiled from sg_bodega_confirmar_devoluciones_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'sg_bodega_confirmar_devoluciones_list.tpl', 5, false),array('modifier', 'number_format', 'sg_bodega_confirmar_devoluciones_list.tpl', 41, false),)), $this); ?>
<div id="pivot">										

<table class="grilla-tab" border="0" cellspacing="0" cellpadding="0" width="100%">
<tr>
	<td colspan='10' class="grilla-tab-fila-titulo" align='center'><b>Listado de Devoluciones De Clientes Por Confirmar al <?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d/%m/%Y") : smarty_modifier_date_format($_tmp, "%d/%m/%Y")); ?>
</b></td>
</tr>
...
<tr>
	...
	<td class="grilla-tab-fila-titulo" align='center'><b>N/U</b></td>
...
'>
		...
		<td class="grilla-tab-fila-campo" align='center'><?php echo $this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['folio']; ?>
</td>
		...
		<td class="grilla-tab-fila-campo" align='center'>
			<SELECT id="<?php echo $this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['ncorr']; ?>
cboNU" name="<?php echo $this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['ncorr']; ?>
cboNU">
				<option value='<?php echo $this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['nu']; ?>
'><?php echo $this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['nu']; ?>
</option>
