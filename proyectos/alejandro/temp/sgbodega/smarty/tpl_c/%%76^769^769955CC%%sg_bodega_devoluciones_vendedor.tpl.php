<?php /* Smarty version 2.6.18, created on 2013-12-02 13:01:49
         compiled from sg_bodega_devoluciones_vendedor.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'sg_bodega_devoluciones_vendedor.tpl', 103, false),)), $this); ?>
					...
					<tr>
						<td>
							<table border="0" class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr> 
									<td colspan="2" class="tabla-alycar-fila-informa-requerida-contrato">Devoluciones de Vendedor<input type="hidden" name="ncorr" id="ncorr" value="<?php echo $this->_tpl_vars['ncorr']; ?>
"/></td>
								</tr>
								<tr align="left">
