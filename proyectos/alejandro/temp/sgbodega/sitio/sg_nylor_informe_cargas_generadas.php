...
function CargaListado($data){
	...
	if ($v_inicio != '' && $v_termino != ''){
		list($dia1,$mes1,$anio1) =  explode('/', $v_inicio);$fecha1 	= $anio1."-".$mes1."-".$dia1." 00:00:00";
		list($dia2,$mes2,$anio2) =  explode('/', $v_termino);$fecha2 	= $anio2."-".$mes2."-".$dia2." 23:59:59";
		...
		$sql = "select
				...
				crea_folio = ventas_antigua.vent_num_folio and
