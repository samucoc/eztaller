...
$xajax->setRequestURI("sg_bodega_informe_aumento_bodega_concon.php");
...
function Grabar($data){
	...
	if (mysql_num_rows($res) > 0){
		...
		$objResponse->addAssign("divabonos", "innerHTML", $miSmarty->fetch('sg_bodega_informe_aumento_bodega_concon_list.tpl'));
	}else{
...
function LlamaGuia($data, $guia){
	...
	$_SESSION["alycar_pag_regreso"] 		= 	"sg_bodega_informe_aumento_bodega_concon.php";
...
$miSmarty->display('sg_bodega_informe_aumento_bodega_concon.tpl');
