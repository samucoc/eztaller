...
//14/10/2010 se saca el filtro por empresa (b.empe_rut = '".$empresa."' and)		
			...
			*/
			//$objResponse->addAlert("$aumentos_n + $trasp_con_n + $dev_vend_n + $dev_clie_n + $dev_clie_n_new - $aum_vend_n -	 $dev_pro_n - $desc_cp_n ---> $aumentos_u + $trasp_con_u + $dev_vend_u + $dev_clie_u + $dev_clie_u_new - $aum_vend_u - $dev_pro_u - $desc_cp_u");
