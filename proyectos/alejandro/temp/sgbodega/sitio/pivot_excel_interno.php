...
include "../includes/php/conf_bd.php"; 
	...
	if (($subfamilia != '') && ($subfamilia != 'Todas')){
        ...
        $body             .= "<table>";
        $body             .= "<tr><td>Familia</td><td>SubFamilia</td><td>Descripcion</td><td>Codigo</td><td>Codigo Antiguo</td><td>Stock Nuevo</td><td>Stock Usado</td><td>Ventas Ultimo Mes Stock Nuevo</td><td>Ventas Ultimo Mes Stock Usado</td><td>Ventas Promedio Ultimos 3 Meses Stock Nuevo</td><td>Ventas Promedio Ultimos 3 Meses Stock Usado</td></tr>";
...
//                        sin movimientos = 3                        
                        ...
                        if (($cod_prod == $line_pd[1])&&($cod_prod!='')&&($cod_prod!=' '))  { 
                            ...
                            $body             .= "<tr>";
                            $body             .= "<td>".$familia."</td>";
                            $body             .= "<td>".$subfamilia."</td>";
                            $body             .= "<td>".$line_pd[0]."</td>";
                            $body             .= "<td>".$line_pd[1]."</td>";
                            $body             .= "<td>".$line_pd[2]."</td>";
                            $body             .= "<td>".round($stock_nuevo)."</td>";
                            $body             .= "<td>".round($stock_usa)."</td>";
                            $body             .= "<td>".round($ventas_men_nuevo)."</td>";
                            $body             .= "<td>".round($ventas_men_usa)."</td>";
                            $body             .= "<td>".round($ventas_tri_nuevo)."</td>";
                            $body             .= "<td>".round($ventas_tri_usa)."</td>";
                            $body             .= "</tr>";                            
