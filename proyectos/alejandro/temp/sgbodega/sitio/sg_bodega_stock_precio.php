...
$xajax->setRequestURI("sg_bodega_stock_precio.php");
...
function Grabar($data){
	...
	if (mysql_num_rows($res_pd) > 0){
		...
		$objResponse->addAssign("divabonos", "innerHTML", $miSmarty->fetch('sg_bodega_stock_precio_list.tpl'));
...
$miSmarty->display('sg_bodega_stock_precio.tpl');
