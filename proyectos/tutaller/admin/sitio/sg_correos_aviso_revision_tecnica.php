...
$xajax->setRequestURI("sg_correos_aviso_revision_tecnica.php");
...
function Grabar($data){
	...
	//	inserto el registro
	$sql = "insert into envio_correos_rev_tec (correo,dias_anticipa,repeticion)
    ...
    $objResponse->addScript("document.location.href='sg_correos_aviso_revision_tecnica.php';");
...
$miSmarty->display('sg_correos_aviso_revision_tecnica.tpl');
