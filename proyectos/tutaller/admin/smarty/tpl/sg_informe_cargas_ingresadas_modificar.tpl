						...
						<form id="Form1" name="Form1" method="post" runat="server">
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<input type="hidden" id="ncorr" name="ncorr" value='{$ncorr}'> </input>
									</td>
								</tr>
							</table>
							<br>
	...
	<option value="1">Con Boleta</option>
				...
				<tr align="left">
					...
					<td class="tabla-alycar-texto" >
						<INPUT type="text" id="monto" name="monto"  onKeyPress="return SoloNumeros(this, event, 0)" value="{$carga_monto}" />
					</td>
				                </tr>
