<?php /* Smarty version 2.6.18, created on 2015-04-07 10:30:04
         compiled from sg_bodega_aumentos_vendedor.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'sg_bodega_aumentos_vendedor.tpl', 139, false),)), $this); ?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<HEAD>
		...
		<title> Aumentos a Vendedor </title>
       <meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
		...
		<script type="text/javascript">
			$(function($) { 
				...
				$("#OBLI-txtDescCobrador").autocomplete({
					source : \'busquedas/busqueda_persona.php\',
					select: function( event, ui ) {
						var rut = ui.item.id;
						document.getElementById(\'rut_trab\').value = rut;
						}
					});
				$("#OBLIPatente").autocomplete({
					...
					<tr>
						<td>
							<table border="0" class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr> 
									<td colspan="2" class="tabla-alycar-fila-informa-requerida-contrato">Salida Repuestos
<input type="hidden" name="ncorr" id="ncorr" value="<?php echo $this->_tpl_vars['ncorr']; ?>
"/>
									</td>
								</tr>
								<tr align="left">
...
' onKeyPress="return SoloNumeros(this, event, 0)" maxLength="10" size="10">
								...
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 25%">Trabajador:<label class="requerido"> * </label></td>
									<td class="tabla-alycar-texto" style="width: 75%">
										<INPUT type="hidden" id="rut_trab" name="rut_trab" value='' maxLength="10" size="10">
										<INPUT type="text" id="OBLI-txtDescCobrador" name="OBLI-txtDescCobrador" value='' maxLength="100" size="50" onKeyPress="return Tabula(this, event, 0)">
									</td>
								</TR>
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 25%">Patente:<label class="requerido"> * </label></td>
									<td class="tabla-alycar-texto" style="width: 75%">
										<INPUT type="text" id="OBLIPatente" name="OBLIPatente" value='' maxLength="25" size="25" onKeyPress="return Tabula(this, event, 0)">
									</td>
								</TR>
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 30%">Observacion:</td>
									<td class="tabla-alycar-texto" style="width: 70%">
							...
							<table class="grilla-tab" border="0" cellspacing="0" cellpadding="0" width="100%">
									...
									<td class="grilla-tab-fila-campo" style="width: 5%" align='center'>Marca</td>
									<td class="grilla-tab-fila-campo" style="width: 5%" align='center'>Vehiculo</td>
									<td class="grilla-tab-fila-campo" style="width: 8%" align='center'>Cantidad</td>
									<td class="grilla-tab-fila-campo" style="width: 8%" align='center'>Valor</td>
									<td class="grilla-tab-fila-campo" align='center'></td>
								</tr>								
								
								<tr>
									<td class="grilla-tab-fila-campo" style="width: 38%" align='left'>
										<INPUT type="text" id="OBLItxtCodProducto" name="OBLItxtCodProducto" value='' onKeyPress="return SoloNumeros(this, event, 5)" onchange="xajax_CargaDesc(xajax.getFormValues('Form1'), 'sgcopec.tallasnew', 'ta_ncorr', 'ta_descripcion', 'OBLItxtCodProducto', 'OBLItxtDescProducto', '');document.getElementById('OBLItxtCant').focus();" maxLength="10" style="width: 15%">
										<INPUT type="text" id="OBLItxtDescProducto" name="OBLItxtDescProducto" value='' maxLength="100" style="width: 75%" readonly>
									
									</td>
									<td class="grilla-tab-fila-campo" style="width: 20%" align='left'>
										<INPUT type="text" id="txtMarcaProducto" name="txtMarcaProducto" value='' maxLength="100" style="width: 75%" readonly>
									
									</td>
									<td class="grilla-tab-fila-campo" style="width: 10%" align='center'>
										<INPUT type="text" id="txtVehiculo" name="txtVehiculo" value='' style="width: 50%" >
									</td>
									...
									<td class="grilla-tab-fila-campo" style="width: 8%" align='center'>
										<INPUT type="text" style="width: 99%" id="OBLItxtValor" name="OBLItxtValor" onKeyPress="return SoloNumeros(this, event, 0)" onchange="xajax_CalculaTotalesLinea(xajax.getFormValues('Form1'))" value='' maxLength="10">
									</td>
