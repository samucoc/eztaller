<?php /* Smarty version 2.6.18, created on 2013-02-07 16:42:33
         compiled from sg_mantenedor_carga_masiva_trabajador.tpl */ ?>
						...
						<form id="Form1" name="Form1" method="post" runat="server" enctype="multipart/form-data">
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%">
                                    	<label class="form-titulo">&nbsp;&nbsp;Cargas Masivas Trabajadores</label>
