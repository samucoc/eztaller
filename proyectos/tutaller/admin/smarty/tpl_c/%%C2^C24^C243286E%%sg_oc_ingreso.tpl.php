<?php /* Smarty version 2.6.18, created on 2016-11-04 16:30:05
         compiled from sg_oc_ingreso.tpl */ ?>
						...
						<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%"><label class="form-titulo">Ingresar Orden de Compra</label></td>
								</tr>
							</table>
							<br>
						</td>
				...
				<table class="tabla-alycar" cellpadding="2" cellspacing="2" style="WIDTH: 100%; float: left; border: 1pt solid #B9B9B9; background:#ffffff">
					<tr>
						...
						<td class="tabla-alycar-texto" >
							<input type="text" name="ot_ncorr" id="ot_ncorr" onblur="xajax_RescatarCotizacion(xajax.getFormValues('Form1'));">
						</td>
					</tr>
					<tr>
						<td class="tabla-alycar-label">
						...
						<td class="tabla-alycar-texto" >
							<table class="tabla-alycar" cellpadding="2" cellspacing="2" style="WIDTH: 100%; float: left; border: 1pt solid #B9B9B9; 	background:#ffffff">
								<tr>
									<td>
										<input type="text" name="proveedor" id="proveedor" size="50">
										<input type="hidden" name="rut_proveedor" id="rut_proveedor">
									</td>
									<td class="tabla-alycar-label">
										<a href="#" onclick="xajax_AgregarProveedor(xajax.getFormValues('Form1'));">
											<img src="../images/plus.png" title="Agregar Proveedor" />
										</a>
									</td>
								</tr>
							</table>
					...
					<tr>
						<td class="tabla-alycar-label" colspan="99">
							<a href="#" onclick="xajax_Grabar(xajax.getFormValues('Form1'));">
								<img src='../images/basicos/guardar.png' title='Grabar Orden Compra' width="32"/>
							</a>
						</td>
					</tr>
				</table>
