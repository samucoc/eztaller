<?php /* Smarty version 2.6.18, created on 2015-04-27 11:18:49
         compiled from sg_reparaciones_ingreso.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'sg_reparaciones_ingreso.tpl', 283, false),)), $this); ?>
							...
							<tr align="left">
							  <td class="tabla-alycar-texto" ><table class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
							    <tr align="left">
							      ...
							      <td class="tabla-alycar-texto" style=""><input name="cboPersona" id="cboPersona" value="<?php echo $this->_tpl_vars['CARGA_NOM_PERS']; ?>
"  />
...
" /></td>
							    ...
							    <tr align="left">
							      ...
							      <td class="tabla-alycar-texto" style="width: 15%"><input id="cboPatente" name="cboPatente" value="<?php echo $this->_tpl_vars['carga_veh']; ?>
" /></td>
							    ...
							    <tr align="left">
							      ...
							      <td class="tabla-alycar-texto" ><input type="text" id="OBLI-txtFecha2" name="OBLI-txtFecha2" value='<?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d/%m/%Y") : smarty_modifier_date_format($_tmp, "%d/%m/%Y")); ?>
' onkeypress="return SoloNumeros(this, event, 0)" maxlength="10" size="10" /></td>
						        </tr>
							    <tr align="left">
