<?php /* Smarty version 2.6.18, created on 2016-09-21 12:02:55
         compiled from sg_ot_ingreso_1.tpl */ ?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="xajax_CargaPagina(xajax.getFormValues('Form1'));" style="background:#ffffff;"> 
		<form id="Form1" name="Form1" method="post" runat="server">
			...
			<div align="left" style="margin-left:2px; padding: 2px;">
				<table class="grilla-tab" cellpadding="2" cellspacing="2" style="WIDTH: 100%; float: left; border: 1pt solid #B9B9B9; background:#ffffff">
					<tr>
						<td class="grilla-tab-fila-titulo">
							Folio
						</td>
						<td class="grilla-tab-fila-campo" colspan="3">
