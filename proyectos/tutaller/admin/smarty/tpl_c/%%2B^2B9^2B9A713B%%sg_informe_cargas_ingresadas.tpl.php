<?php /* Smarty version 2.6.18, created on 2016-03-16 14:10:55
         compiled from sg_informe_cargas_ingresadas.tpl */ ?>
						...
						<form id="Form1" name="Form1" method="post" runat="server">
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%"><label class="form-titulo">&nbsp;&nbsp;Informe de Movimientos</label></td>
								</tr>
							</table>
							<br>
							<table class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								...
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 15%">Deptartamento:</td>
									<td class="tabla-alycar-texto" style="width: 85%">
                                                                            <select id="cboBoleta" name="cboBoleta" >
