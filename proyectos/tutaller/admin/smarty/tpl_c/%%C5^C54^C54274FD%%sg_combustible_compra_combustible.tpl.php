<?php /* Smarty version 2.6.18, created on 2013-10-03 14:52:00
         compiled from sg_combustible_compra_combustible.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'sg_combustible_compra_combustible.tpl', 178, false),)), $this); ?>
							...
							<table class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left">
									...
									<td class="tabla-alycar-texto" style="width: 85%">
										<INPUT type="text" id="OBLI-txtFecha1" name="OBLI-txtFecha1" value='<?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d/%m/%Y") : smarty_modifier_date_format($_tmp, "%d/%m/%Y")); ?>
