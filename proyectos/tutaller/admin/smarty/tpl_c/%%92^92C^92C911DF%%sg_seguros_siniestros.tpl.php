<?php /* Smarty version 2.6.18, created on 2013-03-13 10:01:00
         compiled from sg_seguros_siniestros.tpl */ ?>
						...
						<form id="Form1" name="Form1" method="post" runat="server">
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%"><label class="form-titulo">&nbsp;&nbsp;Ingresar Siniestro</label></td>
								</tr>
							</table>
							<br>
							<table class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								...
								<tr align="left">
									...
									<td class="tabla-alycar-texto" style="width: 85%">
                                        <textarea name="obs" id="obs" rows="5" cols="40"></textarea>
									</td>	
								</tr>
								<tr align="left">
