<?php /* Smarty version 2.6.18, created on 2016-03-18 11:26:05
         compiled from sg_informe_cargas_ingresadas_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'sg_informe_cargas_ingresadas_list.tpl', 24, false),)), $this); ?>
<div id="pivot">										
...
?>
        <?php if (( ( $this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['vehiculo'] != '' ) && ( $this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['debe'] != '' ) && ( $this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['haber'] != '' ) && ( $this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['fecha'] != '' ) && ( $this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['tipo'] != '' ) )): ?>
        <tr>
		...
		<td class="grilla-tab-fila-campo" align='left'><?php echo $this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['haber']; ?>
</td>
		<td class="grilla-tab-fila-campo" align='left'><?php echo $this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['debe']; ?>
</td>
		...
		<td class="grilla-tab-fila-campo" align='left'><?php echo $this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['boleta']; ?>
</td>
		...
		<?php if (( ( ((is_array($_tmp=$this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['fecha_dig'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y-%m-%d") : smarty_modifier_date_format($_tmp, "%Y-%m-%d")) == ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y-%m-%d") : smarty_modifier_date_format($_tmp, "%Y-%m-%d")) ) && ( $this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['tipo'] != 'Extra' ) )): ?>
            <td class="grilla-tab-fila-campo">
                <a href="#" onclick="showPopWin('sg_informe_cargas_ingresadas_modificar.php?ncorr=<?php echo $this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['ncorr']; ?>
', 'Modificar Carga', 800, 600, null);" >Modificar Carga</a>
            </td>
            <td class="grilla-tab-fila-campo">
                <a href="scripts/eliminar_carga.php?id_carga=<?php echo $this->_tpl_vars['arrRegistros'][$this->_sections['registros']['index']]['ncorr']; ?>
" >Eliminar Carga</a>
            </td>
        <?php else: ?>
