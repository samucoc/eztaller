<?php /* Smarty version 2.6.18, created on 2013-10-15 14:25:08
         compiled from sg_combustible_carga_multiple.tpl */ ?>
					...
					<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%"><label class="form-titulo">&nbsp; Ingreso de cargas y devoluciones m&uacute;ltiples</label></td>
								</tr>
							</table>
							<br>
							<table class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								...
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 15%">Tipo de Carga:</td>
									<td class="tabla-alycar-texto" style="width: 85%">
