<?php /* Smarty version 2.6.18, created on 2014-10-14 15:47:57
         compiled from sg_seguros_ingresar.tpl */ ?>
						...
						<form id="Form1" name="Form1" method="post" runat="server">
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
								<tr align="left" valign="middle">
									...
									<td style="width: 93%"><label class="form-titulo">&nbsp;&nbsp;Ingresar Seguro</label></td>
								</tr>
							</table>
							<br>
							<table class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								...
								<tr align="left">
									...
									<td class="tabla-alycar-texto" style="width: 85%">
                                        <input name="rdMes" id="rdMes" value="" readonly="readonly"/>
                                        <input type="hidden" name="rdMes_oculto" id="rdMes_oculto" value="" readonly="readonly"/>
									</td>	
								</tr>
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 15%">Monto a Pagar:</td>
									<td class="tabla-alycar-texto" style="width: 85%">
                                        <input name="rdmonto_pagar" id="rdmonto_pagar" value="" />
									</td>	
								</tr>
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 15%">Monto Pagado:</td>
									<td class="tabla-alycar-texto" style="width: 85%">
                                        <input name="rdmonto_pagado" id="rdmonto_pagado" value="" />
									</td>	
								</tr>
								<tr align="left">
									<td class="tabla-alycar-label" style="width: 15%">Factura:</td>
									<td class="tabla-alycar-texto" style="width: 85%">
                                        <input name="rdfactura" id="rdfactura" value="" />
									</td>	
								</tr>
								<tr align="left">
									<td colspan="2" class="tabla-alycar-fila-botones">
										...
										<input type="button" name="btnActualizar" value="Actualizar" class="boton" onclick="xajax_Actualizar(xajax.getFormValues('Form1'))">
									</td>
								</tr>
