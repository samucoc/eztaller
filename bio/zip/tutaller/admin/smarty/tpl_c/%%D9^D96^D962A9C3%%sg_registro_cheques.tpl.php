<?php /* Smarty version 2.6.18, created on 2011-03-04 10:34:53
         compiled from sg_registro_cheques.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'sg_registro_cheques.tpl', 89, false),)), $this); ?>
						...
						<td>
							...
							<table border="0" class="tabla-alycar" cellpadding="0" cellspacing="0" style="width: 100%">
								...
								<tr align="left">
									...
									<td class="tabla-alycar-texto-peq" style="width: 75%">
										<INPUT type="text" id="OBLItxtFechaEmision" name="OBLItxtFechaEmision" value='<?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d/%m/%Y") : smarty_modifier_date_format($_tmp, "%d/%m/%Y")); ?>
